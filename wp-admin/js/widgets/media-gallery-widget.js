          ...
          /** @lends wp.mediaWidgets.controlConstructors.media_gallery.prototype */ {
               ...
               updateSelectedAttachments: function updateSelectedAttachments() {
                    ...
                    if (addedIds.length) {
                         ...
                         addedQuery.more().done(function () {
                              control.selectedAttachments.reset(
                                   addedQuery.models,
                              );
                         });
                    }
               ...
               renderPreview: function renderPreview() {
                    ...
                    previewTemplate = wp.template(
                         'wp-media-widget-gallery-preview',
                    );
               ...
               editMedia: function editMedia() {
                    ...
                    mediaFrame.on('update', function onUpdate(newSelection) {
                         ...
                         resultSelection =
                              newSelection || state.get('selection');
                         if (!resultSelection) {
                              return;
                         }
                         ...
                         if (resultSelection.gallery) {
                              control.model.set(
                                   control.mapMediaToModelProps(
                                        resultSelection.gallery.toJSON(),
                                   ),
                              );
                         }
                    ...
                    if (selection) {
                         selection.on(
                              'destroy',
                              control.handleAttachmentDestroy,
                         );
                    }
               },
                ...
                * @return {void}
                */
               handleAttachmentDestroy: function handleAttachmentDestroy(
                    attachment,
               ) {
                    var control = this;
                    control.model.set({
                         ids: _.difference(control.model.get('ids'), [
                              attachment.id,
                         ]),
                    });
               },
