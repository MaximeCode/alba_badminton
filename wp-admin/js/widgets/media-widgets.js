...
wp.mediaWidgets = (function ($) {
          ...
          wp.media.controller.Library.extend(
               /** @lends wp.mediaWidgets.PersistentDisplaySettingsLibrary.prototype */ {
                    ...
                    initialize: function initialize(options) {
                         ...
                         wp.media.controller.Library.prototype.initialize.call(
                              this,
                              options,
                         );
                    },
                    ...
                    handleDisplaySettingChange:
                         function handleDisplaySettingChange(displaySettings) {
                              this.get('selectedDisplaySettings').set(
                                   displaySettings.attributes,
                              );
                         },
                    ...
                    display: function getDisplaySettingsModel(model) {
                         var display,
                              selectedDisplaySettings = this.get(
                                   'selectedDisplaySettings',
                              );
                         display =
                              wp.media.controller.Library.prototype.display.call(
                                   this,
                                   model,
                              );
                         ...
                         if (
                              'custom' ===
                              selectedDisplaySettings.get('link_type')
                         ) {
                              display.linkUrl =
                                   selectedDisplaySettings.get('link_url');
                         }
     ...
     component.MediaEmbedView = wp.media.view.Embed.extend(
          /** @lends wp.mediaWidgets.MediaEmbedView.prototype */ {
               ...
               initialize: function (options) {
                    ...
                    wp.media.view.Embed.prototype.initialize.call(
                         view,
                         options,
                    );
                         ...
                         Constructor = wp.media.view.EmbedLink.extend(
                              /** @lends wp.mediaWidgets~Constructor.prototype */ {
                                   ...
                                   setAddToWidgetButtonDisabled:
                                        function setAddToWidgetButtonDisabled(
                                             disabled,
                                        ) {
                                    ...
                                    * @return {void}
                                    */
                                   setErrorNotice: function setErrorNotice(
                                        notice,
                                   ) {
                                        ...
                                        noticeContainer =
                                             embedLinkView.views.parent.$el.find(
                                                  '> .notice:first-child',
                                             );
                                        if (!notice) {
                                             ...
                                             if (!noticeContainer.length) {
                                                  ...
                                                  embedLinkView.views.parent.$el.prepend(
                                                       noticeContainer,
                                                  );
                                             }
                                   ...
                                   updateoEmbed: function () {
                                        ...
                                        if (!url) {
                                             ...
                                             embedLinkView.setAddToWidgetButtonDisabled(
                                                  true,
                                             );
                                             return;
                                        }
                                   ...
                                   fetch: function () {
                                        ...
                                        if (youTubeEmbedMatch) {
                                             ...
                                             embedLinkView.model.attributes.url =
                                                  url;
                                        }
                                   ...
                                   renderFail: function renderFail() {
                                        ...
                                        embedLinkView.controller.$el
                                             ...
                                             .addClass('invalid');
                                        embedLinkView.setErrorNotice(
                                             embedLinkView.controller.options
               ...
               createStates: function createStates() {
                    ...
                    this.states.add([
                         ...
                         new component.PersistentDisplaySettingsLibrary({
                              ...
                              selectedDisplaySettings:
                                   this.options.selectedDisplaySettings,
                              displaySettings: _.isUndefined(
                         ...
                         new wp.media.controller.Embed({
                              ...
                              type:
                                   'image' === this.options.mimeType
                                        ? 'image'
                                        : 'link',
                              invalidEmbedTypeError:
                                   this.options.invalidEmbedTypeError,
                         }),
                    ]);
               },
     ...
     component.MediaWidgetControl = Backbone.View.extend(
          /** @lends wp.mediaWidgets.MediaWidgetControl.prototype */ {
                ...
                */
               events: {
                    'click .notice-missing-attachment a':
                         'handleMediaLibraryLinkClick',
               ...
               initialize: function initialize(options) {
                    ...
                    if (
                         !(control.model instanceof component.MediaWidgetModel)
                    ) {
                    ...
                    control.$el.on(
                         ...
                         function updateLinkUrl() {
                              var linkUrl = $(this).val().trim(),
                                   linkType = 'custom';
                              if (
                                   control.selectedAttachment.get('linkUrl') ===
                                        linkUrl ||
                                   control.selectedAttachment.get('link') ===
                                        linkUrl
                              ) {
                                   linkType = 'post';
                              } else if (
                                   control.selectedAttachment.get('url') ===
                                   linkUrl
                              ) {
                                   linkType = 'file';
                              }
               ...
               syncModelToInputs: function syncModelToInputs() {
                    ...
                    control.syncContainer
                         ...
                         .each(function () {
                              ...
                              if (
                                   'array' ===
                                        control.model.schema[propertyName]
                                             .type &&
                                   _.isArray(value)
                              ) {
                                   value = value.join(',');
                                   ...
                                   'boolean' ===
                                   control.model.schema[propertyName].type
                              ) {
               ...
               template: function template() {
                    ...
                    if (
                         ...
                         throw new Error(
                              'Missing widget control template for ' +
                                   control.id_base,
                         );
                    }
                    return wp.template(
                         'widget-media-' + control.id_base + '-control',
                    );
               },
               ...
               render: function render() {
                    ...
                    if (!control.templateRendered) {
                         control.$el.html(
                              control.template()(control.model.toJSON()),
                         );
                ...
                */
               handleMediaLibraryLinkClick:
                    function handleMediaLibraryLinkClick(event) {
                         var control = this;
               ...
               selectMedia: function selectMedia() {
                    ...
                    if (
                         control.isSelected() &&
                         0 !== control.model.get('attachment_id')
                    ) {
                    ...
                    mediaFrame = new component.MediaFrameSelect({
                         ...
                         state:
                              ...
                              0 === control.model.get('attachment_id')
                                   ...
                                   : 'insert',
                         invalidEmbedTypeError:
                              control.l10n.unsupported_file_type,
                    });
                    ...
                    mediaFrame.on('insert', function onInsert() {
                         ...
                         control.model.set(
                              control.getModelPropsFromMediaFrame(mediaFrame),
                         );
                    });
                ...
                * @return {Object} Props.
                */
               getModelPropsFromMediaFrame:
                    function getModelPropsFromMediaFrame(mediaFrame) {
                         var control = this,
                              state,
                              mediaFrameProps,
                              modelProps;
                         ...
                         if ('insert' === state.get('id')) {
                              ...
                              throw new Error(
                                   'Unexpected state: ' + state.get('id'),
                              );
                         }

                         if (mediaFrameProps.id) {
                              mediaFrameProps.attachment_id =
                                   mediaFrameProps.id;
                         }
                ...
                */
               mapMediaToModelProps: function mapMediaToModelProps(
                    mediaFrameProps,
               ) {
                    var control = this,
                    ...
                    _.each(mediaFrameProps, function (value, mediaProp) {
                         var propName =
                              mediaFramePropToModelPropMap[mediaProp] ||
                              mediaProp;
                    ...
                    if ('post' === mediaFrameProps.link) {
                         modelProps.link_url =
                              mediaFrameProps.postUrl ||
                              mediaFrameProps.linkUrl;
               ...
               mapModelToMediaFrameProps: function mapModelToMediaFrameProps(
                    ...
                    _.each(modelProps, function (value, modelProp) {
                         var fieldSchema =
                              control.model.schema[modelProp] || {};
                         mediaFrameProps[fieldSchema.media_prop || modelProp] =
                              value;
                    });
                    ...
                    if ('custom' === mediaFrameProps.size) {
                         mediaFrameProps.customWidth =
                              control.model.get('width');
                         mediaFrameProps.customHeight =
                              control.model.get('height');
                    }
                    ...
                    function mapModelToPreviewTemplateProps() {
                         ...
                         _.each(control.model.schema, function (value, prop) {
                              if (
                                   ...
                                   previewTemplateProps[prop] =
                                        control.model.get(prop);
                              }
                         });

                         // Templates need to be aware of the error.
                         previewTemplateProps.error =
                              control.model.get('error');
                    ...
                    _.each(attrs, function (value, name) {
                         ...
                         if ('array' === type) {
                              ...
                              if (!_.isArray(castedAttrs[name])) {
                                   castedAttrs[name] =
                                        castedAttrs[name].split(/,/); // Good enough for parsing an ID list.
                              }
                              if (
     ...
     component.handleWidgetAdded = function handleWidgetAdded(
          ...
          ModelConstructor =
               component.modelConstructors[idBase] ||
               component.MediaWidgetModel;
          ...
          component.widgetControls[widgetModel.get('widget_id')] =
               widgetControl;
     };
     ...
     component.setupAccessibleMode = function setupAccessibleMode() {
          ...
          widgetId = widgetForm
               .find('> .widget-control-actions > .widget-id')
               .val();
