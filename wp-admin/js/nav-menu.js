     ...
     api = window.wpNavMenu = {
          ...
          init: function () {
               ...
               if (menus.oneThemeLocationNoMenus)
                    $('#posttype-page').addSelectedToMenu(
               ...
               $.fn.extend({
                    ...
                    addSelectedToMenu: function (processMethod) {
                         ...
                         return this.each(function () {
                              var t = $(this),
                                   ...
                                   checkboxes =
                                        ...
                                        0 ===
                                             ...
                                             ? t.find(
                                                    '#page-all li input[type="checkbox"]',
                                               )
                                             : t.find(
                                                    '.tabs-panel-active .categorychecklist li input:checked',
                                               ),
                              ...
                              t.find('.button-controls .spinner').addClass(
                                   'is-active',
                              );
                              ...
                              $(checkboxes).each(function () {
                                   var t = $(this),
                                        listItemDBIDMatch = re.exec(
                                             t.attr('name'),
                                        ),
                                        listItemDBID =
                                             'undefined' ==
                                             typeof listItemDBIDMatch[1]
                                                  ? 0
                                                  : parseInt(
                                                         listItemDBIDMatch[1],
                                                         10,
                              ...
                              api.addItemToMenu(
                                   ...
                                   function () {
                                        ...
                                        t.find(
                                             '.button-controls .select-all',
                                        ).prop('checked', false);
                                        t.find(
                                             '.button-controls .spinner',
          ...
          moveMenuItem: function ($this, dir) {
               ...
               switch (dir) {
                    ...
                    case 'down':
                         ...
                         if (thisItemChildren) {
                              (items = thisItem.add(thisItemChildren)),
                                   (nextItem = menuItems.eq(
                                        items.length + thisItemPosition,
                                   )),
                                   (nextItemChildren =
                                        0 !== nextItem.childMenuItems().length);

                              if (nextItemChildren) {
                                   newDepth =
                                        parseInt(nextItem.menuItemDepth(), 10) +
                                        1;
                                   thisItem.moveHorizontally(
                                        newDepth,
                                        thisItemDepth,
                              ...
                              thisItem
                                   .detach()
                                   .insertAfter(
                                        menuItems.eq(thisItemPosition + 1),
                                   )
                                   .updateParentMenuItemDBId();
                         }
                         break;
          ...
          refreshAdvancedAccessibilityOfItem: function (itemToRefresh) {
               ...
               if (!isPrimaryMenuItem) {
                    (thisLink = menuItem.find('.menus-move-left')),
                         (thisLinkText = menus.outFrom.replace(
                              '%s',
                              prevItemNameLeft,
                         ));
                    thisLink
                         .attr(
                              'aria-label',
                              menus.moveOutFrom.replace('%s', prevItemNameLeft),
                         )
                         .text(thisLinkText)
                         .css('display', 'inline');
               }
               ...
               if (0 !== position) {
                    if (
                         ...
                         (thisLink = menuItem.find('.menus-move-right')),
                              (thisLinkText = menus.under.replace(
                                   '%s',
                                   prevItemNameRight,
                              ));
                         thisLink
          ...
          initSortables: function () {
               ...
               api.menuList.sortable({
                    ...
                    start: function (e, ui) {
                         ...
                         parent =
                              ui.item.next()[0] == ui.placeholder[0]
                                   ? ui.item.next()
                                   : ui.item;
                    ...
                    sort: function (e, ui) {
                         var offset = ui.helper.offset(),
                              edge = api.isRTL
                                   ? offset.left + ui.helper.width()
                                   : offset.left,
                              depth =
                                   api.negateIfRTL *
                                   api.pxToDepth(edge - menuEdge);
                         ...
                         if (
                              depth > maxDepth ||
                              offset.top <
                                   prevBottom - api.options.targetTolerance
                         ) {
                              depth = maxDepth;
               ...
               function updateSharedVars(ui) {
                    ...
                    prevBottom = prev.length
                         ? prev.offset().top + prev.height()
                         : 0;
                    nextThreshold = next.length
                         ? next.offset().top + next.height() / 3
                         : 0;
                    minDepth = next.length ? next.menuItemDepth() : 0;

                    if (prev.length)
                         maxDepth =
                              (depth = prev.menuItemDepth() + 1) >
               ...
               function updateMenuMaxDepth(depthChange) {
                    ...
                    if (depthChange === 0) {
                         ...
                         depthChange < 0 &&
                         maxChildDepth == menuMaxDepth
                    ) {
                         while (
                              !$('.menu-item-depth-' + newDepth, api.menuList)
                                   .length &&
                              newDepth > 0
                         )
                              newDepth--;
                    ...
                    body.removeClass('menu-max-depth-' + menuMaxDepth).addClass(
                         'menu-max-depth-' + newDepth,
                    );
               ...
               $('#update-nav-menu').on('click', function (e) {
                    if (e.target && e.target.className) {
                         if (-1 != e.target.className.indexOf('item-edit')) {
                              ...
                              -1 != e.target.className.indexOf('menu-save')
                         ) {
                              return that.eventOnClickMenuSave(e.target);
                         } else if (
                              -1 != e.target.className.indexOf('menu-delete')
                         ) {
                              return that.eventOnClickMenuDelete(e.target);
                         } else if (
                              -1 != e.target.className.indexOf('item-delete')
                         ) {
                              return that.eventOnClickMenuItemDelete(e.target);
                         } else if (
                              -1 != e.target.className.indexOf('item-cancel')
                         ) {
                         ...
                         $.each(
                              ...
                              function (index, element) {
                                   var itemName = $(element)
                                        .find('.pending-menu-item-name')
                                        .text();
                                   var itemSpeech =
                                        menus.menuItemDeletion.replace(
                                             '%s',
                                             itemName,
                                        );
                                   ...
                                   if (
                                        index + 1 <
                                        itemsPendingDeletionList.length
                                   ) {
                                        itemsPendingDeletion += ', ';
                                   }
                              },
          ...
          attachPendingMenuItemsListForDeletion: function () {
               $('#post-body-content').on(
                    ...
                    function () {
                         ...
                         ).find('[data-menu-item-id=' + menuItemID + ']');
                         ...
                         $('#pending-menu-items-to-delete li .separator')
                              .last()
                              .html('.');
                    },
               );
          ...
          attachMenuSaveSubmitListeners: function () {
               ...
               $('#update-nav-menu').on('submit', function () {
                    ...
                    $('[name="nav-menu-data"]').val(
                         JSON.stringify(navMenuData),
                    );
               });
          },
          ...
          attachTabsPanelListeners: function () {
               $('#menu-settings-column').on('click', function (e) {
                    ...
                    if (target.hasClass('nav-tab-link')) {
                         ...
                         if (
                              !wrapper.find(
                                   '.tabs-panel-active .menu-item-title',
                              ).length
                         ) {
                         ...
                         if (
                              e.target.id &&
                              'submit-customlinkdiv' == e.target.id
                         )
                              ...
                              $(
                                   '#' + e.target.id.replace(/submit-/, ''),
                              ).addSelectedToMenu(api.addMenuItemToBottom);
                         return false;
                    }
               });
               ...
               $('#nav-menu-meta').on('click', 'a.page-numbers', function () {
                    ...
                    $.post(
                         ...
                         function (resp) {
                              ...
                              toReplace = document.getElementById(
                                   metaBoxData['replace-id'],
                              );
          ...
          processQuickSearchQueryResponse: function (resp, req, panel) {
               ...
               $items.each(function () {
                    ...
                    if (matched && matched[1]) {
                         ...
                         while (
                              form.elements[
                                   'menu-item[' + newID + '][menu-item-type]'
                              ] ||
                              takenIDs[newID]
                         ) {
                              newID--;
          ...
          $(
               ...
               if (window.innerWidth >= 783) {
                    ...
                    if (bottomOffset < navMenuHeight) {
                         ...
                         $(document).scrollTop(
                              scrollTop + (navMenuHeight - bottomOffset),
                         );
                    }
               }
          });
