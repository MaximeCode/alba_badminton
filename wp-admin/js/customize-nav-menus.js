     ...
     api.Menus.AvailableMenuItemsPanelView = wp.Backbone.View.extend(
          /** @lends wp.customize.Menus.AvailableMenuItemsPanelView.prototype */ {
               ...
               initialize: function () {
                    ...
                    this.sectionContent = this.$el.find(
                    ...
                    this.sectionContent.on('scroll', function () {
                         var totalHeight = self.$el
                                   .find(
                                        '.accordion-section.open .available-menu-items-list',
                                   )
                                   .prop('scrollHeight'),
                              visibleHeight = self.$el
               ...
               doSearch: function (page) {
                    ...
                    params = api.previewer.query({
                         excludeCustomizedSaved: true,
                    });
                    _.extend(params, {
                         'customize-menus-nonce':
                              api.settings.nonce['customize-menus'],
                         wp_customize: 'on',
                    ...
                    self.currentRequest.done(function (data) {
                         ...
                         self.loading = false;
                         items = new api.Menus.AvailableItemCollection(
                              data.items,
                         );
                         self.collection.add(items.models);
                         items.each(function (menuItem) {
                              $content.append(
                                   itemTemplate(menuItem.attributes),
                              );
                         });
                         if (20 > items.length) {
                         ...
                         if (items && page > 1) {
                              wp.a11y.speak(
                                   api.Menus.data.l10n.itemsFoundMore.replace(
                                        '%d',
                                        items.length,
                                   ),
                              );
                              ...
                              wp.a11y.speak(
                                   api.Menus.data.l10n.itemsFound.replace(
                                        '%d',
                                        items.length,
                                   ),
                              );
               ...
               loadItems: function (itemTypes, deprecated) {
                    ...
                    request = wp.ajax.post(
                         'load-available-menu-items-customizer',
                         params,
                    );
                    ...
                    request.done(function (data) {
                         ...
                         _.each(data.items, function (typeItems, name) {
                              if (0 === typeItems.length) {
                                   ...
                                   'post_type:page' === name &&
                                   !availableMenuItemContainers[name].hasClass(
                                        'open',
                                   )
                              ) {
                                   availableMenuItemContainers[name]
                              ...
                              typeItems = new api.Menus.AvailableItemCollection(
                                   typeItems,
                              ); // @todo Why is this collection created and then thrown away?
                              self.collection.add(typeItems.models);
                              typeInner = availableMenuItemContainers[
                                   name
               ...
               submitNew: function (container) {
                    ...
                    promise.done(function (data) {
                         ...
                         panel.currentMenuControl.addItemToMenu(
                              availableItem.attributes,
                         );
                         ...
                         itemElement = $(
                              wp.template('available-menu-item')(
                                   availableItem.attributes,
                              ),
                         );
                         itemElement
               ...
               close: function (options) {
                    ...
                    $(
                         '#available-menu-items .menu-item-handle.item-added',
               ...
               attachEvents: function () {
                    ...
                    button.on('click keydown', function (event) {
                         ...
                         if ('true' === button.attr('aria-expanded')) {
                              ...
                              panelMeta.removeClass(
                                   'active-menu-screen-options',
                              );
               ...
               ready: function () {
                    ...
                    api.section('menu_locations', function (section) {
                         section.headContainer.prepend(
                              wp.template('nav-menu-locations-header')(
                                   api.Menus.data,
                              ),
                         );
                    });
          ...
          /** @lends wp.customize.Menus.MenuSection.prototype */ {
               ...
               ready: function () {
                    ...
                    api.each(function (setting, id) {
                         ...
                         if (matches) {
                              section.navMenuLocationSettings[matches[1]] =
                                   setting;
                    ...
                    api.bind('pane-contents-reflowed', function () {
                         ...
                         section.container
                              .find(
                                   '.menu-item.move-up-disabled .menus-move-up',
                              )
                              .attr({ tabindex: '-1', 'aria-hidden': 'true' });
                         section.container
                              .find(
                                   '.menu-item.move-down-disabled .menus-move-down',
                              )
                              .attr({ tabindex: '-1', 'aria-hidden': 'true' });
                         section.container
                              .find(
                                   '.menu-item.move-left-disabled .menus-move-left',
                              )
                              .attr({ tabindex: '-1', 'aria-hidden': 'true' });
                         section.container
                              .find(
                                   '.menu-item.move-right-disabled .menus-move-right',
                              )
                              .attr({ tabindex: '-1', 'aria-hidden': 'true' });
                    });
               ...
               populateControls: function () {
                    ...
                    if (!menuNameControl) {
                         menuNameControl =
                              new api.controlConstructor.nav_menu_name(
                                   menuNameControlId,
                                   {
                                        type: 'nav_menu_name',
                                        label: api.Menus.data.l10n
                                             .menuNameLabel,
                                        section: section.id,
                                        priority: 0,
                                        settings: {
                    ...
                    if (!menuLocationsControl) {
                         menuLocationsControl =
                              new api.controlConstructor.nav_menu_locations(
                                   menuLocationsControlId,
                                   {
                                        section: section.id,
                                        priority: 999,
                    ...
                    if (!menuAutoAddControl) {
                         menuAutoAddControl =
                              new api.controlConstructor.nav_menu_auto_add(
                                   menuAutoAddControlId,
                                   {
                ...
                */
               updateAssignedLocationsInSectionTitle: function (
                    themeLocationSlugs,
               ) {
                    var section = this,
                         $title;

                    $title = section.container.find(
                         '.accordion-section-title:first',
                    );
                    ...
                    _.each(themeLocationSlugs, function (themeLocationSlug) {
                         ...
                         locationName =
                              api.Menus.data.locationSlugMappedToName[
                                   themeLocationSlug
                              ];
                         $label.text(
                              api.Menus.data.l10n.menuLocation.replace(
                                   '%s',
                                   locationName,
                              ),
                         );
               ...
               onChangeExpanded: function (expanded, args) {
                    ...
                    if (expanded) {
                         ...
                         args.completeCallback = function () {
                              if (
                                   'resolved' !==
                                   section.deferred.initSortables.state()
                              ) {
                                   wpNavMenu.initSortables(); // Depends on menu-to-edit ID being set above.
                                   section.deferred.initSortables.resolve(
                                        wpNavMenu.menuList,
                                   ); // Now MenuControl can extend the sortable.
     ...
     api.Menus.NewMenuSection = api.Section.extend(
          /** @lends wp.customize.Menus.NewMenuSection.prototype */ {
               ...
               attachEvents: function () {
                    ...
                    api.Section.prototype.attachEvents.apply(
                         section,
                         arguments,
                    );
               },
                         ...
                         .each(function () {
                              ...
                              if (checkbox.prop('checked')) {
                                   navMenuLocationSetting = api(
                                        'nav_menu_locations[' +
                                             checkbox.data('location-id') +
                                             ']',
                                   );
                                   navMenuLocationSetting.set(
                                        menuSection.params.menu_id,
                                   );
               ...
               ready: function () {
                    ...
                    control.container
                         ...
                         .on('click', function () {
                              ...
                              addMenuSection.selectDefaultLocation(
                    ...
                    api.bind('add', function (setting) {
                         ...
                         menuId = matches[1];
                         option = new Option(
                              displayNavMenuName(setting().name),
                              menuId,
                         );
          ...
          /** @lends wp.customize.Menus.MenuItemControl.prototype */ {
               ...
               initialize: function (id, options) {
                    ...
                    control.expanded.bind(function (expanded) {
                         ...
                         args = $.extend(
                              {},
                              control.defaultExpandedArguments,
                              args,
                         );
               ...
               initAccessibility: function () {
                    ...
                    menu.on(
                         ...
                         '.menu-item',
                         function () {
                              control.refreshAdvancedAccessibilityOfItem(
                                   $(this).find('button.item-edit'),
                              );
                         },
                    );
               ...
               refreshAdvancedAccessibilityOfItem: function (itemToRefresh) {
                    ...
                    if (
                         true !==
                         $(itemToRefresh).data('needs_accessibility_refresh')
                    ) {
                         return;
                    }
               ...
               actuallyEmbed: function () {
                    ...
                    $('button.item-edit').data(
                         'needs_accessibility_refresh',
                         true,
                    );
               },
               ...
               _setupControlToggle: function () {
                    ...
                    this.container
                         ...
                         .on('click', function (e) {
                              ...
                              if (
                                   menuControl.isReordering ||
                                   menuControl.isSorting
                              ) {
                                   return;
                              }
                              control.toggleForm();
               ...
               _setupReorderUI: function () {
                    ...
                    $reorderNav = control.container.find(
               ...
               _setupUpdateUI: function () {
                         ...
                         if (false === to) {
                                   ...
                                   function (otherControl) {
                                        if (
                                             from.menu_item_parent ===
                                                  otherControl.setting()
                                                       .menu_item_parent &&
                                             otherControl.setting().position >
                                                  from.position
                                        ) {
                                             followingSiblingItemControls.push(
                                                  otherControl,
                                             );
                                        } else if (
                                             otherControl.setting()
                                                  .menu_item_parent === itemId
                                        ) {
                                             childrenItemControls.push(
                                                  otherControl,
                                             );
                                        }
                                   },
                              ...
                              _.each(
                                   ...
                                   function (followingSiblingItemControl) {
                                        var value = _.clone(
                                             followingSiblingItemControl.setting(),
                                        );
                                        value.position +=
                                             childrenItemControls.length;
                                        followingSiblingItemControl.setting.set(
                                             value,
                                        );
                                   },
                              );
                    ...
                    control.setting.notifications.bind(
                         'add',
                         updateNotifications,
                    );
                    control.setting.notifications.bind(
                    ...
                    $removeBtn.on('click', function () {
                         ...
                         var addingItems = true,
                              ...
                              deleteItemOriginalItemId =
                                   control.params.original_item_id,
                              addedItems = control
                                   .getMenuControl()
                         ...
                         $next = control.container
                              .nextAll(
                                   '.customize-control-nav_menu_item:visible',
                              )
                              .first();
               ...
               _setupTitleUI: function () {
                    ...
                    control.setting.bind(function (item) {
                         ...
                         titleText =
                              trimmedTitle ||
                              item.original_title ||
                              api.Menus.data.l10n.untitled;

                         if (item._invalid) {
                              titleText =
                                   api.Menus.data.l10n.invalidTitleTpl.replace(
                                        '%s',
                                        titleText,
                                   );
                         }
               ...
               renderContent: function () {
                    ...
                    if (settingValue._invalid) {
                         ...
                         control.params.title =
                              api.Menus.data.pendingTitleTpl.replace(
                                   '%s',
                                   control.params.title,
                              );
                    }
                    ...
                    control.params.original_title =
                         settingValue.original_title || '';
               ...
               getMenuControl: function () {
                    ...
                    if (settingValue && settingValue.nav_menu_term_id) {
                         return api.control(
                              'nav_menu[' + settingValue.nav_menu_term_id + ']',
                         );
                    } else {
                         return null;
                    }
               ...
               expandControlSection: function () {
                    ...
                    if (!$section.hasClass('open')) {
                         $section
                              .find('.accordion-section-title:first')
                              .trigger('click');
                    }
               },
               ...
               _changePosition: function (offset) {
                    ...
                    if (1 !== offset && -1 !== offset) {
                         throw new Error(
                              'Offset changes by 1 are only supported.',
                         );
                    }
                    ...
                    if (-1 === realPosition) {
                         throw new Error(
                              'Expected setting to be among siblings.',
                         );
                    }
                    ...
                    if (
                         ...
                         (realPosition === siblingSettings.length - 1 &&
                              offset > 0)
                    ) {
               ...
               _changeDepth: function (offset) {
                    ...
                    if (-1 === realPosition) {
                         throw new Error(
                              'Expected control to be among siblings.',
                         );
                    }
                    ...
                    if (-1 === offset) {
                         ...
                         _(control.getMenuControl().getMenuItemControls()).each(
                              function (otherControl) {
                                   ...
                                   isControlToBeShifted =
                                        otherControl.setting()
                                             .menu_item_parent ===
                                             parentControl.setting()
                                                  .menu_item_parent &&
                                        otherControl.setting().position >
                                             parentControl.setting().position;
                                   if (isControlToBeShifted) {
                                        otherControlSettingValue = _.clone(
                                             otherControl.setting(),
                                        );
                                        otherControl.setting.set(
                                             $.extend(
                                                  ...
                                                  {
                                                       position:
                                                            otherControlSettingValue.position +
                                                            1,
                                                  },
                                             ),
                                        );
                         ...
                         settingValue.position =
                              parentControl.setting().position + 1;
                         settingValue.menu_item_parent =
                         ...
                         settingValue.menu_item_parent =
                              siblingControl.params.menu_item_id;
     ...
     api.Menus.MenuLocationsControl = api.Control.extend(
          /** @lends wp.customize.Menus.MenuLocationsControl.prototype */ {
               ...
               ready: function () {
                    ...
                    control.container
                         .find('.assigned-menu-location')
                         .each(function () {
                              var container = $(this),
                                   checkbox = container.find(
                                        'input[type=checkbox]',
                                   ),
                                   ...
                                   updateSelectedMenuLabel = function (
                                        selectedMenuId,
                                   ) {
                                        var menuSetting = api(
                                             'nav_menu[' +
                              ...
                              updateCheckbox(
                                   navMenuLocationSetting.get() ===
                                        control.params.menu_id,
                              );
     ...
     api.Menus.MenuControl = api.Control.extend(
          /** @lends wp.customize.Menus.MenuControl.prototype */ {
               ...
               ready: function () {
                    ...
                    if (menu) {
                         ...
                         api.control.each(function (widgetControl) {
                              if (
                                   !widgetControl.extended(
                                        api.controlConstructor.widget_form,
                                   ) ||
                                   'nav_menu' !==
                                        widgetControl.params.widget_id_base
                              ) {
                                   return;
                              }
                              ...
                              widgetControl.container
                                   .find(
                                        '.nav-menu-widget-no-menus-message:first',
                                   )
                                   .hide();
                         ...
                         widgetTemplate
                              ...
                              .hide();
                         select = widgetTemplate.find(
                              '.widget-inside select:first',
                         );
                         if (
                              0 ===
                              select.find(
                    ...
                    control.setting.bind(function (to) {
                         ...
                         if (false === to) {
                              ...
                              api.control.each(function (widgetControl) {
                                   ...
                                   var select =
                                        widgetControl.container.find('select');
                                   select
                                        .find(
                                             'option[value=' +
                                                  String(menuId) +
                    ...
                    menuList.on('sortstop', function () {
                         setTimeout(function () {
                              ...
                              var menuItemContainerIds =
                                        control.$sectionContent.sortable(
                                             'toArray',
                                        ),
                                   menuItemControls = [],
                                   position = 0,
                              ...
                              _.each(
                                   ...
                                   function (menuItemControl) {
                                        if (
                                             false === menuItemControl.setting()
                                        ) {
                                             // Skip deleted items.
                                             return;
                                        }
                                        var setting = _.clone(
                                             menuItemControl.setting(),
                                        );
                                        position += 1;
                                        priority += 1;
                    ...
                    if (section && section.expanded()) {
                         section.collapse({
                              completeCallback: function () {
                                   removeSection();
                                   wp.a11y.speak(
                                        api.Menus.data.l10n.menuDeleted,
                                   );
               ...
               toggleReordering: function (showOrHide) {
                    var addNewItemBtn =
                              this.container.find('.add-new-menu-item'),
                    ...
                    if (
                         showOrHide ===
                         this.$sectionContent.hasClass('reordering')
                    ) {
                         return;
                    }
                    ...
                    if (this.isReordering) {
                         ...
                         reorderBtn.attr(
                              'aria-label',
                              api.Menus.data.l10n.reorderLabelOff,
                         );
                         ...
                         reorderBtn.attr(
                              'aria-label',
                              api.Menus.data.l10n.reorderLabelOn,
                         );
               ...
               reflowMenuItems: function () {
                    ...
                    reflowRecursively = function (context) {
                         ...
                         currentMenuItemControls.sort(function (a, b) {
                              return (
                                   a.setting().position - b.setting().position
                              );
                         });
                         ...
                         _.each(
                              ...
                              function (menuItemControl) {
                                   ...
                                   menuItemControl.priority.set(
                                        context.currentAbsolutePosition,
                                   ); // This will change the sort order.

                                   // Update depth.
                                   if (
                                        !menuItemControl.container.hasClass(
                                             'menu-item-depth-' +
                                                  String(context.currentDepth),
                                        )
                                   ) {
                                        _.each(
                                             menuItemControl.container
                                   ...
                                   menuItemControl.container.data(
                                        'item-depth',
               ...
               addItemToMenu: function (item) {
                    ...
                    customizeId =
                         'nav_menu_item[' + String(placeholderId) + ']';
                    settingArgs = {
                         type: 'nav_menu_item',
                         transport: api.Menus.data.settingTransport,
                         previewer: api.previewer,
     ...
     api.Menus.applySavedData = function (data) {
          ...
          _(data.nav_menu_updates).each(function (update) {
               ...
               if ('inserted' === update.status) {
                    ...
                    oldCustomizeId =
                         'nav_menu[' + String(update.previous_term_id) + ']';
                    if (!api.has(oldCustomizeId)) {
                         throw new Error(
                              'Expected setting to exist: ' + oldCustomizeId,
                         );
                    }
                    oldSetting = api(oldCustomizeId);
                    if (!api.section.has(oldCustomizeId)) {
                         throw new Error(
                              'Expected control to exist: ' + oldCustomizeId,
                         );
                    }
                    ...
                    if (!settingValue) {
                         throw new Error(
                              'Did not expect setting to be empty (deleted).',
                         );
                    }
                    settingValue = $.extend(
                         _.clone(settingValue),
                         update.saved_value,
                    );

                    insertedMenuIdMapping[update.previous_term_id] =
                         update.term_id;
                    ...
                    api.control.each(function (setting) {
                         ...
                         oldMenuOption = select.find(
                              'option[value=' +
                                   String(update.previous_term_id) +
                                   ']',
                         );
                    ...
                    if (!api.has(customizeId)) {
                         throw new Error(
                              'Expected setting to exist: ' + customizeId,
                         );
                    }
          ...
          _(data.nav_menu_item_updates).each(function (update) {
               if (update.previous_post_id) {
                    insertedMenuItemIdMapping[update.previous_post_id] =
                         update.post_id;
               }
          });
          ...
          _(data.nav_menu_item_updates).each(function (update) {
               ...
               if ('inserted' === update.status) {
                    ...
                    oldCustomizeId =
                         'nav_menu_item[' +
                         String(update.previous_post_id) +
                         ']';
                    if (!api.has(oldCustomizeId)) {
                         throw new Error(
                              'Expected setting to exist: ' + oldCustomizeId,
                    ...
                    newCustomizeId =
                         'nav_menu_item[' + String(update.post_id) + ']';
                    newSetting = api.create(
                         newCustomizeId,
                         newCustomizeId,
                         settingValue,
                    ...
                    newControl = new api.controlConstructor.nav_menu_item(
                         newCustomizeId,
                         {
                              ...
                              section:
                                   'nav_menu[' +
                                   String(settingValue.nav_menu_term_id) +
                                   ']',
