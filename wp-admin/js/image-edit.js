...
(function ($) {
     ...
     var imageEdit = (window.imageEdit = {
          ...
          toggleCropTool: function (postid, nonce, cropButton) {
               ...
               var $el = $(cropButton);
               var state =
                    $el.attr('aria-expanded') === 'true' ? 'true' : 'false';
          ...
          togglePopup: function (el) {
               ...
               $target
                    .toggleClass('imgedit-popup-menu-open')
                    .slideToggle('fast')
                    .css({ 'z-index': 200000 });
          ...
          monitorPopup: function () {
               ...
               var $toggle = document.querySelector(
                    '.imgedit-rotate-menu-container .imgedit-rotate',
               );
          ...
          toggleControls: function (el) {
               ...
               $target
                    .parent('.imgedit-group')
                    .toggleClass('imgedit-panel-active');
          ...
          scaleChanged: function (postid, x, el) {
               ...
               if (x) {
                    h1 =
                         w.val() !== ''
                              ? Math.round(w.val() / this.hold.xy_ratio)
                              : '';
                    h.val(h1);
               } else {
                    w1 =
                         h.val() !== ''
                              ? Math.round(h.val() * this.hold.xy_ratio)
                              : '';
                    w.val(w1);
               }
          ...
          focusManager: function () {
               ...
               setTimeout(function () {
                    ...
                    if (!elementToSetFocusTo.length) {
                         elementToSetFocusTo =
                              $('.imgedit-wrap').find(':tabbable:first');
                    }
          ...
          initCrop: function (postid, image, parent) {
               ...
               t.iasapi = $image.imgAreaSelect({
                    ...
                    onSelectStart: function () {
                         imageEdit.setDisabled(
                              $('#imgedit-crop-sel-' + postid),
                              1,
                         );
                         imageEdit.setDisabled($('.imgedit-crop-clear'), 1);
          ...
          setCropSelection: function (postid, c) {
               ...
               if (!c || (c.width < 3 && c.height < 3)) {
                    this.setDisabled(
                         $('.imgedit-crop', '#imgedit-panel-' + postid),
                         1,
                    );
               ...
               if (x && y) {
                    ...
                    if ((sel = this.iasapi.getSelection(true))) {
                         ...
                         if (r > h) {
                              ...
                              var error = $('#imgedit-crop-' + postid).find(
                                   '.notice-error',
                              );
