...
(function ($) {
     ...
     window.wpWidgets = {
          ...
          init: function () {
               ...
               $(document.body).on('click.widgets-toggle', function (e) {
                    ...
                    if (
                         ...
                         targetWidth = parseInt(
                              widget.find('input.widget-width').val(),
                              10,
                         );
                         ...
                         if (inside.is(':hidden')) {
                              if (
                                   ...
                                   widget.closest('div.widgets-sortables')
                                        .length
                              ) {
                                   if (
                                        widget.closest(
                         ...
                         target.attr('id') === 'inactive-widgets-control-remove'
                    ) {
               ...
               sidebars.droppable({
                    ...
                    over: function (event) {
                         ...
                         if (
                              ...
                              !$wrap.is(wpWidgets.hoveredSidebar)
                         ) {
                    ...
                    .sortable({
                         ...
                         receive: function (event, ui) {
                              ...
                              if (
                                   $sender
                                        .attr('id')
                                        .indexOf('orphaned_widgets') > -1 &&
                                   !$sender.children('.widget').length
                              ) {
                                   $sender
                                        .parents('.orphan-sidebar')
               ...
               $('#widgets-right .widgets-holder-wrap').each(
                    function (index, element) {
                         var $element = $(element),
                              name =
                                   $element.find('.sidebar-name h2').text() ||
                                   '',
                              ariaLabel = $element
                                   .find('.sidebar-name')
                                   .data('add-to'),
                              id = $element
                                   .find('.widgets-sortables')
                                   .attr('id'),
                              li = $('<li>'),
                              button = $('<button>', {
                                   type: 'button',
               ...
               $('#available-widgets .widget .widget-top').on(
                    ...
                    function () {
                         var $widget = $(this).closest('.widget'),
                              ...
                              chooserButtons = selectSidebar.find(
               ...
               chooser
                    .on('click.widgets-chooser', function (event) {
                         ...
                         if ($target.hasClass('button-primary')) {
                              ...
                              $target.hasClass('widgets-chooser-cancel')
                         ) {
                              self.closeChooser();
                         }
                    })
          ...
          removeInactiveWidgets: function () {
               ...
               $.post(ajaxurl, data, function () {
                    $('#wp_inactive_widgets .widget').each(function () {
                         var $widget = $(this);
                         delete self.dirtyWidgets[
                              $widget.find('input.widget-id').val()
                         ];
                         $widget.remove();
                    });
                    $('#inactive-widgets-control-remove').prop(
          ...
          closeChooser: function () {
               var self = this,
                    widgetInQuestion = $(
                         '#available-widgets .widget-in-question',
                    );
