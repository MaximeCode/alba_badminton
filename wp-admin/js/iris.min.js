          ...
          j
               ...
               : ((b = a('<div id="iris-gradtest" />')),
                 ...
                 a.each(l, function (a, e) {
                      if ((b.css(d, e + c), b.css(d).match('gradient')))
                           return (k = a), !1;
                 }),
                 !1 === k &&
                      (b.css(
     ...
     (a.support.iris = !0),
          (a.fn.gradient = function () {
               ...
               return this.each(function () {
                    j
                         ? e.apply(this, b)
                         : a(this).css('backgroundImage', d.apply(this, b));
               });
          }),
          ...
          (n = {
               ...
               _create: function () {
                    ...
                    !1 === k && c(),
                         d.is('input')
                              ? (b.options.target
                                     ? (b.picker = a(i).appendTo(
                                            b.options.target,
                                       ))
                                     : (b.picker = a(i).insertAfter(d)),
                                b._addInputListeners(d))
                              : (d.append(i),
                                (b.picker = d.find('.iris-picker'))),
                         p
                              ? 9 === q
                         ...
                         (b.horizontalSlider =
                              b.onlySlider &&
                              'horizontal' === b.options.slider),
                         b.onlySlider &&
                              ((b.options.controls.strip = 'h'),
                              e || (e = 'hsl(10,100,50)')),
                         ...
                         (b.controls = {
                              ...
                              stripSlider: b.picker.find(
                                   '.iris-strip .iris-slider-offset',
                              ),
                         }),
                         'hsv' === b.options.mode &&
                         b._has('l', b.options.controls)
               ...
               _initControls: function () {
                    ...
                    c.stripSlider.slider({
                         ...
                         c.squareDrag
                              .draggable({
                                   containment:
                                        c.square.find('.iris-square-inner'),
                                   zIndex: 1e3,
                                   cursor: 'move',
                                   drag: function (a, c) {
                                        b._squareDrag(a, c);
                              ...
                              .on('keydown', function (a) {
                                   ...
                                   (f.left = Math.max(
                                        0,
                                        Math.min(f.left, d.width()),
                                   )),
                                        (f.top = Math.max(
                                             0,
                                             Math.min(f.top, d.height()),
                                        )),
                                        e.css(f),
               ...
               _squareDrag: function (a, b) {
                    var c = this,
                         ...
                         f = Math.round(
                              ((e.h - b.position.top) / e.h) * c._scale[d.vert],
                         ),
                         g =
                              c._scale[d.horiz] -
                              Math.round(
                                   ((e.w - b.position.left) / e.w) *
                                        c._scale[d.horiz],
                              );
                         ...
                         case 'color':
                              f.onlySlider
                                   ? ((c = parseInt(c, 10)),
                                     ...
                                     (f._color = new Color(c).setHSpace(
                                          f.options.mode,
                                     )),
                                     (f.active = 'external'),
                                     f._change())
                                   : ((c = '' + c),
                                     c.replace(/^#/, ''),
                                     (d = new Color(c).setHSpace(
                                          f.options.mode,
                                     )),
                                     d.error
                                          ? (f.options[b] = g)
                                          : ((f._color = d),
                                            (f.options.color = f.options[b] =
                                                 f._color.toString()),
                                            (f.active = 'external'),
                                            f._change()));
                              break;
          ...
          c.fn = c.prototype = {
               ...
               fromCSS: function (a) {
                    ...
                    if (
                         ...
                         if (
                              4 === b.length &&
                              (this.a(parseFloat(b.pop())), this.error)
                         )
                              return this;
               ...
               getReadableContrastingColor: function (a, d) {
                    ...
                    if (h >= g) return this;
                    if (
                         ((e = a.getMaxContrastColor()),
                         e.getDistanceLuminosityFrom(a) <= g)
                    )
                         return e;
                    for (
                         f = 0 === e.toInt() ? -1 : 1;
