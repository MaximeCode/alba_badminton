...
(function (wp, $) {
     ...
     api.Widgets.AvailableWidgetsPanelView = wp.Backbone.View.extend(
          /** @lends wp.customize.Widgets.AvailableWidgetsPanelView.prototype */ {
               ...
               search: _.debounce(function (event) {
                    ...
                    if (!this.selected && event.target.value) {
                         firstVisible = this.$el.find(
                              '> .widget-tpl:visible:first',
                         );
               ...
               announceSearchMatches: function () {
                    var message = l10n.widgetsFound.replace(
                         '%d',
               ...
               updateList: function () {
                    this.collection.each(function (widget) {
                         ...
                         widgetTpl.toggle(
                              widget.get('search_matched') &&
                                   !widget.get('is_disabled'),
                         );
                         if (
                              widget.get('is_disabled') &&
                              widgetTpl.is(this.selected)
                         ) {
                              this.selected = null;
                         }
                    });
               ...
               keyboardAccessible: function (event) {
                    var isEnter = event.which === 13,
                         ...
                         lastVisible = this.$el.find(
                              '> .widget-tpl:visible:last',
                         ),
                         isSearchFocused = $(event.target).is(this.$search),
                         isLastWidgetFocused = $(event.target).is(
                              '.widget-tpl:visible:last',
                         );
                    ...
                    if (isDown || isUp) {
                         if (isDown) {
                              if (isSearchFocused) {
                                   ...
                                   this.selected &&
                                   this.selected.nextAll('.widget-tpl:visible')
                                        .length !== 0
                              ) {
                                   selected = this.selected.nextAll(
                                        '.widget-tpl:visible:first',
                                   );
                              }
                         } else if (isUp) {
                              if (isSearchFocused) {
                                   ...
                                   this.selected &&
                                   this.selected.prevAll('.widget-tpl:visible')
                                        .length !== 0
                              ) {
                                   selected = this.selected.prevAll(
                                        '.widget-tpl:visible:first',
                                   );
                              }
                         }
                    ...
                    if (
                         ...
                         isTab &&
                         ((isShift && isSearchFocused) ||
                              (!isShift && isLastWidgetFocused))
                    ) {
                         this.currentSidebarControl.container
                              .find('.add-new-widget')
                              .focus();
          ...
          /** @lends wp.customize.Widgets.WidgetControl.prototype */ {
               ...
               _setupModel: function () {
                    ...
                    rememberSavedWidgetId = function () {
                         api.Widgets.savedWidgetIds[self.params.widget_id] =
                              true;
                    };
               ...
               _setupWideWidget: function () {
                    ...
                    $customizeSidebar = $(
                         '.wp-full-overlay-sidebar-content:first',
                    );
               ...
               _setupControlToggle: function () {
                    ...
                    $closeBtn.on('click', function () {
                         self.collapse();
                         self.container
                              .find('.widget-top .widget-action:first')
               ...
               _setupWidgetTitle: function () {
                    ...
                    updateTitle = function () {
                         var title = self.setting().title,
                              inWidgetTitle =
                                   self.container.find('.in-widget-title');
               ...
               _setupReorderUI: function () {
                    ...
                    selectSidebarItem = function (li) {
                         ...
                         var isSelfSidebar =
                              li.data('id') === self.params.sidebar_id;
                         self.container
                    ...
                    $moveWidgetArea = $(
                         template({
                              sidebars: _(
                                   api.Widgets.registeredSidebars.toArray(),
                              ).pluck('attributes'),
                         }),
                    );
                    ...
                    updateAvailableSidebars = function () {
                         ...
                         $sidebarItems.each(function () {
                              ...
                              sidebar =
                                   api.Widgets.registeredSidebars.get(
                                        sidebarId,
                                   );
                    ...
                    $reorderNav
                         .find(
                              '.move-widget, .move-widget-down, .move-widget-up',
                         )
                         .each(function () {
                              $(this).prepend(
                                   self.container.find('.widget-title').text() +
                                        ': ',
                              );
                         })
                         .on('click keypress', function (event) {
                              ...
                              if ($(this).is('.move-widget')) {
                                   ...
                                   var isMoveDown =
                                             $(this).is('.move-widget-down'),
                                        isMoveUp =
                                             $(this).is('.move-widget-up'),
                    ...
                    this.container.find('.move-widget-btn').click(function () {
                         self.getSidebarWidgetsControl().toggleReordering(
                              false,
                         );
               ...
               _setupRemoveUI: function () {
                    ...
                    $removeBtn.on('click', function () {
                         ...
                         if (
                              self.container
                                   .next()
                                   .is('.customize-control-widget_form')
                         ) {
                         ...
                         self.container.slideUp(function () {
                              ...
                              sidebarWidgetIds = sidebarsWidgetsControl
                                   .setting()
                                   .slice();
                              i = _.indexOf(
                                   sidebarWidgetIds,
               ...
               getSidebarWidgetsControl: function () {
                    ...
                    settingId =
                         'sidebars_widgets[' + this.params.sidebar_id + ']';
               ...
               updateWidget: function (args) {
                    ...
                    params.customized =
                         wp.customize.previewer.query().customized;
                         ...
                         data +=
                              ...
                              $.param({
                                   sanitized_widget_setting:
                                        JSON.stringify(instanceOverride),
                              });
                    } else {
                    ...
                    jqxhr.done(function (r) {
                         ...
                         if (r.success) {
                              ...
                              if (
                                   ...
                                   $(document).trigger('widget-synced', [
                                        $widgetRoot,
                                        r.data.form,
                                   ]);
               ...
               onChangeExpanded: function (expanded, args) {
                    ...
                    $toggleBtn = this.container.find(
                         '.widget-top button.widget-action',
                    );
               ...
               getWidgetSidebarPosition: function () {
                    ...
                    sidebarWidgetIds =
                         this.getSidebarWidgetsControl().setting();
                    position = _.indexOf(
                         sidebarWidgetIds,
                         this.params.widget_id,
                    );
               ...
               _moveWidgetByOne: function (offset) {
                    ...
                    sidebarWidgetsSetting =
                         this.getSidebarWidgetsControl().setting;
                    sidebarWidgetIds = Array.prototype.slice.call(
                         sidebarWidgetsSetting(),
                    ); // Clone.
               ...
               ready: function () {
                    ...
                    panel.deferred.embedded.done(function () {
                         var panelMetaContainer,
                              ...
                              shouldShowNotice;
                         panelMetaContainer =
                              panel.container.find('.panel-meta');
                         ...
                         api.bind('pane-contents-reflowed', function () {
                              var duration =
                                   'resolved' ===
                                   api.previewer.deferred.active.state()
                                        ? 'fast'
                                        : 0;
                              updateNotice();
                              if (shouldShowNotice()) {
          ...
          /** @lends wp.customize.Widgets.SidebarControl.prototype */ {
               ...
               _setupModel: function () {
                    ...
                    this.setting.bind(function (newWidgetIds, oldWidgetIds) {
                         ...
                         removedWidgetIds =
                              _(oldWidgetIds).difference(newWidgetIds);
                         ...
                         _(widgetFormControls).each(
                              function (widgetFormControl) {
                                   widgetFormControl.params.sidebar_id =
                                        self.params.sidebar_id;
                              },
                         );
                         ...
                         _(removedWidgetIds).each(function (removedWidgetId) {
                              ...
                              setTimeout(function () {
                                   ...
                                   removedIdBase =
                                        parseWidgetId(removedWidgetId).id_base;
                                   widget =
                                        api.Widgets.availableWidgets.findWhere({
               ...
               toggleReordering: function (showOrHide) {
                    var addNewWidgetBtn =
                              this.$sectionContent.find('.add-new-widget'),
                         reorderBtn = this.container.find('.reorder-toggle'),
                         widgetsTitle =
                              this.$sectionContent.find('.widget-title');
               ...
               addWidget: function (widgetId) {
                    ...
                    if (widget.get('is_multi')) {
                         controlContainer
                              ...
                              .val(widgetNumber);
                         controlContainer
                              .find('input[name="multi_number"]')
                              .val(widgetNumber);
                    }

                    widgetId = controlContainer
                         .find('[name="widget-id"]')
                         .val();
     ...
     (api.Widgets.highlightWidgetFormControl = function (widgetId) {
           ...
           * @return {Object|null}
           */
          (api.Widgets.getSidebarWidgetControlContainingWidget = function (
               widgetId,
          ) {
     ...
     $(document).on('widget-added', function (event, widgetContainer) {
          ...
          parsedWidgetId = parseWidgetId(
               widgetContainer
                    .find('> .widget-inside > .form > .widget-id')
                    .val(),
          );
          ...
          editMenuButton = widgetContainer.find(
               '.edit-selected-nav-menu > button',
          );
