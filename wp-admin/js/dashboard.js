     ...
     app = window.wp.communityEvents = /** @lends wp.communityEvents */ {
          ...
          renderEventsTemplate: function (templateParams, initiatedBy) {
               ...
               if (templateParams.location.ip) {
                    ...
                    elementVisibility['#community-events-location-message'] =
                         true;
                    ...
                    template = wp.template(
                         'community-events-attend-event-near',
                    );
                    ...
                    elementVisibility['.community-events-could-not-locate'] =
                         true;
                    ...
                    elementVisibility['.community-events-errors'] = true;
                    elementVisibility['.community-events-error-occurred'] =
                         true;
               } else {
                    $locationMessage.text(
