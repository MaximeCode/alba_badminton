...
(function (exports, $) {
     ...
     api.OverlayNotification = api.Notification.extend(
          /** @lends wp.customize.OverlayNotification.prototype */ {
               ...
               initialize: function (code, params) {
                    ...
                    api.Notification.prototype.initialize.call(
                         notification,
                         code,
                         params,
                    );
          ...
          /** @lends wp.customize.Notifications.prototype */ {
               ...
               add: function (notification, notificationObject) {
                    ...
                    if (!collection.has(code)) {
                         ...
                         collection._addedOrder[code] =
                              collection._addedIncrement;
                    }
                    return api.Values.prototype.add.call(
                         collection,
                         code,
                         instance,
                    );
               ...
               get: function (args) {
                    ...
                    if (params.sort) {
                         ...
                         notifications.sort(function (a, b) {
                              ...
                              return (
                                   collection._addedOrder[b.code] -
                                   collection._addedOrder[a.code]
               ...
               render: function () {
                    ...
                    if (
                         ...
                         _.isEqual(
                              notifications,
                              collection.previousNotifications,
                         )
                    ) {
                         return;
                    }
                    ...
                    hasOverlayNotification = Boolean(
                         overlayNotifications.length,
                    );
                    ...
                    if (hasOverlayNotification !== hadOverlayNotification) {
                         ...
                         if (hasOverlayNotification) {
                              collection.previousActiveElement =
                                   document.activeElement;
                              $(document).on(
                                   'keydown',
                                   collection.constrainFocus,
                              );
                         } else {
                              $(document).off(
                                   'keydown',
                    ...
                    if (hasOverlayNotification) {
                         collection.focusContainer =
                              overlayNotifications[
                                   overlayNotifications.length - 1
                              ].container;
                         collection.focusContainer.prop('tabIndex', -1);
                         focusableElements =
                              collection.focusContainer.find(':focusable');
          ...
          /** @lends wp.customize.Setting.prototype */ {
               ...
               preview: function () {
                    ...
                    if (
                         ...
                         !api.state('previewerAlive').get()
                    ) {
                         transport = 'refresh';
                    }

                    if ('postMessage' === transport) {
                         setting.previewer.send('setting', [
                              setting.id,
                              setting(),
                         ]);
     ...
     api.bind('ready', function () {
          api.bind('add', function incrementCreatedSettingRevision(setting) {
               if (setting._dirty) {
                    api._latestRevision += 1;
                    api._latestSettingRevisions[setting.id] =
                         api._latestRevision;
               }
          });
     });
          ...
          request.done(function requestChangesetUpdateDone(data) {
               ...
               if (data.setting_validities) {
                    _.each(
                         ...
                         function (validity, settingId) {
                              if (
                                   true === validity &&
                                   _.isObject(submittedChanges[settingId]) &&
                                   !_.isUndefined(
                                        submittedChanges[settingId].value,
                                   )
                              ) {
                                   savedChangesetValues[settingId] =
                                        submittedChanges[settingId].value;
                              }
                         },
                    );
               ...
               api.previewer.send(
                    'changeset-saved',
                    _.extend({}, data, {
                         saved_changeset_values: savedChangesetValues,
                    }),
               );
          });
     ...
     focus = function (params) {
          ...
          focus = function () {
               ...
               var focusContainer;
               if (
                    (construct.extended(api.Panel) ||
                         construct.extended(api.Section)) &&
                    construct.expanded &&
                    construct.expanded()
               ) {
     ...
     api.utils.getCurrentTimestamp = function getCurrentTimestamp() {
          ...
          currentDate = new Date(
               api.settings.initialServerDate.replace(/-/g, '/'),
          );
          timestampDifferential =
               currentClientTimestamp - api.settings.initialClientTimestamp;
          timestampDifferential +=
               api.settings.initialClientTimestamp -
               api.settings.initialServerTimestamp;
          ...
          /** @lends wp.customize~Container.prototype */ {
               ...
               initialize: function (id, options) {
                    ...
                    if (!container.params.instanceNumber) {
                         container.params.instanceNumber =
                              Container.instanceCounter;
                    }
                    ...
                    container.active.bind(function (active) {
                         ...
                         args = $.extend(
                              {},
                              container.defaultActiveArguments,
                              args,
                         );
                    ...
                    container.expanded.bind(function (expanded) {
                         ...
                         args = $.extend(
                              {},
                              container.defaultExpandedArguments,
                              args,
                         );
               ...
               setupNotifications: function () {
                    ...
                    renderNotifications();
                    container.notifications.bind(
                         'change',
                         _.debounce(renderNotifications),
                    );
               },
               ...
               _toggleExpanded: function (expanded, params) {
                    ...
                    params.completeCallback = function () {
                         if (previousCompleteCallback) {
                              previousCompleteCallback.apply(
                                   instance,
                                   arguments,
                              );
                         }
                    ...
                    if (
                         ...
                         params.unchanged = true;
                         instance.onChangeExpanded(
                              instance.expanded.get(),
                              params,
                         );
                         return false;
                    } else {
               ...
               _animateChangeExpanded: function (completeCallback) {
                    ...
                    _.defer(function () {
                         var container = content.closest(
                              ...
                              previousScrollTop =
                                   content.data('previous-scrollTop') || 0,
                         ...
                         if (expanded && 0 < currentScrollTop) {
                              ...
                              !expanded &&
                              0 < currentScrollTop + previousScrollTop
                         ) {
                              content.css(
                                   'top',
                                   previousScrollTop - currentScrollTop + 'px',
                              );
               ...
               getContainer: function () {
                    ...
                    if (template && container.container) {
                         return template(
                              _.extend({ id: container.id }, container.params),
                         )
                              .toString()
                              .trim();
                    }
               ...
               getContent: function () {
                    var construct = this,
                         ...
                         content = container
                              .find(
                                   '.accordion-section-content, .control-panel-content',
                              )
                              .first(),
                    ...
                    if (alreadyOwnedElements) {
                         ownedElements =
                              ownedElements + ' ' + alreadyOwnedElements;
                    }
          ...
          /** @lends wp.customize.Section.prototype */ {
               ...
               initialize: function (id, options) {
                    ...
                    section.panel.bind(function (id) {
                         $(section.headContainer).toggleClass(
                              'control-subsection',
                              !!id,
                         );
                    });
               ...
               embed: function () {
                    ...
                    section.containerParent = api.ensure(
                                   ...
                                   panel.deferred.embedded.done(function () {
                                        ...
                                        if (
                                             !section.contentContainer
                                                  .parent()
                                                  .is(section.headContainer)
                                        ) {
                                             section.containerParent.append(
                                                  section.contentContainer,
                                             );
                                        }
               ...
               attachEvents: function () {
                    ...
                    section.container
                         .find(
                              '.accordion-section-title, .customize-section-back',
                         )
                    ...
                    section.container
                         .find(
                              '.customize-section-title .customize-help-toggle',
                         )
                         .on('click', function () {
                              ...
                              content = meta.find(
                                   '.customize-section-description:first',
                              );
               ...
               onChangeExpanded: function (expanded, args) {
                    var section = this,
                         ...
                         overlay =
                              section.headContainer.closest('.wp-full-overlay'),
                    ...
                    if (expanded && !content.hasClass('open')) {
                         ...
                         if (section.panel()) {
                              ...
                              if (
                                   panel.contentContainer.hasClass(
                                        'skip-transition',
                                   )
                              ) {
                                   panel.collapse();
     ...
     api.ThemesSection = api.Section.extend(
          /** @lends wp.customize.ThemesSection.prototype */ {
               ...
               initialize: function (id, options) {
                    ...
                    section.updateCountDebounced = _.debounce(
                         section.updateCount,
                         500,
                    );
               },
                         ...
                         api.panel(panelId, function (panel) {
                              ...
                              panel.deferred.embedded.done(function () {
                                   ...
                                   if (
                                        ...
                                        parentContainer
                                             .find(
                                                  '.customize-themes-full-container-container',
                                             )
               ...
               ready: function () {
                    ...
                    section.template = wp.template(
                         'customize-themes-details-view',
                    );
                    ...
                    section.renderScreenshots = _.throttle(
               ...
               attachEvents: function () {
                    ...
                    section.container.on(
                         ...
                         function () {
                              api.panel('themes').loadThemePreview(
                                   $(this).data('slug'),
                              );
                         },
                    );
               ...
               onChangeExpanded: function (expanded, args) {
                    ...
                    function expand() {
                              ...
                              if (otherSection !== section) {
                                   ...
                                   if ('themes' === otherSection.params.type) {
                                        ...
                                        if (
                                             ...
                                             '' !== section.term &&
                                             'local' !==
                                                  section.params.filter_type
                                        ) {
                                             section.term = '';
                                             section.initializeNewQuery(
                                                  section.term,
                                                  section.tags,
                                             );
                                        } else {
                         ...
                         container.on(
                              'scroll',
                              _.throttle(section.renderScreenshots, 300),
                         );
                         container.on(
                              'scroll',
                              _.throttle(section.loadMore, 300),
                         );
               ...
               checkTerm: function (section) {
                    var newTerm;
                    if ('remote' === section.params.filter_type) {
                         newTerm = section.contentContainer
                              .find('.wp-filter-search')
                              .val();
               ...
               filtersChecked: function () {
                    ...
                    if (0 === tags.length) {
                         ...
                         section.contentContainer
                              .find(
                                   '.feature-filter-toggle .filter-count-filters',
                              )
                              .hide();
                    } else {
                         section.contentContainer
                              .find(
                                   '.feature-filter-toggle .theme-filter-count',
                              )
                              .text(tags.length);
                         section.contentContainer
                              .find('.feature-filter-toggle .filter-count-0')
               ...
               getVisibleCount: function () {
                    return this.contentContainer.find(
                         'li.customize-control:visible',
                    ).length;
               },
               ...
               updateCount: function (count) {
                    ...
                    displayed =
                         section.contentContainer.find('.themes-displayed');
                    ...
                    if (0 === count) {
                         ...
                         wp.a11y.speak(
                              api.settings.l10n.announceThemeCount.replace(
                                   '%d',
                                   count,
                              ),
                         );
               ...
               loadThemePreview: function (themeId) {
                    return api.ThemesPanel.prototype.loadThemePreview.call(
                         this,
                         themeId,
                    );
               },
               ...
               showDetails: function (theme, callback) {
                    ...
                    wp.a11y.speak(
                         api.settings.l10n.announceThemeDetails.replace(
                              '%s',
                              theme.name,
                         ),
                    );
     ...
     api.Panel = Container.extend(
          /** @lends wp.customize.Panel.prototype */ {
               ...
               attachEvents: function () {
                    ...
                    meta.find(
                         '> .accordion-section-title .customize-help-toggle',
                    ).on('click', function () {
                         if (meta.hasClass('cannot-expand')) {
                              return;
                         }

                         var content = meta.find(
                              '.customize-panel-description:first',
                         );
               ...
               onChangeExpanded: function (expanded, args) {
                    ...
                    if (
                         expanded &&
                         !accordionSection.hasClass('current-panel')
                    ) {
                         // Collapse any sibling sections/panels.
                         ...
                         skipTransition =
                              accordionSection.hasClass('skip-transition');
                         if (!skipTransition) {
                              panel._animateChangeExpanded(function () {
               ...
               renderContent: function () {
                    ...
                    if (
                         0 !==
                         $('#tmpl-' + panel.templateSelector + '-content')
                              .length
                    ) {
                         template = wp.template(
                              panel.templateSelector + '-content',
                         );
                    } else {
                         template = wp.template(
                    ...
                    if (template && panel.headContainer) {
                         panel.contentContainer.html(
                              template(
                                   _.extend({ id: panel.id }, panel.params),
                              ),
                         );
                    }
               },
     ...
     api.ThemesPanel = api.Panel.extend(
          /** @lends wp.customize.ThemsPanel.prototype */ {
               ...
               canSwitchTheme: function canSwitchTheme(slug) {
                    ...
                    return (
                         'publish' ===
                              api.state('selectedChangesetStatus').get() &&
                         ('' === api.state('changesetStatus').get() ||
                              'auto-draft' ===
                                   api.state('changesetStatus').get())
                    );
               ...
               attachEvents: function () {
                    ...
                    if (
                         ...
                         panel.notifications.add(
                              new api.Notification(
                                   'theme_install_unavailable',
                                   {
                                        message: api.l10n
                                             .themeInstallUnavailable,
                                        type: 'info',
                                        dismissible: true,
                                   },
                              ),
                    ...
                    function toggleDisabledNotifications() {
                         if (panel.canSwitchTheme()) {
                              panel.notifications.remove(
                                   'theme_switch_unavailable',
                              );
                         } else {
                              panel.notifications.add(
                                   new api.Notification(
                    ...
                    api.state('selectedChangesetStatus').bind(
                         toggleDisabledNotifications,
                    );
               ...
               onChangeExpanded: function (expanded, args) {
                    ...
                    api.Panel.prototype.onChangeExpanded.apply(this, [
                         expanded,
                         args,
                    ]);
                    ...
                    if (expanded) {
                         ...
                         overlay
                              .removeClass(
                                   'in-themes-panel themes-panel-expanded',
                              )
                              .find('.customize-themes-full-container')
                              .removeClass('animate');
                    }
               ...
               installTheme: function (event) {
                    ...
                    onInstallSuccess = function (response) {
                         ...
                         if (preview) {
                              ...
                              api.control.add(themeControl);
                              api.control(themeControl.id).container.trigger(
                                   'render-screenshot',
                              );
     ...
     api.Control = api.Class.extend(
          /** @lends wp.customize.Control.prototype */ {
               ...
               initialize: function (id, options) {
                    ...
                    control.selector =
                         '#customize-control-' +
                         id.replace(/\]/g, '').replace(/\[/g, '-'); // Deprecated, likely dead code from time before #28709.
                    if (control.params.content) {
                    ...
                    control.active.bind(function (active) {
                         ...
                         args = $.extend(
                              {},
                              control.defaultActiveArguments,
                              args,
                         );
                    ...
                    control.priority.set(
                         isNaN(control.params.priority)
                              ? 10
                              : control.params.priority,
                    );
                    ...
                    if (0 === deferredSettingIds.length) {
                         ...
                         api.apply(
                              api,
                              deferredSettingIds.concat(gatherSettings),
                         );
                    }
               ...
               linkElements: function () {
                    ...
                    nodes.each(function () {
                         ...
                         if (node.data('customizeSettingLink')) {
                              ...
                              setting =
                                   control.settings[
                                        node.data('customizeSettingKeyLink')
                                   ];
                         }
               ...
               embed: function () {
                    ...
                    inject = function (sectionId) {
                         ...
                         api.section(sectionId, function (section) {
                              ...
                              section.deferred.embedded.done(function () {
                                   parentContainer =
                                        section.contentContainer.is('ul')
                                             ? section.contentContainer
                                             : section.contentContainer.find(
                                                    'ul:first',
                                               );
                                   if (
                                        !control.container
               ...
               ready: function () {
                    ...
                    if (
                         ...
                         newItem = control.container.find(
                              '.new-content-item-wrapper',
                         );
               ...
               getNotificationsContainerElement: function () {
                    ...
                    if (
                         ...
                         controlTitle = control.container.find(
               ...
               setupNotifications: function () {
                    ...
                    renderNotificationsIfVisible = function () {
                         ...
                         if (
                              !sectionId ||
                              (api.section.has(sectionId) &&
                                   api.section(sectionId).expanded())
                         ) {
                    ...
                    control.notifications.bind('rendered', function () {
                         ...
                         control.container.toggleClass(
                              'has-error',
                              0 !==
                                   _.where(notifications, { type: 'error' })
                                        .length,
                         );
                    });
                    ...
                    onSectionAssigned = function (newSectionId, oldSectionId) {
                         if (oldSectionId && api.section.has(oldSectionId)) {
                              api.section(oldSectionId).expanded.unbind(
                                   renderNotificationsIfVisible,
                              );
                         }
                         if (newSectionId) {
               ...
               addNewPage: function () {
                    ...
                    container = control.container.find(
                         '.new-content-item-wrapper',
                    );
                    ...
                    promise.done(function (data) {
                         ...
                         api.Menus.availableMenuItemsPanel.collection.add(
                              availableItem,
                         );
                         $content = $(
                              '#available-menu-items-post_type-page',
                         ).find('.available-menu-items-list');
                         itemTemplate = wp.template('available-menu-item');
                         $content.prepend(
                              itemTemplate(availableItem.attributes),
                         );
          ...
          /** @lends wp.customize.ColorControl.prototype */ {
               ready: function () {
                    ...
                    control.container.on('keydown', function (event) {
                         ...
                         pickerContainer = control.container.find(
                              '.wp-picker-container',
                         );
               ...
               ready: function () {
                    ...
                    updateRadios = _.debounce(function () {
                         ...
                         radioInput = control.container.find(
                              'input[name="background-position"][value="' +
                                   inputValue +
                                   '"]',
                         );
     ...
     api.SiteIconControl = api.CroppedImageControl.extend(
          /** @lends wp.customize.SiteIconControl.prototype */ {
                    ...
                    if (
                         ...
                         wp.ajax
                              ...
                              .done(function (croppedImage) {
                                   controller.setImageFromAttachment(
                                        croppedImage,
                                   );
                                   controller.frame.close();
                              })
                              .fail(function () {
                                   controller.frame.trigger(
                                        'content:error:crop',
                                   );
                              });
                    } else {
               ...
               removeFile: function (event) {
                    ...
                    this.setting('');
                    this.renderContent(); // Not bound to setting change when emptying.
                    $('link[rel="icon"][sizes="32x32"]').attr(
                         'href',
                         '/favicon.ico',
                    ); // Set to default.
               },
     ...
     api.HeaderControl = api.Control.extend(
          /** @lends wp.customize.HeaderControl.prototype */ {
               ready: function () {
                    ...
                    this.btnNew = $(
                         '#customize-control-header_image .actions .new',
                    );
               ...
               calculateImageSelectOptions: function (attachment, controller) {
                    var xInit = parseInt(_wpCustomizeHeader.data.width, 10),
                         ...
                         flexWidth = !!parseInt(
                              _wpCustomizeHeader.data['flex-width'],
                              10,
                         ),
                         flexHeight = !!parseInt(
                              _wpCustomizeHeader.data['flex-height'],
                              10,
                         ),
                         ratio,
                         xImg,
                    ...
                    controller.set(
                         'canSkipCrop',
                         !this.headerImage.shouldBeCropped(),
                    );
                    ...
                    this.frame = wp.media({
                         ...
                         states: [
                              new wp.media.controller.Library({
                                   ...
                                   priority: 20,
                                   suggestedWidth:
                                        _wpCustomizeHeader.data.width,
                                   suggestedHeight:
                                        _wpCustomizeHeader.data.height,
                              }),
     ...
     api.ThemeControl = api.Control.extend(
          /** @lends wp.customize.ThemeControl.prototype */ {
               ...
               ready: function () {
                    ...
                    control.container.on(
                         ...
                         function (event) {
                              ...
                              if (
                                   $(event.target).is(
                                        '.theme-actions .button, .update-theme',
                                   )
                              ) {
                                   return;
                              }
               ...
               filter: function (terms) {
                    ...
                    if (
                         control.params.theme.name.toLowerCase() ===
                         terms.join(' ')
                    ) {
                         matchCount = 100;
                    } else {
                         ...
                         matchCount =
                              matchCount +
                              10 * (haystack.split(terms.join(' ')).length - 1);

                         // Search for each term individually (as whole-word and partial match) and sum weighted match counts.
                         _.each(terms, function (term) {
                              matchCount =
                                   matchCount +
                                   2 * (haystack.split(term + ' ').length - 1); // Whole-word, double-weighted.
                              matchCount =
                                   matchCount + haystack.split(term).length - 1; // Partial word, to minimize empty intermediate searches while typing.
                         });
          ...
          /** @lends wp.customize.CodeEditorControl.prototype */ {
               ...
               initialize: function (id, options) {
                    ...
                    control.notifications.bind('add', function (notification) {
                         ...
                         if (
                              notification.code !==
                              control.setting.id + ':csslint_error'
                         ) {
                              return;
                         }
                         ...
                         notification.render = (function (render) {
                              return function () {
                                   ...
                                   li.find('input[type=checkbox]').on(
                                        'click',
                                        function () {
                                             control.setting.notifications.remove(
                                                  'csslint_error',
                                             );
                                        },
                                   );
               ...
               initEditor: function () {
                    ...
                    if (
                         ...
                         if (_.isObject(control.params.editor_settings)) {
                              _.each(
                                   control.params.editor_settings,
                                   function (value, key) {
                                        if (_.isObject(value)) {
                    ...
                    element = new api.Element(
                         control.container.find('textarea'),
                    );
                    control.elements.push(element);
               ...
               initSyntaxHighlightingEditor: function (codeEditorSettings) {
                    ...
                    settings = _.extend({}, codeEditorSettings, {
                         ...
                         onUpdateErrorNotice: _.bind(
                              control.onUpdateErrorNotice,
                              control,
                         ),
                    });
               ...
               onTabNext: function onTabNext() {
                    ...
                    if (controls.length === controlIndex + 1) {
                         ...
                         controls[controlIndex + 1].container
               ...
               onUpdateErrorNotice: function onUpdateErrorNotice(
                    ...
                    if (0 !== errorAnnotations.length) {
                         if (1 === errorAnnotations.length) {
                              message =
                                   api.l10n.customCssError.singular.replace(
                                        '%d',
                                        '1',
                                   );
                         } else {
     ...
     api.DateTimeControl = api.Control.extend(
          /** @lends wp.customize.DateTimeControl.prototype */ {
               ...
               ready: function ready() {
                    ...
                    control.inputElements.month.bind(
               ...
               parseDateTime: function parseDateTime(datetime) {
                    ...
                    if (
                         control.params.includeTime &&
                         control.params.twelveHourFormat
                    ) {
               ...
               validateInputs: function validateInputs() {
                    ...
                    _.find(components, function (component) {
                         ...
                         control.invalidDate =
                              isNaN(value) || value > max || value < min;
                    ...
                    if (
                         ...
                         validityInput =
                              control.inputElements.meridian.element.get(0);
                         if (
               ...
               updateDaysForMonth: function updateDaysForMonth() {
                    ...
                    if (month && year) {
                         ...
                         control.inputElements.day.element.attr(
                              'max',
                              daysInMonth,
                         );
               ...
               populateSetting: function populateSetting() {
                    ...
                    if (
                         ...
                         (!control.params.allowPastDate &&
                              !control.isFutureDate())
                    ) {
                         return false;
                    }
               ...
               convertInputDateToString: function convertInputDateToString() {
                    ...
                    pad = function (number, padding) {
                         ...
                         if (String(number).length < padding) {
                              ...
                              number =
                                   Math.pow(10, zeros).toString().substr(1) +
                                   String(number);
                         }
                         return number;
                    };
                    ...
                    getElementValue = function (component) {
                         var value = parseInt(
                              control.inputElements[component].get(),
                              10,
                         );
               ...
               isFutureDate: function isFutureDate() {
                    ...
                    return (
                         0 <
                         api.utils.getRemainingTime(
                              control.convertInputDateToString(),
                         )
                    );
               },
                ...
                */
               toggleFutureDateNotification:
                    function toggleFutureDateNotification(notify) {
                         var control = this,
                              notificationCode,
                              notification;
          ...
          /** @lends wp.customize.PreviewFrame.prototype */ {
               ...
               run: function (deferred) {
                    var previewFrame = this,
                         ...
                         ready = false,
                         readyData = null,
                         hasPendingChangesetUpdate =
                              '{}' !== previewFrame.query.customized,
                         urlParser,
                         params,
                         form;
                    ...
                    params = _.extend(
                         api.utils.parseQueryString(urlParser.search.substr(1)),
                         {
                              ...
                              customize_theme:
                                   previewFrame.query.customize_theme,
                    ...
                    if (
                         api.settings.changeset.autosaved ||
                         !api.state('saved').get()
                    ) {
                    ...
                    previewFrame.targetWindow(
                         previewFrame.iframe[0].contentWindow,
                    );
                    ...
                    previewFrame.iframe.one('load', function () {
                         ...
                         if (ready) {
                              ...
                              setTimeout(function () {
                                   deferred.rejectWith(previewFrame, [
                                        'ready timeout',
                                   ]);
          ...
          /** @lends wp.customize.Previewer.prototype */ {
               ...
               initialize: function (params, options) {
                    ...
                    previewer.refresh = _.debounce(
                         (function (originalRefresh) {
                              return function () {
                                   var isProcessingComplete,
                                        refreshOnceProcessingComplete;
                                   isProcessingComplete = function () {
                                        return (
                                             0 === api.state('processing').get()
                                        );
                                   };
                    ...
                    previewer
                         .add('previewUrl', params.previewUrl)
                         .setter(function (to) {
                              var result = null,
                                   urlParser,
                                   queryParams,
                              ...
                              if (
                                   /\/wp-(admin|includes|content)(\/|$)/.test(
                                        urlParser.pathname,
                                   )
                              ) {
                                   return null;
                              ...
                              _.find(
                                   parsedCandidateUrls,
                                   function (parsedCandidateUrl) {
                                        return !_.isUndefined(
                                             _.find(
                                                  previewer.allowedUrls,
                                                  function (allowedUrl) {
                                                       parsedAllowedUrl.href =
                                                            allowedUrl;
                                                       if (
                                                            urlParser.protocol ===
                                                                 parsedAllowedUrl.protocol &&
                                                            urlParser.host ===
                                                                 parsedAllowedUrl.host &&
                                                            0 ===
                    ...
                    _(constructs).each(function (activeConstructs, type) {
                         api[type].each(function (construct, id) {
                              ...
                              if (
                                   ...
                                   !_.isUndefined(activeConstructs[id])
                              ) {
               ...
               refresh: function () {
                    ...
                    onSettingChange = function (setting) {
                         previewer.settingsModifiedWhileLoading[setting.id] =
                              true;
                    };
     ...
     api._handleSettingValidities = function handleSettingValidities(args) {
               ...
               if (setting) {
                    ...
                    if (_.isObject(validity)) {
                         _.each(validity, function (params, code) {
                              ...
                              existingNotification = setting.notifications(
                                   notification.code,
                              );
                              ...
                              if (
                                   !setting.notifications.has(notification.code)
                              ) {
          ...
          if (args.focusInvalidControl) {
               invalidSettingControls =
                    api.findControlsForSettings(invalidSettings);
      ...
      */
     api.findControlsForSettings = function findControlsForSettings(
          settingIds,
     ) {
          var controls = {},
               settingControls;
     ...
     api.reflowPaneContents = _.bind(function () {
          ...
          ); // @todo This should be defined elsewhere, and to be configurable.
          if (
               !api.utils.areElementListsEqual(
                    rootHeadContainers,
          ...
          api.section.each(function (section) {
               ...
               section.active.callbacks.fireWith(section.active, [
                    value,
                    value,
               ]);
          });
     ...
     $(function () {
          ...
          api.section('publish_settings', function (section) {
               ...
               dateControl = new api.DateTimeControl(
                    'changeset_scheduled_date',
                    {
                         priority: 20,
                         section: 'publish_settings',
               ...
               updateTimeArrivedPoller = function () {
                    ...
                    if (shouldPoll && !pollInterval) {
                         pollInterval = setInterval(function () {
                              ...
                              api.state('remainingTimeToPublish').set(
                                   remainingTime,
                              );
                              if (remainingTime <= 0) {
               ...
               api.state('saving').bind(function (isSaving) {
                    if (
                         ...
                         dateControl.toggleFutureDateNotification(
                              !dateControl.isFutureDate(),
                         );
                    }
               });
          });
          ...
          $('#customize-controls').on('keydown', function (e) {
               ...
               if (
                    isEnter &&
                    ($el.is('input:not([type=button])') || $el.is('select'))
               ) {
                    e.preventDefault();
               }
          });
          ...
          $('.customize-info')
               ...
               .on('click', function () {
                    ...
                    if (section.hasClass('open')) {
                         ...
                         content.slideUp(
                              api.Panel.prototype.defaultExpandedArguments
                                   .duration,
                              function () {
                                   content.trigger('toggled');
                              },
               ...
               /** @lends wp.customize.previewer */ {
                    ...
                    query: function (options) {
                         ...
                         queryVars.customized = JSON.stringify(
                              api.dirtyValues({
                                   unsaved:
                                        options &&
                                        options.excludeCustomizedSaved,
                              }),
                         );
                    ...
                    save: function (args) {
                         var previewer = this,
                              deferred = $.Deferred(),
                              changesetStatus = api
                                   .state('selectedChangesetStatus')
                                   .get(),
                              selectedChangesetDate = api
                                   .state('selectedChangesetDate')
                                   .get(),
                         ...
                         submit = function () {
                              ...
                              api.control.each(function (control) {
                                   if (
                                        ...
                                        control.notifications.each(
                                             function (notification) {
                                                  if (
                                                       'error' ===
                                                       notification.type
                                                  ) {
                                                       invalidSettingLessControls.push(
                                                            [control],
                                                       );
                                                  }
                                             },
                              ...
                              if (args && args.date) {
                                   ...
                                   'future' === changesetStatus &&
                                   selectedChangesetDate
                              ) {
                                   query.customize_changeset_date =
                                        selectedChangesetDate;
                              }
                              ...
                              api.state('processing').set(
                                   api.state('processing').get() + 1,
                              );
                              ...
                              request.done(function (response) {
                                   ...
                                   if (response.changeset_date) {
                                        api.state('changesetDate').set(
                                             response.changeset_date,
                                        );
                                   }
                    ...
                    getFrontendPreviewUrl: function () {
                         ...
                         params = api.utils.parseQueryString(
                              urlParser.search.substr(1),
                         );
                         ...
                         if (
                              ...
                              params.customize_changeset_uuid =
                                   api.settings.changeset.uuid;
                         }
                         if (!api.state('activated').get()) {
                              params.customize_theme =
                                   api.settings.theme.stylesheet;
                         }
          ...
          $.each(api.settings.sections, function (id, data) {
               var Constructor =
                         api.sectionConstructor[data.type] || api.Section,
                    options;
          ...
          $.each(api.settings.controls, function (id, data) {
               var Constructor =
                         api.controlConstructor[data.type] || api.Control,
                    options;
          ...
          api.bind('ready', function setUpGlobalNotificationsArea() {
               ...
               api.notifications.bind('rendered', function updateSidebarTop() {
                    ...
                    if (0 !== api.notifications.count()) {
                         containerHeight =
                              api.notifications.container.outerHeight() + 1;
                         containerInitialTop = parseInt(sidebar.css('top'), 10);
                         sidebar.css(
                              'top',
                              containerInitialTop + containerHeight + 'px',
                         );
                    }
          ...
          (function (state) {
               var saved = state.instance('saved'),
                    ...
                    selectedChangesetStatus = state.instance(
                         'selectedChangesetStatus',
                    ),
                    changesetDate = state.instance('changesetDate'),
                    selectedChangesetDate = state.instance(
                         'selectedChangesetDate',
                    ),
                    previewerAlive = state.instance('previewerAlive'),
                    editShortcutVisibility = state.instance(
                         'editShortcutVisibility',
                    ),
          ...
          (function checkAndDisplayLockNotice() {
               var LockedNotification = api.OverlayNotification.extend(
                    /** @lends wp.customize~LockedNotification.prototype */ {
                         ...
                         initialize: function (code, params) {
                              ...
                              _params.containerClasses +=
                                   ' notification-changeset-locked';
                         ...
                         render: function () {
                              ...
                              data = _.extend(
                                   {
                                        ...
                                        previewUrl:
                                             api.previewer.previewUrl.get(),
                                        frontendPreviewUrl:
                                             api.previewer.getFrontendPreviewUrl(),
                                   },
                                   this,
                              );

                              li =
                                   api.OverlayNotification.prototype.render.call(
                                        data,
                                   );
                              ...
                              takeOverButton = li.find(
                                   '.customize-notice-take-over-button',
                              );
                              takeOverButton.on('click', function (event) {
                                   ...
                                   request.fail(function (response) {
                                        var message =
                                             response.message ||
                                             api.l10n.unknownRequestFail;
                                        li.find('.notice-error')
                                             .prop('hidden', false)
                                             .text(message);

                                        request.always(function () {
                                             takeOverButton.removeClass(
                                                  'disabled',
                                             );
                                        });
                                   });
               ...
               $(document).on(
                    ...
                    function (event, data) {
                         ...
                         if (
                              notification &&
                              notification.lockUser.id !==
                                   api.settings.changeset.lockUser.id
                         ) {
               ...
               api.bind('error', function (response) {
                    if (
                         'changeset_locked' === response.code &&
                         response.lock_user
                    ) {
                         startLock({
          ...
          (function () {
               ...
               function addSiteEditorNotification(notification) {
                    api.notifications.add(
                         new api.Notification(
                              'site_editor_block_theme_notice',
                              {
                                   ...
                                   render: function () {
                                        var notification =
                                                  api.Notification.prototype.render.call(
                                                       this,
                                                  ),
                                             button = notification.find(
          ...
          body.on('keydown', function (event) {
               ...
               if (
                    event.target.closest('.block-editor-writing-flow') !==
                         null ||
          ...
          (function initStickyHeaders() {
               ...
               api.notifications.bind('sidebarTopUpdated', function () {
                    if (
                         activeHeader &&
                         activeHeader.element.hasClass('is-sticky')
                    ) {
                         activeHeader.element.css(
                              'top',
                              parentContainer.css('top'),
                         );
                    }
               });
          ...
          if (title.length) {
               api('blogname', function (setting) {
                    var updateTitle = function () {
                         ...
                         title.text(
                              blogTitle.toString().trim() ||
                                   api.l10n.untitledBlogName,
                         );
                    };
          ...
          (function () {
               ...
               function startPromptingBeforeUnload() {
                    ...
                    api.state('selectedChangesetStatus').unbind(
                         startPromptingBeforeUnload,
                    );
                    api.state('selectedChangesetDate').unbind(
                         startPromptingBeforeUnload,
                    );
               ...
               api.state('selectedChangesetDate').bind(
                    startPromptingBeforeUnload,
               );
          ...
          api.previewer.bind(
               ...
               function handleSelectiveRefreshedSettingValidities(
                    settingValidities,
               ) {
                    api._handleSettingValidities({
          ...
          api.state('paneVisible').bind(function (isPaneVisible) {
               ...
               api.state('editShortcutVisibility').set(
                    isPaneVisible || isMobileScreen ? 'visible' : 'hidden',
               );
          });
          if (window.matchMedia) {
               window
                    ...
                    .addListener(function () {
                         ...
                         state.callbacks.fireWith(state, [
                              state.get(),
                              state.get(),
                         ]);
                    });
