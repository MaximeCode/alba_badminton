     ...
     $._farbtastic = function (container, callback) {
          ...
          fb.mousedown = function (event) {
               ...
               if (!document.dragging) {
                    $(document)
                         .on('mousemove', fb.mousemove)
                         .on('mouseup', fb.mouseup);
               ...
               fb.circleDrag =
                    Math.max(Math.abs(pos.x), Math.abs(pos.y)) * 2 > fb.square;
          ...
          fb.mousemove = function (event) {
               ...
               if (fb.circleDrag) {
                    ...
                    var sat = Math.max(
                         0,
                         Math.min(1, -(pos.x / fb.square) + 0.5),
                    );
                    var lum = Math.max(
                         0,
                         Math.min(1, -(pos.y / fb.square) + 0.5),
                    );
          ...
          fb.updateDisplay = function () {
               ...
               $('.h-marker', e).css({
                    left:
                         Math.round(
                              Math.sin(angle) * fb.radius + fb.width / 2,
                         ) + 'px',
                    top:
                         Math.round(
                              -Math.cos(angle) * fb.radius + fb.width / 2,
                         ) + 'px',
               });
               ...
               $('.sl-marker', e).css({
                    left:
                         Math.round(
                              fb.square * (0.5 - fb.hsl[1]) + fb.width / 2,
                         ) + 'px',
                    top:
                         Math.round(
                              fb.square * (0.5 - fb.hsl[2]) + fb.width / 2,
                         ) + 'px',
               });
