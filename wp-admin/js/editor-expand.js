...
(function (window, $, undefined) {
     ...
     $(function () {
          var $wrap = $('#postdivrich'),
               ...
               initialMode = $contentWrap.hasClass('tmce-active')
                    ? 'tinymce'
                    : 'html',
          ...
          function textEditorResize() {
               ...
               if (length < oldTextLength) {
                    ...
                    parseInt(textEditor.style.height, 10) <
                    textEditor.scrollHeight
               ) {
                    textEditor.style.height =
                         Math.ceil(textEditor.scrollHeight) + 'px';
                    adjust();
               }
          ...
          function getHeights() {
               ...
               heights = {
                    ...
                    adminBarHeight:
                         windowWidth > 600 ? $adminBar.outerHeight() : 0,
          ...
          $document.on(
               ...
               function (event, editor) {
                    ...
                    function mceScroll(key) {
                         ...
                         cursorTop =
                              offset.top +
                              editor.iframeElement.getBoundingClientRect().top;
                    ...
                    mceBind = function () {
                         ...
                         editor.on(
                              'setcontent wp-autoresize wp-toolbar-toggle',
                              adjust,
                         );
          ...
          function adjust(event) {
                         ...
                         if (
                              ...
                              if (visual && $menuBar.length) {
                                   $menuBar.css({
                                        ...
                                        top: 0,
                                        width:
                                             contentWrapWidth - borderWidth * 2,
                                   });
                              }
               ...
               if (
                    ...
                    $document.height() >
                         $sideSortables.height() + postBodyTop + 120 &&
          ...
          function on() {
               ...
               if (
                    window.pageYOffset &&
                    window.pageYOffset > pageYOffsetAtTop
               ) {
     ...
     $(function () {
          var $body = $(document.body),
               ...
               $editorIframe = $(),
               _isActive =
                    window.getUserSetting('editor_expand', 'on') === 'on',
               _isOn = _isActive
                    ? window.getUserSetting('post_dfw') === 'on'
                    : false,
               traveledX = 0,
               traveledY = 0,
               buffer = 20,
          ...
          $document.on('tinymce-editor-init.focus', function (event, editor) {
               ...
               if (editor.id === 'content') {
                    ...
                    $editorIframe = $(editor.getContentAreaContainer()).find(
                         'iframe',
                    );
                    ...
                    $document
                         .on('dfw-on.focus', mceBind)
                         .on('dfw-off.focus', mceUnbind);
          ...
          $document.on('quicktags-init', function (event, editor) {
               ...
               if (
                    ...
                    (',' + editor.settings.buttons + ',').indexOf(',dfw,') !==
                         -1
               ) {
