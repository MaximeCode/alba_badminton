<?php
/*
Plugin Name: Gestion des horaires des entrainements et jeux libres
Description: Ce plugin permet de gérer les horaires des entrainements et jeux libres via un Custom Post Type.
Author: M.B.
Version: 1.0
*/
