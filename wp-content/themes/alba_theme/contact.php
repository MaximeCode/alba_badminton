  ...
  <section>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-y-12 justify-center items-center">
      ...
      <section class="w-full md:w-10/12 lg:max-xl:w-full xl:w-10/12 mx-auto bg-white px-5 py-3 rounded-2xl">
        ...
        <address
          class="flex flex-col not-italic gap-y-6 md:gap-y-8 my-7 md:my-10 md:text-lg text-center md:text-left">
          <!--Email-->
          ...
          <!--Facebook-->
          <div class="inline-flex items-center">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" width="32" height="32" fill="#1fa2da"
                 class="<?= $size_svg ?> text-primary-blue basis-1/12 md:basis-2/12">
              <path
            ...
            <span class="font-bold basis-5/12 md:basis-4/12">Sur Facebook :</span>
            <a href="https://www.facebook.com/profile.php?id=61561571563796&locale=fr_FR" target="_blank"
               class="text-lg md:text-xl italic basis-6/12 md:basis-6/12 hover:text-primary-blue hover:underline">
              Amicale de Lucé Badminton - Officiel
            </a>
          </div>
          <!--TikTok-->
          <div class="inline-flex items-center">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640" fill="#1fa2da" class="<?= $size_svg ?> text-primary-blue basis-1/12 md:basis-2/12">
            ...
            <span class="font-bold basis-5/12 md:basis-4/12">Sur TikTok :</span>
            <a href="https://www.tiktok.com/@alba.bad" target="_blank"
               class="text-lg md:text-xl italic basis-6/12 md:basis-6/12 hover:text-primary-blue hover:underline">
              @Alba.bad
            </a>
          </div>
