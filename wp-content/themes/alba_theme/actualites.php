...
?>
    ...
    <section>
        ...
        <div class="my-8 font-semibold space-y-4 md:space-y-0">
            <?php foreach (get_categories() as $cat) :
                ...
                <a href="<?= get_permalink(26) ?>?categoryName=<?= $cat->slug ?>"
                   ...
                   inline-block rounded-lg px-5 py-2.5 text-center me-2 text-primary-blue hover:text-white border border-primary-blue hover:bg-primary-blue focus:ring-4 focus:outline-none focus:ring-blue-300 dark:border-blue-500 dark:text-blue-500 dark:hover:text-white dark:hover:bg-blue-500 dark:focus:ring-primary-blue"
