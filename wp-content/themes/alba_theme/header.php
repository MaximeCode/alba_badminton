...
<style>
    ...
    ::-webkit-scrollbar-thumb:hover {
        ...
        /* Couleur plus foncée quand on survole la barre */
    }
</style>
...
<body class="bg-back-blue font-crimson selection:bg-primary-blue selection:text-white">
    ...
    <header>
        <!-- Navbar wrapper -->
        <nav class="bg-<?= $mainColor ?> mb-10 z-50 font-personal relative shadow-xl">
            ...
            focus:outline-none hover:ring-2 hover:ring-white focus:ring-2 focus:ring-gray-200 <?= $alba_theme_variables['animBase'] ?>"
                ...
                <div class="hidden absolute top-24 left-0 w-full bg-<?= $mainColor ?> lg:static lg:w-auto lg:block z-50 transform transition-all duration-300 ease-in-out"
                    id="navbar-dropdown">
                    <ul class="w-10/12 mx-auto lg:w-full flex flex-col font-medium mt-4 mb-4 lg:mb-0 xl:px-4 xl:text-lg text-white rounded-lg uppercase xl:space-x-8 lg:flex-row lg:mt-0">
                        ...
                        <li class="group">
                            ...
                            <div id="dropdownNavbarClub"
                                class="<?= $alba_theme_variables['classDivDropdown'] ?> border border-white bg-<?= $mainColor ?>">
                                <ul class="xl:text-lg normal-case divide-y" aria-labelledby="dropdownLargeButton">
                                    ...
                                    <?php
                                        ...
                                        echo "<li class='block px-4 py-2 leading-7 rounded-lg hover:bg-white hover:text-<?= $mainColor ?>'>Aucune page enfant disponible !</li>";
                                    }
                                    ?>
                                </ul>
                            </div>
                            ...
                            <div id="dropdownNavbarGalerie"
                                ...
                                <ul class="xl:text-lg divide-y normal-case" aria-labelledby="dropdownLargeButton">
                                            ...
                                            <li>
                                                ...
                                                <div id="doubleDropdown<?= $id ?>"
                                                    ...
                                                    <ul class="xl:text-lg divide-y normal-case"
                                                        ...
                                                        <?php endforeach; ?>
                                                        <li class="bg-white text-<?= $mainColor ?> p-1 rounded-lg">
                                    ...
                                    <?php
                                        ...
                                        echo "<li class='block px-4 py-2 leading-7 rounded-lg hover:bg-white hover:text-<?= $mainColor ?>'>Aucune galerie disponible !</li>";
                                    } ?>
                                </ul>
                            </div>
                        </li>
