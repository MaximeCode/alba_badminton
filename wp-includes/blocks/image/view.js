...
/******/
/************************************************************************/
var __webpack_exports__ = {}; // CONCATENATED MODULE: external "@wordpress/interactivity"
...
var y = (x) => () => x;
const interactivity_namespaceObject = x({
     ['getContext']: () =>
          __WEBPACK_EXTERNAL_MODULE__wordpress_interactivity_8e89b257__.getContext,
     ['getElement']: () =>
          __WEBPACK_EXTERNAL_MODULE__wordpress_interactivity_8e89b257__.getElement,
     ['store']: () =>
          __WEBPACK_EXTERNAL_MODULE__wordpress_interactivity_8e89b257__.store,
     ...
     'core/image',
     {
          state: {
               ...
               get imgStyles() {
                    return (
                         state.overlayOpened &&
                         `${state.currentImage.imgStyles?.replace(/;$/, '')}; object-fit:cover;`
                    );
               },
          },
          actions: {
               ...
               handleKeydown(event) {
                    if (state.overlayEnabled) {
                         ...
                         if (event.key === 'Tab') {
                              ...
                              const { ref } = (0,
                              interactivity_namespaceObject.getElement)();
               ...
               setOverlayStyles() {
                    ...
                    if (state.currentImage.scaleAttr === 'contain') {
                         if (naturalRatio > originalRatio) {
                              ...
                              screenPosX +=
                                   (originalWidth - widthWithoutSpace) / 2;
                    ...
                    if (naturalRatio.toFixed(2) !== imgRatio.toFixed(2)) {
                         ...
                         if (originalRatio > imgRatio) {
                              ...
                              containerMaxHeight =
                                   containerMaxWidth / originalRatio;
                         } else {
                              containerMaxHeight = imgMaxHeight;
                              containerMaxWidth =
                                   containerMaxHeight * originalRatio;
                         }
                    }
