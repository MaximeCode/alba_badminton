...
const { state: l, actions: c } = (0, n.store)(
     'core/navigation',
     {
          state: {
               get roleAttribute() {
                    return 'overlay' === (0, n.getContext)().type &&
                         l.isMenuOpen
                         ? 'dialog'
                         : null;
               },
               ...
               get ariaLabel() {
                    ...
                    return 'overlay' === e.type && l.isMenuOpen
                         ? e.ariaLabel
                         : null;
               },
               get isMenuOpen() {
                    return (
                         Object.values(l.menuOpenedBy).filter(Boolean).length >
                         0
                    );
               },
               get menuOpenedBy() {
                    const e = (0, n.getContext)();
                    return 'overlay' === e.type
                         ? e.overlayOpenedBy
                         : e.submenuOpenedBy;
               },
          },
          actions: {
               openMenuOnHover() {
                    const { type: e, overlayOpenedBy: t } = (0, n.getContext)();
                    'submenu' === e &&
                         0 === Object.values(t || {}).filter(Boolean).length &&
                         c.openMenu('hover');
               },
               closeMenuOnHover() {
                    const { type: e, overlayOpenedBy: t } = (0, n.getContext)();
               ...
               handleMenuKeydown(e) {
                    ...
                    if (l.menuOpenedBy.click) {
                         if ('Escape' === e?.key)
                              return (
                                   c.closeMenu('click'),
                                   void c.closeMenu('focus')
                              );
                         'overlay' === t &&
                              'Tab' === e.key &&
                              (e.shiftKey && window.document.activeElement === o
               ...
               handleMenuFocusout(e) {
                    const { modal: t, type: o } = (0, n.getContext)();
