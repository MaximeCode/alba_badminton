               ...
               report: function (e, t, a, n, r, i) {
                    ...
                    l.messages.push({
                         ...
                         rule: {
                              ...
                              link:
                                   'https://github.com/yaniswang/HTMLHint/wiki/' +
                                   r.id,
                         },
                    });
               },
          ...
          (t.prototype = {
               ...
               parse: function (t) {
                    ...
                    var n,
                         ...
                         L = c._arrBlocks;
                    for (
                         c.fire('start', { pos: 0, line: 1, col: 1 });
                         (n = g.exec(t));
                    ...
                    t.length > p &&
                         ((d = t.substring(p, t.length)), a('text', d, p)),
                         c.fire('end', {
                              pos: p,
                              line: w,
                              col: t.length - b + 1,
               ...
               fire: function (t, a) {
                    ...
                    var o = n.lastEvent;
                    null !== o && (delete o.lastEvent, (a.lastEvent = o)),
                         (n.lastEvent = a);
          ...
          init: function (e, t) {
               ...
               e.addListener('tagstart', function (e) {
                    for (
                         ...
                         (n = i[o]),
                              ((/^(img|script|embed|bgsound|iframe)$/.test(
                                   r,
                              ) === !0 &&
                                   'src' === n.name) ||
                                   ('link' === r && 'href' === n.name) ||
