...
!(function (e) {
          ...
          (e.wp = e.wp || {}),
               ...
               (wp.api.getModelByRoute = function (t) {
                    return _.find(wp.api.models, function (e) {
                         return (
                              e.prototype.route && t === e.prototype.route.index
                         );
                    });
               }),
               ...
               (wp.api.utils.capitalizeAndCamelCaseDashes = function (e) {
                    return _.isUndefined(e)
                         ? e
                         : ((e = wp.api.utils.capitalize(e)),
                           wp.api.utils.camelCaseDashes(e));
               }),
               ...
               (wp.api.utils.extractParentName = function (e) {
                    ...
                    return t < 0
                         ? ''
                         : ((e = (e = e.substr(0, t - 1)).split('/')).pop(),
                           e.pop());
               }),
               (wp.api.utils.decorateFromRoute = function (e, t) {
                    _.each(e, function (e) {
                         _.includes(e.methods, 'POST') ||
                         _.includes(e.methods, 'PUT')
                              ? _.isEmpty(e.args) ||
                                (_.isEmpty(t.prototype.args)
                                     ? (t.prototype.args = e.args)
                                     : (t.prototype.args = _.extend(
                                            t.prototype.args,
                                            e.args,
                                       )))
               ...
               (wp.api.utils.addMixinsAndHelpers = function (t, e, i) {
                    function n(e, t, i, n, o) {
                         ...
                         return _.isNumber(t) && 0 !== t
                              ? ((s = (s = e[n]
                                     ? _.findWhere(e[n], { id: t })
                                     : s) || { id: t }),
                                (e = new wp.api.models[i](s)).get(o)
                                     ? a.resolve(e)
                                     : e.fetch({
                                            success: function (e) {
                                                 a.resolve(e);
                    ...
                    var o = !1,
                         ...
                         a = {
                              ...
                              getDate: function (e) {
                                   var e = e || 'date',
                                        t = this.get(e);
                                   return (
                                        !(_.indexOf(s, e) < 0 || _.isNull(t)) &&
                                        new Date(wp.api.utils.parseISO8601(t))
                                   );
                              },
                         },
                         r = {
                                             ...
                                             ? (_.isUndefined(i) ||
                                               _.isUndefined(e[i])
                                                    ...
                                                    : (s = _.isUndefined(n)
                                                           ? e[i]
                                                           : e[i][n]),
                                               (e = new wp.api.collections[t](
                                                    s,
                                                    o,
                                               )),
                                               _.isUndefined(e.models[0])
                                                    ? e.fetch({
                                                           success: function (
                                                                e,
                                                           ) {
                         ...
                         l = {
                              ...
                              setCategoriesWithCollection: function (e) {
                                   return (
                                        this.set('categories', e.pluck('id')),
                                        this.save()
                                   );
                              },
                         },
                    ...
                    return (t =
                         ...
                         o && (t = t.extend(a)),
                         _.isUndefined(t.prototype.args.author) ||
                              (t = t.extend(u)),
                         _.isUndefined(t.prototype.args.featured_media) ||
                              (t = t.extend(g)),
                         _.isUndefined(t.prototype.args.categories) ||
                              (t = t.extend(l)),
                         _.isUndefined(t.prototype.args.meta) ||
                              (t = t.extend(r)),
                         _.isUndefined(t.prototype.args.tags) ||
                              (t = t.extend(d)),
                         _.isUndefined(i.collections[e + 'Revisions']))
                              ? t
                              : t.extend(c));
               });
     })(window),
     (function () {
          ...
          (wp.api.WPApiBaseModel = Backbone.Model.extend({
               initialize: function () {
                    -1 === _.indexOf(e, this.name) &&
                         (this.requireForceForDelete = !0);
               },
               sync: function (e, t, i) {
                    var n;
                    return (
               ...
               (wp.api.models.Schema = wp.api.WPApiBaseModel.extend({
                    ...
                    initialize: function (e, t) {
                         (t = t || {}),
                              ...
                              (this.versionString =
                                   t.versionString || i.versionString);
                    },
                    url: function () {
          ...
          wp.api.WPApiBaseCollection = Backbone.Collection.extend({
               ...
               sync: function (e, t, i) {
                    ...
                    return (
                         ...
                         'read' === e &&
                              (i.data
                                   ? ((s.state.data = _.clone(i.data)),
                                     delete s.state.data.page)
                                   : (s.state.data = i.data = {}),
                              void 0 === i.data.page
          ...
          (window.wp = window.wp || {}),
               ...
               (o = Backbone.Model.extend({
                    ...
                    initialize: function () {
                         var e,
                              t = this;
                         Backbone.Model.prototype.initialize.apply(
                              t,
                              arguments,
                         ),
                              (e = jQuery.Deferred()),
                              ...
                              t.get('schema')
                                   ? t.schemaModel.set(
                                          t.schemaModel.parse(t.get('schema')),
                                     )
                                   : !_.isUndefined(sessionStorage) &&
                                       (_.isUndefined(c.cacheSchema) ||
                                            c.cacheSchema) &&
               ...
               (wp.api.init = function (e) {
                    ...
                    return (
                         (e = e || {}),
                         (n.nonce = _.isString(e.nonce)
                              ? e.nonce
                              : c.nonce || ''),
                         (n.apiRoot = e.apiRoot || c.root || '/wp-json'),
                         (n.versionString =
                              e.versionString || c.versionString || 'wp/v2/'),
                         (n.schema = e.schema || null),
                         (n.modelEndpoints = e.modelEndpoints || [
                              'me',
                              'settings',
                         ]),
                         n.schema ||
                         ...
                         s[n.apiRoot + n.versionString] ||
                              ...
                              (i = (t = jQuery.Deferred()).promise()),
                              e.schemaConstructed.done(function (e) {
