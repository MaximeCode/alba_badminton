...
(function (window, undefined) {
     ...
     wp.api.getModelByRoute = function (route) {
          return _.find(wp.api.models, function (model) {
               return (
                    ...
                    route === model.prototype.route.index
               );
          });
     };
     ...
     wp.api.getCollectionByRoute = function (route) {
          return _.find(wp.api.collections, function (collection) {
               return (
                    collection.prototype.route &&
                    route === collection.prototype.route.index
               );
          });
     };
     ...
     if (!Date.prototype.toISOString) {
          ...
          Date.prototype.toISOString = function () {
               return (
                    ...
                    '.' +
                    String((this.getUTCMilliseconds() / 1000).toFixed(3)).slice(
                         2,
                         5,
                    ) +
                    'Z'
     ...
     wp.api.utils.addMixinsAndHelpers = function (
          ...
          var hasDate = false,
               ...
               TimeStampedMixin = {
                    ...
                    getDate: function (field) {
                         ...
                         if (
                              _.indexOf(parseableDates, theField) < 0 ||
                              _.isNull(theISODate)
                         ) {
                              return false;
                         }
               ...
               buildModelGetter = function (
                    ...
                    if (embeddedObjects[embedSourcePoint]) {
                         attributes = _.findWhere(
                              embeddedObjects[embedSourcePoint],
                              { id: modelId },
                         );
                    }
               ...
               buildCollectionGetter = function (
                    ...
                    if (
                         ...
                         !_.isUndefined(embeddedObjects[embedSourcePoint])
                    ) {
                         ...
                         if (_.isArray(categories)) {
                              ...
                              allCategories.fetch({
                                   ...
                                   success: function (allcats) {
                                        ...
                                        self.setCategoriesWithCollection(
                                             categories,
                                        );
                                   },
                              });
          ...
          if (
               !_.isUndefined(
                    loadingObjects.collections[modelClassName + 'Revisions'],
               )
          ) {
               ...
               sync: function (method, model, options) {
                    ...
                    if (
                         ...
                         options.complete = function (xhr) {
                              var returnedNonce =
                                   xhr.getResponseHeader('X-WP-Nonce');
     ...
     Endpoint = Backbone.Model.extend(
          /** @lends Endpoint.prototype */ {
               ...
               initialize: function () {
                    ...
                    if (model.get('schema')) {
                         ...
                         model.schemaModel.set(
                              model.schemaModel.parse(model.get('schema')),
                         );
                    } else if (
               ...
               constructFromSchema: function () {
                    ...
                    _.each(
                         routeModel.schemaModel.get('routes'),
                    ...
                    _.each(modelRoutes, function (modelRoute) {
                         ...
                         if ('' !== parentName && parentName !== routeName) {
                              modelClassName =
                                   wp.api.utils.capitalizeAndCamelCaseDashes(
                                        parentName,
                                   ) +
                                   wp.api.utils.capitalizeAndCamelCaseDashes(
                                        routeName,
                    ...
                    _.each(collectionRoutes, function (collectionRoute) {
                         ...
                         if (
                              ...
                              modelClassName =
                                   mapping.models[collectionClassName] ||
                                   collectionClassName;
                              collectionClassName =
                                   mapping.collections[collectionClassName] ||
                                   collectionClassName;
                              loadingObjects.collections[collectionClassName] =
                                   wp.api.WPApiBaseCollection.extend({
                                        ...
                                        model: function (attrs, options) {
                                             return new loadingObjects.models[
                                                  modelClassName
                                             ](attrs, options);
                                        },
                    ...
                    _.each(loadingObjects.models, function (model, index) {
                         loadingObjects.models[index] =
                              wp.api.utils.addMixinsAndHelpers(
                                   model,
                                   index,
                                   loadingObjects,
                              );
     ...
     wp.api.init = function (args) {
          ...
          if (
               ...
               endpoint.schemaConstructed.done(function (resolvedEndpoint) {
                    ...
                    wp.api.models = _.extend(
                         wp.api.models,
                         resolvedEndpoint.get('models'),
                    );
