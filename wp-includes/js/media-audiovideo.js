                    ...
                    /** @lends wp.media.view.AudioDetails.prototype */ {
                         ...
                         setMedia: function () {
                              ...
                              if (audio.find('source').length) {
                                   ...
                                   this.media = MediaDetails.prepareSrc(
                                        audio.get(0),
                                   );
                              } else {
                                   audio.hide();
               ...
               AudioDetails = MediaDetails.extend(
                    /** @lends wp.media.view.MediaFrame.AudioDetails.prototype */ {
                         ...
                         bindHandlers: function () {
                              MediaDetails.prototype.bindHandlers.apply(
                                   this,
                                   arguments,
                              );
               ...
               MediaDetails = Select.extend(
                    /** @lends wp.media.view.MediaFrame.MediaDetails.prototype */ {
                         ...
                         initialize: function (options) {
                              ...
                              this.media = new wp.media.model.PostMedia(
                                   options.metadata,
                              );
                         ...
                         renderReplaceToolbar: function () {
                              this.setPrimaryButton(
                                   l10n.replace,
                                   function (controller, state) {
                                        var attachment = state
                                             .get('selection')
                                             .single();
                                        controller.media.changeAttachment(
                                             attachment,
                                        );
                                        state.trigger(
                                             'replace',
               ...
               VideoDetails = MediaDetails.extend(
                    /** @lends wp.media.view.MediaFrame.VideoDetails.prototype */ {
                         ...
                         renderSelectPosterImageToolbar: function () {
                              this.setPrimaryButton(
                                   l10n.videoSelectPosterImageTitle,
                                   function (controller, state) {
                                        var urls = [],
                                             attachment = state
                                                  .get('selection')
                                        ...
                                        _.each(
                                             ...
                                             function (ext) {
                                                  if (
                                                       controller.media.get(ext)
                                                  ) {
                                                       urls.push(
                                                            controller.media.get(
                                                                 ext,
                                                            ),
                                                       );
                                                  }
               ...
               MediaDetails = AttachmentDisplay.extend(
                    /** @lends wp.media.view.MediaDetails.prototype */ {
                         ...
                         addSource: function (e) {
                              this.controller.lastMime = $(
                                   e.currentTarget,
                              ).data('mime');
                              this.controller.setState(
                                   'add-' +
                                        this.controller.defaults.id +
                                        '-source',
                              );
                         },
