...
})(
     {
               ...
               function (e, t, n) {
                    ...
                    var i = function e(t, n, o) {
                         ...
                         (o = Array.isArray(o) ? o : null),
                              ...
                              (f.mediaElement = j.default.createElement(
                                   n.fakeNodeName,
                              ));
                         var i = t,
                              r = !1;
                         ...
                         var a =
                              f.mediaElement.originalNode.tagName.toLowerCase();
                         -1 < ['video', 'audio'].indexOf(a) &&
                              !f.mediaElement.originalNode.getAttribute(
                                   'preload',
                              ) &&
                              f.mediaElement.originalNode.setAttribute(
                                   'preload',
                         ...
                         var s = function (t, e) {
                                   if (
                                        'https:' ===
                                             F.default.location.protocol &&
                                        0 === t.indexOf('http:') &&
                                        R.IS_IOS &&
                                        -1 <
                                             I.default.html5media.mediaTypes.indexOf(
                                                  e,
                                             )
                                   ) {
                         ...
                         if (null !== o) l = o;
                              ...
                              switch (
                                   ...
                                   case 'iframe':
                                        l.push({
                                             type: '',
                                             src: f.mediaElement.originalNode.getAttribute(
                                                  'src',
                                             ),
                                        });
                                        break;
                         ...
                         var E = I.default.html5media.properties,
                              ...
                              P = function (e) {
                                   ...
                                   if (
                                        ...
                                        (f.mediaElement.originalNode.src =
                                             t[0].src || ''),
                                        null !== u || !t[0].src)
                                   )
                                        return !(
                                             null == t[0].src || '' === t[0].src
                                        )
                                             ? f.mediaElement.changeRenderer(
                                                    u.rendererName,
                                                    t,
                                               )
                                             : null;
                                   f.mediaElement.generateError(
                                        'No renderer found',
                                        t,
                                   );
                              },
                         ...
                         return (
                              (f.mediaElement.addEventListener = function (
                                   e,
                                   t,
                              ) {
                                   (f.mediaElement.events[e] =
                                        f.mediaElement.events[e] || []),
                                        f.mediaElement.events[e].push(t);
                              }),
                              (f.mediaElement.removeEventListener = function (
                                   e,
                                   t,
                              ) {
                                   if (!e)
                                        return (f.mediaElement.events = {}), !0;
                                   var n = f.mediaElement.events[e];
                                   if (!n) return !0;
                                   if (!t)
                                        return (
                                             (f.mediaElement.events[e] = []), !0
                                        );
                              ...
                              (f.mediaElement.destroy = function () {
                                   var e =
                                             f.mediaElement.originalNode.cloneNode(
                                                  !0,
                                             ),
                         ...
                         Object.assign(r.default.prototype, {
                              ...
                              enterFullScreen: function () {
                                   ...
                                   if (o.isVideo)
                                        if (
                                             !1 ===
                                                  o.options.useFakeFullscreen &&
                                             (m.IS_IOS || m.IS_SAFARI) &&
                                             m.HAS_IOS_FULLSCREEN &&
                                             'function' ==
                                                  typeof o.media.originalNode
                                             ...
                                             if (
                                                  ...
                                                  (o.normalHeight = parseFloat(
                                                       t.height,
                                                  )),
                                                  (o.normalWidth = parseFloat(
                                                       t.width,
                                                  )),
                                                  ('native-native' !==
                                                       o.fullscreenMode &&
                              ...
                              exitFullScreen: function () {
                                   ...
                                   if (e.isVideo) {
                                        ...
                                        e.getElement(e.container).dispatchEvent(
                                             d,
                                        );
                                   }
                              },
                                                                 ...
                                                                 b.hasClass)(
                                                                      ...
                                                                      (s +=
                                                                           ...
                                                                           g
                                                                                ...
                                                                                .offsetWidth /
                                                                                2),
                                                                 (g.timefloat.style.left =
                                                                      s + 'px'),
                                                                 (g.timefloatcurrent.innerHTML =
                                                                      (0,
                                                                      E.secondsToTimeCode)(
                                                                           g.newTime,
                                                                           h
                                             ...
                                             function (e) {
                                                  if (
                                                       ...
                                                       var t =
                                                            ...
                                                            n = g.getDuration(),
                                                            o =
                                                                 h.options.defaultSeekForwardInterval(
                                                                      d,
                                                                 ),
                                                            i =
                                                                 h.options.defaultSeekBackwardInterval(
                                                                      d,
                                                                 ),
                                                            r =
                                                                 g.getCurrentTime(),
                         ...
                         Object.assign(i.default.prototype, {
                              ...
                              buildtracks: function (o, e, t, n) {
                                   if (
                                        ...
                                        if (i.domNode.textTracks)
                                             for (
                                                  var d =
                                                       i.domNode.textTracks
                                                            .length - 1;
                                                  0 <= d;
                                                  d--
                                             )
                                                  i.domNode.textTracks[d].mode =
                                                       'hidden';
                                        i.cleartracks(o),
                                             (o.captions =
                                        ...
                                        if (
                                             ...
                                             o.captionsButton.addEventListener(
                                                  'click',
                                                  function (e) {
                                                       var t = 'none';
                                                       null ===
                                             ...
                                             for (
                                                  var g =
                                                            o.captionsButton.querySelectorAll(
                                                                 '.' +
                                                                      i.options
                                                                           .classPrefix +
                                                                      'captions-selector-label',
                                        ...
                                        for (
                                             ...
                                             o.chaptersButton.addEventListener(
                                                  h[k],
                                                  function () {
                                                       this.querySelector(
                                                            '.' +
                              ...
                              cleartracks: function (e) {
                                   e &&
                                        ...
                                        e.captionsText &&
                                             e.captionsText.remove(),
                                        e.captionsButton &&
                                             e.captionsButton.remove(),
                                        e.chaptersButton &&
                                             e.chaptersButton.remove());
                              },
                              ...
                              setTrack: function (e, t) {
                                   for (
                                        var n = this,
                                             o =
                                                  n.captionsButton.querySelectorAll(
                                                       'input[type="radio"]',
                                                  ),
                                             i =
                                                  n.captionsButton.querySelectorAll(
                                        ...
                                        (0, I.ajax)(
                                             ...
                                             function (e) {
                                                  (n.entries =
                                                       'string' == typeof e &&
                                                       /<tt\s+xml/gi.exec(e)
                                                            ? d.default.TrackFormatParser.dfxp.parse(
                                                                   e,
                                                              )
                                                            : d.default.TrackFormatParser.webvtt.parse(
                                                                   e,
                                                              )),
                                                       (n.isLoaded = !0),
                                             ...
                                             if (-1 < n) {
                                                  ...
                                                  return (
                                                       'function' ==
                                                            ...
                                                            (o =
                                                                 e.options.captionTextPreprocessor(
                                                                      o,
                                                                 )),
                                                       (e.captionsText.innerHTML =
                                                            (function (e) {
                                                                 var t =
                                                                      L.default.createElement(
                                                                           'div',
                                             ...
                                             (a.src = t),
                                                  a.addEventListener(
                                                       ...
                                                       function () {
                                                            ...
                                                            (e.style.display =
                                                                 'none'),
                                                                 (r.slidesContainer.innerHTML +=
                                                                      e.innerHTML),
                                                                 (0, I.fadeIn)(
                                                                      r.slidesContainer.querySelector(
                                                                           a,
                                                                      ),
                                                                 );
                                                            for (
                              ...
                              drawChapters: function (e) {
                                   ...
                                   if (t) {
                                        ...
                                        for (
                                             var o =
                                                       r.chaptersButton.querySelectorAll(
                                                            'input[type="radio"]',
                                                       ),
                                                  i =
                                                       r.chaptersButton.querySelectorAll(
                              ...
                              o(r, [
                                             ...
                                             if (
                                                  ...
                                                  if (
                                                       ((i.className =
                                                            ...
                                                            'offscreen'),
                                                       (i.innerText = o),
                                                       n.media.parentNode.insertBefore(
                                                            i,
                                                            n.media,
                                                       ),
                                                       (n.container =
                                                  ...
                                                  if (
                                                       ...
                                                       n
                                                            ...
                                                            n.media.addEventListener(
                                                                 'play',
                                                                 function () {
                                                                      for (var e in ((n.hasFocus =
                                                                           !0),
                                                                      f.default
                                                                           .players))
                                                                           if (
                                                                                f.default.players.hasOwnProperty(
                                                                                     e,
                                                                                )
                                                                           ) {
                                                                                var t =
                                   ...
                                   },
                                   {
                                        ...
                                        value: function (e, t, n) {
                                             ...
                                             if (!a) {
                                                  var l =
                                                       o.media.originalNode.getAttribute(
                                                            'poster',
                                                       );
                                                  if (
                                                       (l &&
                                   ...
                                   },
                                   {
                                        ...
                                        value: function (o, e, t, i) {
                                             ...
                                             r
                                                  ...
                                                  (r.globalKeydownCallback =
                                                       function (e) {
                                                            var t =
                                                                      x.default.activeElement.closest(
                                                                           '.' +
                                                                                r
                                                                                     .options
                                                                                     .classPrefix +
                                   ...
                                   },
                                   {
                                        ...
                                        value: function () {
                                             ...
                                             l.globalUnbind(
                                                  'resize',
                                                  l.globalResizeCallback,
                                             ),
                                                  l.globalUnbind(
                                                       'keydown',
                                                       l.globalKeydownCallback,
                                                  ),
                                                  l.globalUnbind(
                                                       'click',
                                                       l.globalClickCallback,
                                                  ),
                    ...
                    'undefined' != typeof jQuery
                         ...
                         void 0 !== (o = i.default.$) &&
                              ...
                              o(document).ready(function () {
                                   o(
                                        '.' +
                                             i.default.MepDefaults.classPrefix +
                                             'player',
                                   ).mediaelementplayer();
                              }));
               },
                              ...
                              create: function (s, l, e) {
                                                  ...
                                                  (d['get' + e] = function () {
                                                       ...
                                                       (d['set' + e] =
                                                            function (e) {
                                                                 if (
                                                                      -1 ===
                                                                      x.default.html5media.readOnlyProperties.indexOf(
                                                                           i,
                                                                      )
                                                                 )
                                                                      if (
                                   ...
                                   if (
                                        ...
                                        for (
                                             ...
                                             if (
                                                  w.renderer.renderers[
                                                       l.prefix
                                                  ].canPlayType(e[g].type)
                                             ) {
                                                  d.setAttribute(
                                                       'src',
                                                       e[g].src,
                    ...
                    var i = {
                         create: function (e, t, n) {
                              ...
                              (C.default['__ready__' + r.id] = function () {
                                   if (
                                        ((r.flashReady = !0),
                                        (r.flashApi = k.default.getElementById(
                                             '__' + r.id,
                                        )),
                                   ...
                                   (C.default['__event__' + r.id] = function (
                                        e,
                                        t,
                                   ) {
                              ...
                              if (
                                   ...
                                   for (var P = 0, T = n.length; P < T; P++)
                                        if (
                                             A.renderer.renderers[
                                                  t.prefix
                                             ].canPlayType(n[P].type)
                                        ) {
                                             r.setSrc(n[P].src);
                                             break;
                                        }
                                                  ...
                                                  (d['get' + e] = function () {
                                                       ...
                                                       (d['set' + e] =
                                                            function (e) {
                                                                 if (
                                                                      -1 ===
                                                                      b.default.html5media.readOnlyProperties.indexOf(
                                                                           r,
                                                                      )
                                                                 )
                                                                      if (
          ...
          23: [
               function (e, t, n) {
                    ...
                    var a = {
                         ...
                         create: function (n, e, t) {
                              var o = n.id + '_' + e.prefix,
                                   i = !1,
                                   r = null;
                              void 0 === n.originalNode ||
                              null === n.originalNode
                                   ? ((r = g.default.createElement('audio')),
                                     n.appendChild(r))
                                   : (r = n.originalNode),
                                   r.setAttribute('id', o);
                              for (
                                   var a = y.default.html5media.properties,
                                        s = function (t) {
                                             ...
                                             (r['get' + e] = function () {
                                                  ...
                                                  (r['set' + e] = function (e) {
                                                       -1 ===
                                                            y.default.html5media.readOnlyProperties.indexOf(
                                                                 t,
                                                            ) && (r[t] = e);
                                                  });
                                        },
                              ...
                              if (0 < h)
                                   for (; m < h; m++)
                                        if (
                                             E.renderer.renderers[
                                                  e.prefix
                                             ].canPlayType(t[m].type)
                                        ) {
                    ...
                    (o.default.HtmlMediaElement = y.default.HtmlMediaElement =
                         a),
                         E.renderer.add(a);
               },
                              ...
                              create: function (m, n, o) {
                                   ...
                                   (f.id = h.id),
                                        h.options.youtube.nocookie &&
                                             (m.originalNode.src =
                                                  k.getYouTubeNoCookieUrl(
                                                       o[0].src,
                                                  )),
                                        m.originalNode.parentNode.insertBefore(
                                             f,
                                             m.originalNode,
                                        ),
                                   ...
                                   var p =
                                             'audio' ===
                                             m.originalNode.tagName.toLowerCase(),
                                   ...
                                   return (
                                        (p ||
                                             m.originalNode.hasAttribute(
                                                  'playsinline',
                                             )) &&
                                             (x.playerVars.playsinline = 1),
                                        m.originalNode.controls &&
                                             (x.playerVars.controls = 1),
                                        m.originalNode.autoplay &&
                                             (x.playerVars.autoplay = 1),
                                        m.originalNode.loop &&
                                             (x.playerVars.loop = 1),
                                        ((x.playerVars.loop &&
                                             1 ===
               ...
               function (e, t, n) {
                    ...
                    for (
                         var s = (n.NAV = i.default.navigator),
                              ...
                              p = (n.IS_IE = /(trident|microsoft)/i.test(
                                   s.appName,
                              )),
                              m = (n.IS_EDGE =
                                   ('msLaunchUri' in s) &&
                    ...
                    (n.isFullScreen = M),
                         ...
                         (o.default.Features.isiOS =
                              o.default.Features.isiPhone ||
                              o.default.Features.isiPad),
               ...
               function (e, t, n) {
                    ...
                    function s(e) {
                         var t = e.getBoundingClientRect(),
                              n =
                                   l.default.pageXOffset ||
                                   i.default.documentElement.scrollLeft,
                              o =
                                   l.default.pageYOffset ||
                                   i.default.documentElement.scrollTop;
                    ...
                    function a(e) {
                         ...
                         if (C(o)) {
                              ...
                              (c = Math.floor(Math.floor(g / 60) / 60)),
                                   ...
                                   (p = n
                                        ? g % 60
                                        : Math.floor((h / s) % 60).toFixed(i));
                         } else
                              (c = Math.floor(e / 3600) % 24),
                                   (f = Math.floor(e / 60) % 60),
                                   (p = n
                                        ? Math.floor(e % 60)
                                        : Math.floor(e % 60).toFixed(i));
                         (c = c <= 0 ? 0 : c),
                              (p = 60 === (p = p <= 0 ? 0 : p) ? 0 : p),
                              (f = 60 === (f = f <= 0 ? 0 : f) ? 0 : f);
                         for (
                              var y = r.split(':'), E = {}, b = 0, S = y.length;
                              b < S;
                              ++b
                         ) {
                              for (
                                   var x = '', w = 0, P = y[b].length;
                                   w < P;
                                   w++
                              )
