               ...
               function (e, t, n) {
                    ...
                    var a = function e(t, n, r) {
                         ...
                         (r = Array.isArray(r) ? r : null),
                              ...
                              (f.mediaElement = C.default.createElement(
                                   n.fakeNodeName,
                              ));
                         var a = t,
                              i = !1;
                         ...
                         (f.mediaElement.id = a),
                              ...
                              (f.mediaElement.changeRenderer = function (e, t) {
                                   ...
                                   for (
                                        var o = n.mediaElement.options.renderers
                                                  .length
                    ...
                    (O.default.MediaElement = a),
                         (I.default.MediaElement = a),
                         (n.default = a);
               },
                                                  ...
                                                  (d['get' + e] = function () {
                                                       ...
                                                       (d['set' + e] =
                                                            function (e) {
                                                                 if (
                                                                      -1 ===
                                                                      _.default.html5media.readOnlyProperties.indexOf(
                                                                           a,
                                                                      )
                                                                 )
                                                                      if (
                    ...
                    var a = {
                         create: function (e, t, n) {
                              ...
                              (A.default['__ready__' + i.id] = function () {
                                   if (
                                        ((i.flashReady = !0),
                                        (i.flashApi = T.default.getElementById(
                                             '__' + i.id,
                                        )),
                                   ...
                                   (A.default['__event__' + i.id] = function (
                                        e,
                                        t,
                                   ) {
                              ...
                              if (
                                   ...
                                   for (var N = 0, j = n.length; N < j; N++)
                                        if (
                                             x.renderer.renderers[
                                                  t.prefix
                                             ].canPlayType(n[N].type)
                                        ) {
                                             i.setSrc(n[N].src);
                                             break;
                                        }
               ...
               function (e, t, n) {
                    ...
                    var o = {
                         ...
                         create: function (n, e, t) {
                              ...
                              null === n.originalNode
                                   ? ((i = g.default.createElement('audio')),
                                     n.appendChild(i))
                                   : (i = n.originalNode),
                                   i.setAttribute('id', r);
                              for (
                    ...
                    (r.default.HtmlMediaElement = y.default.HtmlMediaElement =
                         o),
                         E.renderer.add(o);
               },
                              ...
                              create: function (p, n, r) {
                                   ...
                                   (f.id = h.id),
                                        h.options.youtube.nocookie &&
                                             (p.originalNode.src =
                                                  T.getYouTubeNoCookieUrl(
                                                       r[0].src,
                                                  )),
                                        p.originalNode.parentNode.insertBefore(
                                             f,
                                             p.originalNode,
                                        ),
                                   ...
                                   var m =
                                             'audio' ===
                                             p.originalNode.tagName.toLowerCase(),
                                   ...
                                   return (
                                        (m ||
                                             p.originalNode.hasAttribute(
                                                  'playsinline',
                                             )) &&
                                             (_.playerVars.playsinline = 1),
                                        p.originalNode.controls &&
                                             (_.playerVars.controls = 1),
                                        p.originalNode.autoplay &&
                                             (_.playerVars.autoplay = 1),
                                        p.originalNode.loop &&
                                             (_.playerVars.loop = 1),
                                        ((_.playerVars.loop &&
                                             1 ===
               ...
               function (e, t, n) {
                    ...
                    for (
                         var l = (n.NAV = a.default.navigator),
                              ...
                              d = (n.IS_IPAD =
                                   /ipad/i.test(s) && !a.default.MSStream),
                              u = (n.IS_IPHONE =
                                   /iphone/i.test(s) && !a.default.MSStream),
                              c = (n.IS_IPOD =
                                   /ipod/i.test(s) && !a.default.MSStream),
                              f =
                                   ((n.IS_IOS =
                                        /ipad|iphone|ipod/i.test(s) &&
                                        !a.default.MSStream),
                                   (n.IS_ANDROID = /android/i.test(s))),
                              m = (n.IS_IE = /(trident|microsoft)/i.test(
                                   l.appName,
                              )),
                              p = (n.IS_EDGE =
                                   ('msLaunchUri' in l) &&
                                   !('documentMode' in i.default)),
                              h = (n.IS_CHROME = /chrome/i.test(s)),
                              v = (n.IS_FIREFOX = /firefox/i.test(s)),
                              g = (n.IS_SAFARI = /safari/i.test(s) && !h),
                              y = (n.IS_STOCK_ANDROID =
                                   /^mozilla\/\d+\.\d+\s\(linux;\su;/i.test(s)),
                    ...
                    var P = void 0 !== S.webkitRequestFullScreen,
                         ...
                         M = void 0;
                    x
                         ? (C = i.default.mozFullScreenEnabled)
                         : L && (C = i.default.msFullscreenEnabled),
                         h && (T = !1),
                         O &&
                              (P
                    ...
                    (n.isFullScreen = k),
                         ...
                         (r.default.Features.isiOS =
                              r.default.Features.isiPhone ||
                              r.default.Features.isiPad),
               ...
               function (e, t, n) {
                    ...
                    function l(e) {
                         var t = e.getBoundingClientRect(),
                              n =
                                   s.default.pageXOffset ||
                                   a.default.documentElement.scrollLeft,
                              r =
                                   s.default.pageYOffset ||
                    ...
                    function d(e, n) {
                         ...
                         return (
                              (e || '').split(' ').forEach(function (e) {
                                   var t = e + (n ? '.' + n : '');
                                   t.startsWith('.')
                                        ? (a.d.push(t), a.w.push(t))
                                        : a[r.test(e) ? 'w' : 'd'].push(t);
                              }),
                              (a.d = a.d.join(' ')),
                              (a.w = a.w.join(' ')),
                              a
