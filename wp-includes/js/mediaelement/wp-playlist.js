          ...
          /** @lends WPPlaylistView.prototype */ {
               ...
               initialize: function (options) {
                    ...
                    this.data =
                         options.metadata ||
                         $.parseJSON(
                              this.$('script.wp-playlist-script').html(),
                         );
                    ...
                    if ('audio' === this.data.type) {
                         this.currentTemplate = wp.template(
               ...
               renderCurrent: function () {
                    var dimensions,
                         defaultImage = 'wp-includes/images/media/video.svg';
                    if ('video' === this.data.type) {
                         if (
                              ...
                              -1 ===
                                   this.current
                                        .get('image')
                                        .src.indexOf(defaultImage)
                         ) {
                              this.playerNode.attr(
                                   'poster',
                                   this.current.get('image').src,
                              );
                         }
                         ...
                         this.currentNode.html(
                              this.currentTemplate(this.current.toJSON()),
                         );
                    }
               },
               ...
               clickTrack: function (e) {
                    ...
                    this.index = this.$('.wp-playlist-item').index(
                         e.currentTarget,
                    );
                    this.setCurrent();
               },
