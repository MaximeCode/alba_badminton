...
})()(
     {
                              ...
                              if (i18n[args[0]] === undefined) {
                                   args[1] =
                                        ...
                                        _typeof(args[1]) === 'object'
                                             ? args[1]
                                             : {};
                                   i18n[args[0]] = !(0, _general.isObjectEmpty)(
                                        args[1],
                                   )
                                        ? args[1]
                                        : _en.EN;
                    ...
                    i18n.t = function (message) {
                         ...
                         if (typeof message === 'string' && message.length) {
                              ...
                              var _plural = function _plural(
                                   ...
                                   return _pluralForms[form].apply(
                                        null,
                                        [number].concat(input),
                                   );
                              };
                              ...
                              if (i18n[language] !== undefined) {
                                   ...
                                   if (
                                        pluralParam !== null &&
                                        typeof pluralParam === 'number'
                                   ) {
                                        pluralForm =
                                             i18n[language]['mejs.plural-form'];
          ...
          6: [
               function (_dereq_, module, exports) {
                    ...
                    var MediaElement = function MediaElement(
                         ...
                         var tagName =
                              t.mediaElement.originalNode.tagName.toLowerCase();
                         if (
                              ['video', 'audio'].indexOf(tagName) > -1 &&
                              !t.mediaElement.originalNode.getAttribute(
                                   'preload',
                              )
                         ) {
                              t.mediaElement.originalNode.setAttribute(
                         ...
                         var processURL = function processURL(url, type) {
                              if (
                                   _window2.default.location.protocol ===
                                        'https:' &&
                                   url.indexOf('http:') === 0 &&
                                   _constants.IS_IOS &&
                                   _mejs2.default.html5media.mediaTypes.indexOf(
                                        type,
                                   ) > -1
                              ) {
                         ...
                         if (sources !== null) {
                              ...
                              switch (
                                   ...
                                   case 'iframe':
                                        mediaFiles.push({
                                             type: '',
                                             src: t.mediaElement.originalNode.getAttribute(
                                                  'src',
                                             ),
                                        });
                                        break;
                         ...
                         t.mediaElement.changeRenderer = function (
                              ...
                              var newRenderer =
                                        t.mediaElement.renderers[rendererName],
                              ...
                              var rendererArray = t.mediaElement.options
                                   .renderers.length
                                   ? t.mediaElement.options.renderers
                                   : _renderer.renderer.order;

                              for (
                                   var _i = 0, total = rendererArray.length;
                                   _i < total;
                                   _i++
                              ) {
                                   ...
                                   if (index === rendererName) {
                                        ...
                                        t.mediaElement.renderers[
                                             newRendererType.name
                                        ] = newRenderer;
                                        t.mediaElement.renderer = newRenderer;
                                        t.mediaElement.rendererName =
                                             rendererName;
                                        newRenderer.show();
                                        return true;
                                   }
                         ...
                         t.mediaElement.setSize = function (width, height) {
                              if (
                                   ...
                                   t.mediaElement.renderer.setSize(
                                        width,
                                        height,
                                   );
                              }
                         ...
                         var props = _mejs2.default.html5media.properties,
                              ...
                              assignGettersSetters =
                                   function assignGettersSetters(propName) {
                                        if (propName !== 'src') {
                                             ...
                                             t.mediaElement['get' + capName] =
                                                  getFn;
                                             t.mediaElement['set' + capName] =
                                                  setFn;
                                        }
                                   },
                              getSrc = function getSrc() {
                                   return t.mediaElement.renderer !==
                                        undefined &&
                                        t.mediaElement.renderer !== null
                              ...
                              setSrc = function setSrc(value) {
                                   ...
                                   if (typeof value === 'string') {
                                        ...
                                        var _src = (0, _media2.absolutizeUrl)(
                                                  value.src,
                                             ),
                                             _type2 = value.type,
                                        ...
                                        for (
                                             var _i2 = 0, total = value.length;
                                             _i2 < total;
                                             _i2++
                                        ) {
                                             var _src2 = (0,
                                                  _media2.absolutizeUrl)(
                                                       value[_i2].src,
                                                  ),
                                                  _type3 = value[_i2].type,
                                                  _media = Object.assign(
                                                       value[_i2],
                                                       {
                                                            src: _src2,
                                                            type:
                                   ...
                                   t.mediaElement.originalNode.src =
                                        mediaFiles[0].src || '';
                              ...
                              assignMethods = function assignMethods(
                                   methodName,
                              ) {
                                   t.mediaElement[methodName] = function () {
                                        ...
                                        if (
                                             t.mediaElement.renderer !==
                                                  undefined &&
                                             t.mediaElement.renderer !== null &&
                                             typeof t.mediaElement.renderer[
                                                  methodName
                                             ] === 'function'
                                        ) {
                                             if (
                         ...
                         for (
                              var _i4 = 0, _total = methods.length;
                              _i4 < _total;
                              _i4++
                         ) {
                         ...
                         t.mediaElement.removeEventListener = function (
                              ...
                              for (var _i5 = 0; _i5 < callbacks.length; _i5++) {
                                   if (callbacks[_i5] === callback) {
                                        t.mediaElement.events[eventName].splice(
                                             _i5,
                                             1,
                                        );
                                        return true;
                         ...
                         t.mediaElement.destroy = function () {
                              var mediaElement =
                                   t.mediaElement.originalNode.cloneNode(true);
                                   ...
                                   value: function select(mediaFiles) {
                                        ...
                                        if (!renderersLength) {
                                             var rendererIndicator = [
                                                  ...
                                                  rendererRanking =
                                                       function rendererRanking(
                                                            renderer,
                                                       ) {
                                                            for (
                                                                 var i = 0,
                                                                      total =
                                                                           rendererIndicator.length;
                                                                 i < total;
                                                                 i++
                                                            ) {
                                                                 if (
                    ...
                    Object.assign(_player2.default.prototype, {
                         ...
                         enterFullScreen: function enterFullScreen() {
                              var t = this,
                                   ...
                                   containerStyles = getComputedStyle(
                              ...
                              if (
                                   ...
                                   typeof t.media.originalNode
                                        .webkitEnterFullscreen === 'function' &&
                                   t.media.originalNode.canPlayType(
                                        (0, _media.getTypeFromFile)(
                                             t.media.getSrc(),
                                        ),
                                   )
                              ) {
                              ...
                              if (captionText) {
                                   ...
                                   t
                                        ...
                                        t.getElement(t.controls).offsetHeight /
                                             2 +
                                        zoomFactor +
                                        15 +
                                        'px';
                         ...
                         exitFullScreen: function exitFullScreen() {
                              ...
                              if (t.options.setDimensions) {
                                   ...
                                   for (var _i2 = 0; _i2 < total; _i2++) {
                                        layers[_i2].style.width =
                                             t.normalWidth + 'px';
                                        layers[_i2].style.height =
                                             t.normalHeight + 'px';
                                   }
                              }
               ...
               function (_dereq_, module, exports) {
                    ...
                    Object.assign(_player2.default.prototype, {
                         buildplaypause: function buildplaypause(
                              ...
                              var t = this,
                                   op = t.options,
                                   playTitle = (0, _general.isString)(
                                        op.playText,
                                   )
                                        ? op.playText
                                        : _i18n2.default.t('mejs.play'),
                                   pauseTitle = (0, _general.isString)(
                                        op.pauseText,
                                   )
                                        ? op.pauseText
                    ...
                    Object.assign(_player2.default.prototype, {
                         buildprogress: function buildprogress(
                                        ...
                                        action: function action(player) {
                                             if (
                                                  ...
                                                  var newTime = Math.max(
                                                       player.currentTime -
                                                            player.options.defaultSeekBackwardInterval(
                                                                 player,
                                                            ),
                                                       0,
                                                  );
                              ...
                              var handleMouseMove = function handleMouseMove(
                                        ...
                                        var totalStyles = getComputedStyle(
                                                  t.total,
                                             ),
                                             offsetStyles = (0, _dom.offset)(
                                                  t.total,
                                             ),
                                             width = t.total.offsetWidth,
                                             transform = (function () {
                                                  if (
                                                       totalStyles.webkitTransform !==
                                                       undefined
                                                  ) {
                                                       return 'webkitTransform';
                                                  } else if (
                                                       totalStyles.mozTransform !==
                                                       undefined
                                                  ) {
                                                       return 'mozTransform ';
                                                  } else if (
                                                       totalStyles.oTransform !==
                                                       undefined
                                                  ) {
                                                       return 'oTransform';
                                                  } else if (
                                                       totalStyles.msTransform !==
                                                       undefined
                                                  ) {
                                                       return 'msTransform';
                                                  } else {
                         ...
                         setCurrentRailHandle: function setCurrentRailHandle(
                              fakeTime,
                         ) {
                              var t = this;
                         ...
                         setCurrentRailMain: function setCurrentRailMain(
                              t,
                              fakeTime,
                         ) {
                              if (
                                   t.getCurrentTime() !== undefined &&
                                   t.getDuration()
                              ) {
                                   var nTime =
                                   ...
                                   if (t.total && t.handle) {
                                        var tW = parseFloat(
                                             getComputedStyle(t.total).width,
                                        );
                                        ...
                                        var newWidth = Math.round(
                                             ...
                                             handlePos =
                                                  newWidth -
                                                  Math.round(
                                                       t.handle.offsetWidth / 2,
                                                  );

                                        handlePos =
                                             handlePos < 0 ? 0 : handlePos;
                                        t.setTransformStyle(
                                             t.current,
                                             'scaleX(' + newWidth / tW + ')',
                                        );
          ...
          12: [
               function (_dereq_, module, exports) {
                    ...
                    Object.assign(_player2.default.prototype, {
                         ...
                         cleancurrent: function cleancurrent(
                              player,
                              controls,
                              layers,
                              media,
          ...
          13: [
               function (_dereq_, module, exports) {
                    ...
                    Object.assign(_player2.default.prototype, {
                         ...
                         buildtracks: function buildtracks(
                              player,
                              controls,
                              layers,
                              media,
                              ...
                              var t = this,
                                   attr = t.options.tracksAriaLive
                                        ...
                                        : '',
                                   tracksTitle = (0, _general.isString)(
                                   ...
                                   chaptersTitle = (0, _general.isString)(
                              ...
                              if (t.domNode.textTracks) {
                                   for (
                                        var i = t.domNode.textTracks.length - 1;
                                        i >= 0;
                                        i--
                                   ) {
                              ...
                              if (
                                   ...
                                   for (
                                        var _i3 = 0, _total = inEvents.length;
                                        _i3 < _total;
                                        _i3++
                                   ) {
                                        player.captionsButton.addEventListener(
                              ...
                              if (player.options.slidesSelector !== '') {
                                   player.slidesContainer =
                                        _document2.default.querySelectorAll(
                         ...
                         setTrack: function setTrack(trackId, setByKeyboard) {
                              ...
                              for (
                                   var _i9 = 0, _total7 = captions.length;
                                   _i9 < _total7;
                                   _i9++
                              ) {
                                   (0, _dom.removeClass)(
                              ...
                              if (trackId === 'none') {
                                   ...
                                   for (
                                        ...
                                        if (_track.trackId === trackId) {
                                             ...
                                             t.captions.setAttribute(
                                                  'lang',
                                                  t.selectedTrack.srclang,
                                             );
                                             t.displayCaptions();
                                             break;
                                        }
                                   ...
                                   (0, _dom.ajax)(
                                        ...
                                        function (d) {
                                             track.entries =
                                                  typeof d === 'string' &&
                                                  /<tt\s+xml/gi.exec(d)
                                                       ? _mejs2.default.TrackFormatParser.dfxp.parse(
                                                              d,
                                                         )
                                                       : _mejs2.default.TrackFormatParser.webvtt.parse(
                                                              d,
                                                         );
                         ...
                         enableTrackButton: function enableTrackButton(track) {
                              ...
                              for (
                                   var i = 0, total = targetSiblings.length;
                                   i < total;
                                   i++
                              ) {
                         ...
                         removeTrackButton: function removeTrackButton(
                              trackId,
                         ) {
                         ...
                         addTrackButton: function addTrackButton(
                              trackId,
                              lang,
                              label,
                         ) {
                              ...
                              if (track !== null && track.isLoaded) {
                                   ...
                                   if (i > -1) {
                                        ...
                                        if (
                                             ...
                                             text =
                                                  t.options.captionTextPreprocessor(
                                                       text,
                                                  );
                                        t.captionsText.innerHTML =
                                             sanitize(text);
                         ...
                         showSlide: function showSlide(index) {
                              ...
                              if (
                                   img === undefined ||
                                   img.fadeIn === undefined
                              ) {
                                   var image =
                                        _document2.default.createElement('img');
                                   image.src = url;
                                   image.addEventListener('load', function () {
                                        var self = _this,
                                             visible = (0, _dom.siblings)(
                                                  self,
                                                  function (el) {
                                                       return visible(el);
                                                  },
                                        ...
                                        t.slidesContainer.innerHTML +=
                                             self.innerHTML;
                                        (0, _dom.fadeIn)(
                                             t.slidesContainer.querySelector(
                                                  image,
                                             ),
                                        );
                                        for (
                                             var i = 0, total = visible.length;
                                             i < total;
                                             i++
                                        ) {
                                   ...
                                   (0, _dom.fadeIn)(
                                        t.slidesContainer.querySelector(img),
                                   );
                                   for (
                                        var i = 0, total = _visible.length;
                                        i < total;
                                        i++
                                   ) {
                         ...
                         drawChapters: function drawChapters(chapters) {
                              ...
                              for (
                                   ...
                                   radios[_i13].addEventListener(
                                        'click',
                                        function (e) {
                                             var self = this,
                                                  listItems =
                                                       t.chaptersButton.querySelectorAll(
                                                            'li',
                                                       ),
                                                  label = (0, _dom.siblings)(
                                                       self,
                                                       function (el) {
                                                            return (0,
                                                            _dom.hasClass)(
                              ...
                              for (
                                   ...
                                   labels[_i15].addEventListener(
                                        'click',
                                        function (e) {
                                             var radio = (0, _dom.siblings)(
                                                       this,
                                                       function (el) {
                                                            return (
                                                                 el.tagName ===
          ...
          14: [
               function (_dereq_, module, exports) {
                    ...
                    Object.assign(_player2.default.prototype, {
                         buildvolume: function buildvolume(
                              player,
                              controls,
                              layers,
                              media,
                              ...
                              var t = this,
                                   ...
                                   muteText = (0, _general.isString)(
                                        t.options.muteText,
                                   )
                                        ? t.options.muteText
                                        : _i18n2.default.t('mejs.mute'),
                                   unmuteText = (0, _general.isString)(
                              ...
                              if (mode === 'horizontal') {
                                   var anchor =
                                        _document2.default.createElement('a');
                                   anchor.className =
                                        t.options.classPrefix +
                              ...
                              var volumeSlider =
                                   ...
                                   positionVolumeHandle =
                                        function positionVolumeHandle(volume) {
                                             ...
                                             if (mode === 'vertical') {
                                                  ...
                                                  volumeCurrent.style.height =
                                                       volumePercentage;
                                                  volumeHandle.style.bottom =
                                                       volumePercentage;
                                   ...
                                   handleVolumeMove = function handleVolumeMove(
                                        e,
                                   ) {
                                        var totalOffset = (0, _dom.offset)(
                                                  volumeTotal,
                                             ),
                                             volumeStyles =
                              ...
                              mute.querySelector('button').addEventListener(
                                   'click',
                                   function () {
               ...
               function (_dereq_, module, exports) {
                    ...
                    var MediaElementPlayer = (function () {
                         function MediaElementPlayer(node, o) {
                              ...
                              if (o === undefined) {
                                   var options =
                                        t.node.getAttribute('data-mejsoptions');
                         ...
                         _createClass(MediaElementPlayer, [
                              ...
                              },
                              {
                                   ...
                                   value: function init() {
                                        ...
                                        if (
                                             ...
                                             offscreen.innerText =
                                                  videoPlayerTitle;
                                             t.media.parentNode.insertBefore(
                                                  offscreen,
                                                  t.media,
                                             );
                                             ...
                                             playerOptions.pluginWidth =
                                                  t.width;
                                             playerOptions.pluginHeight =
                                                  t.height;
                                        } else if (
                                             !t.isVideo &&
                                             !t.options.features.length &&
                                             ...
                                             if (t.options.useDefaultControls) {
                                                  ...
                                                  t.options.features =
                                                       defaultControls.concat(
                                                            t.options.features.filter(
                                                                 function (
                                                                      item,
                                                                 ) {
                                                                      return (
                                                                           defaultControls.indexOf(
                                                                                item,
                                                                           ) ===
                                                                           -1
                                                                      );
                              ...
                              },
                              {
                                   ...
                                   value: function _handleError(
                                        ...
                                        if (!errorContent) {
                                             var poster =
                                                  t.media.originalNode.getAttribute(
                                                       'poster',
                                                  );
                                             if (poster) {
                                                  imgError =
                              ...
                              },
                              {
                                   ...
                                   value: function setResponsiveMode() {
                                        ...
                                        if (newHeight && parentWidth) {
                                             ...
                                             var layerChildren = t.getElement(
                                                  t.layers,
                                             ).children;
                                             for (
                                                  var i = 0,
                                                       total =
                                                            layerChildren.length;
                                                  i < total;
                                                  i++
                                             ) {
                                                  layerChildren[i].style.width =
                                                       '100%';
                                                  layerChildren[
                                                       i
                                                  ].style.height = '100%';
                              ...
                              },
                              {
                                   ...
                                   value: function setFillMode() {
                                        ...
                                        var targetElement = t
                                             ...
                                             scaleX1 = parentWidth,
                                             scaleY1 =
                                                  (initHeight * parentWidth) /
                                                  initWidth,
                                             scaleX2 =
                                                  (initWidth * parentHeight) /
                                                  initHeight,
                                        ...
                                        for (
                                             ...
                                             targetElement[i].style.height =
                                                  height;
                                             targetElement[i].style.width =
                                                  width;
                                             if (t.media.setSize) {
                                                  t.media.setSize(
                                                       width,
                                             ...
                                             targetElement[i].style.marginTop =
                                                  0;
                                        }
                                   },
                              },
                              {
                                   ...
                                   value: function setDimensions(
                                        ...
                                        width =
                                             (0, _general.isString)(width) &&
                                             width.indexOf('%') > -1
                                                  ? width
                                                  : parseFloat(width) + 'px';
                                        height =
                                             (0, _general.isString)(height) &&
                                             height.indexOf('%') > -1
                                                  ? height
                                        ...
                                        var layers = t.getElement(
                                             t.layers,
                                        ).children;
                                        for (
                                             var i = 0, total = layers.length;
                                             i < total;
                                             i++
                                        ) {
                                        ...
                                        if (t.rail && dom.visible(t.rail)) {
                                             var totalStyles = t.total
                                                  ...
                                                  totalMargin = totalStyles
                                                       ? parseFloat(
                                                              totalStyles.marginLeft,
                                                         ) +
                                                         parseFloat(
                                                              totalStyles.marginRight,
                                                         )
                                                       : 0,
                                                  railStyles = getComputedStyle(
                                                       t.rail,
                                                  ),
                                                  railMargin =
                                                       parseFloat(
                                                            railStyles.marginLeft,
                                                       ) +
                                                       parseFloat(
                                                            railStyles.marginRight,
                                                       );
                              ...
                              },
                              {
                                   ...
                                   value: function addControlElement(
                                        element,
                                        key,
                                   ) {
                                        var t = this;
                                        ...
                                        if (
                                             t.featurePosition[key] !==
                                             undefined
                                        ) {
                                             var child = t.getElement(
                                                  t.controls,
                                             ).children[
                                             ...
                                             for (
                                                  ...
                                                  _eventList[_i2]
                                                       ...
                                                       .reduce(function (
                                                            ...
                                                            _window2.default.addEventListener(
                                                                 e,
                                                                 callback,
                                                                 false,
                                                            );
                              ...
                              },
                              {
                                   ...
                                   value: function buildposter(
                                        ...
                                        var posterUrl =
                                             media.originalNode.getAttribute(
                                                  'poster',
                                             );
                                        ...
                                        if (player.options.poster !== '') {
                                             if (
                                                  ...
                                                  media.originalNode.removeAttribute(
                                                       'poster',
                                                  );
                                             }
                              ...
                              },
                              {
                                   ...
                                   value: function buildkeyboard(
                                        ...
                                        t.globalKeydownCallback = function (
                                             event,
                                        ) {
                                             var container =
                                                       _document2.default.activeElement.closest(
                                                            '.' +
                                                                 t.options
                                                                      .classPrefix +
                                                                 'container',
                                        ...
                                        t.globalClickCallback = function (
                                             event,
                                        ) {
                                             t.hasFocus =
                                        ...
                                        t.globalBind(
                                             'keydown',
                                             t.globalKeydownCallback,
                                        );

                                        t.globalBind(
                                             'click',
                                             t.globalClickCallback,
                                        );
                                   },
                              },
                              {
                              ...
                              },
                              {
                                   ...
                                   value: function remove() {
                                        ...
                                        for (var featureIndex in t.options
                                             .features) {
                                             var feature =
                                                  t.options.features[
                                                       featureIndex
                                        ...
                                        if (
                                             t.media.renderer &&
                                             typeof t.media.renderer.destroy ===
                                                  'function'
                                        ) {
               ...
               function (_dereq_, module, exports) {
                    ...
                    var NativeDash = {
                         ...
                         _createPlayer: function _createPlayer(settings) {
                              ...
                              _window2.default['__ready__' + settings.id](
                                   player,
                              );
                              return player;
                         },
                    ...
                    var DashNativeRenderer = {
                         ...
                         create: function create(
                              ...
                              for (
                                   var _i2 = 0, _total2 = props.length;
                                   _i2 < _total2;
                                   _i2++
                              ) {
                              ...
                              _window2.default['__ready__' + id] = function (
                                   ...
                                   mediaElement.dashPlayer = dashPlayer =
                                        _dashPlayer;
                                   ...
                                   for (var eventType in dashEvents) {
                                        if (
                                             dashEvents.hasOwnProperty(
                                                  eventType,
                                             )
                                        ) {
                                             dashPlayer.on(
                                                  dashEvents[eventType],
                                                  function (e) {
                                                       return assignMdashEvents(
                                                            e,
                                                       );
                                                  },
                                             );
                              ...
                              if (mediaFiles && mediaFiles.length > 0) {
                                   for (
                                        ...
                                        if (
                                             _renderer.renderer.renderers[
                                                  options.prefix
                                             ].canPlayType(mediaFiles[_i4].type)
                                        ) {
                                             node.setAttribute(
                                                  'src',
                                                  mediaFiles[_i4].src,
          ...
          20: [
               function (_dereq_, module, exports) {
                    ...
                    var PluginDetector = (exports.PluginDetector = {
                         ...
                         hasPluginVersion: function hasPluginVersion(
                              plugin,
                              v,
                         ) {
                         ...
                         addPlugin: function addPlugin(
                              ...
                              PluginDetector.plugins[p] =
                                   PluginDetector.detectPlugin(
                                        pluginName,
                                        mimeType,
                                        activeX,
                                        axDetect,
                         ...
                         detectPlugin: function detectPlugin(
                              ...
                              if (
                                   ...
                                   _typeof(
                                        _constants.NAV.plugins[pluginName],
                                   ) === 'object'
                              ) {
                                   description =
                                        _constants.NAV.plugins[pluginName]
                                   ...
                                   if (
                                        description &&
                                        !(
                                             typeof _constants.NAV.mimeTypes !==
                                                  'undefined' &&
                                             _constants.NAV.mimeTypes[
                                                  mimeType
                                             ] &&
                                   ...
                                   _window2.default.ActiveXObject !== undefined
                              ) {
                                   try {
                    ...
                    var FlashMediaElementRenderer = {
                         create: function create(
                              ...
                              flash.id =
                                   mediaElement.id + '_' + flash.options.prefix;
                              ...
                              var props = _mejs2.default.html5media.properties,
                                   assignGettersSetters =
                                        function assignGettersSetters(
                                             ...
                                             flash['set' + capName] = function (
                                                  value,
                                             ) {
                                                  if (propName === 'src') {
                                                       value = (0,
                                                       _media.absolutizeUrl)(
                                                            value,
                                                       );
                                                  }
                              ...
                              methods.push('stop');
                              for (
                                   var _i = 0, _total = methods.length;
                                   _i < _total;
                                   _i++
                              ) {
                              ...
                              _window2.default['__ready__' + flash.id] =
                                   function () {
                              ...
                              _window2.default['__event__' + flash.id] =
                              ...
                              var autoplay = mediaElement.originalNode.autoplay,
                                   flashVars = [
                                        ...
                                        'allowScriptAccess=' +
                                             flash.options.shimScriptAccess,
                                        'preload=' +
                                             (mediaElement.originalNode.getAttribute(
                                                  'preload',
                                             ) || ''),
                                   ],
                                   isVideo =
                                        mediaElement.originalNode !== null &&
                                        mediaElement.originalNode.tagName.toLowerCase() ===
                                             'video',
                                   flashHeight = isVideo
                                        ? mediaElement.originalNode.height
                                        : 1,
                                   flashWidth = isVideo
                                        ? mediaElement.originalNode.width
                                        : 1;
                              ...
                              if (
                                   flash.options.enablePseudoStreaming === true
                              ) {
                                   flashVars.push(
                                        'pseudostreamstart=' +
                                             flash.options
                              ...
                              if (flash.options.proxyType) {
                                   flashVars.push(
                                        'proxytype=' + flash.options.proxyType,
                                   );
                              }
                              ...
                              if (_constants.IS_IE || _constants.IS_EDGE) {
                                   var specialIEContainer =
                                        _document2.default.createElement('div');
                                   flash.flashWrapper.appendChild(
                                        specialIEContainer,
                                   );
                              ...
                              flash.setSize = function (width, height) {
                                   ...
                                   if (
                                        flash.flashApi !== null &&
                                        typeof flash.flashApi.fire_setSize ===
                                             'function'
                                   ) {
                    ...
                    var hasFlash = PluginDetector.hasPluginVersion(
                         'flash',
                         [10, 0, 0],
                    );
                    ...
                    if (hasFlash) {
                         ...
                         _renderer.renderer.add(
                              FlashMediaElementMdashVideoRenderer,
                         );
                    ...
                    var FlvNativeRenderer = {
                         ...
                         create: function create(
                              ...
                              _window2.default['__ready__' + id] = function (
                                   ...
                                   mediaElement.flvPlayer = flvPlayer =
                                        _flvPlayer;
                                   ...
                                   var assignFlvEvents =
                                        function assignFlvEvents(name, data) {
                                             if (name === 'error') {
                                                  var message =
                                                       data[0] +
                                                       ': ' +
                              ...
                              if (mediaFiles && mediaFiles.length > 0) {
                                   for (
                                        ...
                                        if (
                                             _renderer.renderer.renderers[
                                                  options.prefix
                                             ].canPlayType(mediaFiles[_i2].type)
                                        ) {
                                             node.setAttribute(
                                                  'src',
                                                  mediaFiles[_i2].src,
                    ...
                    var HlsNativeRenderer = {
                         ...
                         create: function create(
                              ...
                              _window2.default['__ready__' + id] = function (
                                   ...
                                   mediaElement.hlsPlayer = hlsPlayer =
                                        _hlsPlayer;
                                   ...
                                   for (
                                        var _i = 0, _total3 = events.length;
                                        _i < _total3;
                                        _i++
                                   ) {
                                        assignEvents(events[_i]);
                                   ...
                                   var assignHlsEvents =
                                        function assignHlsEvents(name, data) {
                                             if (name === 'hlsError') {
                                                  console.warn(data);
                                                  data = data[1];
               ...
               function (_dereq_, module, exports) {
                    ...
                    var HtmlMediaElement = {
                         ...
                         create: function create(
                              ...
                              for (
                                   var _i = 0, _total2 = events.length;
                                   _i < _total2;
                                   _i++
                              ) {
                                   assignEvents(events[_i]);
                    ...
                    _window2.default.HtmlMediaElement =
                         _mejs2.default.HtmlMediaElement = HtmlMediaElement;
               ...
               function (_dereq_, module, exports) {
                    ...
                    var YouTubeApi = {
                         ...
                         getYouTubeId: function getYouTubeId(url) {
                              ...
                              if (url.indexOf('?') > 0) {
                                   youTubeId =
                                        YouTubeApi.getYouTubeIdFromParam(url);

                                   if (youTubeId === '') {
                                        youTubeId =
                                             YouTubeApi.getYouTubeIdFromUrl(
                                                  url,
                                             );
                                   }
                              } else {
                                   youTubeId =
                                        YouTubeApi.getYouTubeIdFromUrl(url);
                              }

                              var id = youTubeId.substring(
                                   youTubeId.lastIndexOf('/') + 1,
                              );
                              youTubeId = id.split('?');
                              return youTubeId[0];
                         },

                         getYouTubeIdFromParam: function getYouTubeIdFromParam(
                              url,
                         ) {
                              if (
                                   url === undefined ||
                              ...
                              for (
                                   var i = 0, total = parameters.length;
                                   i < total;
                                   i++
                              ) {
                         ...
                         getYouTubeIdFromUrl: function getYouTubeIdFromUrl(
                              url,
                         ) {
                              if (
                                   url === undefined ||
                         ...
                         getYouTubeNoCookieUrl: function getYouTubeNoCookieUrl(
                              url,
                         ) {
                              if (
                                   url === undefined ||
                    ...
                    var YouTubeIframeRenderer = {
                         ...
                         create: function create(
                              ...
                              youtube.id =
                                   mediaElement.id + '_' + options.prefix;
                                                            ...
                                                            switch (propName) {
                                                                 case 'src':
                                                                      ...
                                                                      if (
                                                                           ...
                                                                           youTubeApi.loadVideoById(
                                                                                _videoId,
                                                                           );
                                                                      } else {
                                                                           youTubeApi.cueVideoById(
                                                                                _videoId,
                                                                           );
                                                                      }
                                                                      break;
                              ...
                              if (youtube.options.youtube.nocookie) {
                                   mediaElement.originalNode.src =
                                        YouTubeApi.getYouTubeNoCookieUrl(
                                             mediaFiles[0].src,
                                        );
                              }
                              ...
                              var isAudio =
                                   ...
                                   width = isAudio
                                        ? '1'
                                        : mediaElement.originalNode.width,
                                   videoId = YouTubeApi.getYouTubeId(
                                        mediaFiles[0].src,
                                   ),
                                   youtubeSettings = {
                                        id: youtube.id,
                              ...
                              if (
                                   isAudio ||
                                   mediaElement.originalNode.hasAttribute(
                                        'playsinline',
                                   )
                              ) {
                              ...
                              if (
                                   ((youtubeSettings.playerVars.loop &&
                                        ...
                                        mediaElement.originalNode.src.indexOf(
                                             'loop=',
                                        ) > -1) &&
                              ...
                              youtube.getPosterUrl = function () {
                                   var quality = options.youtube.imageQuality,
                                        ...
                                        id = YouTubeApi.getYouTubeId(
                                             mediaElement.originalNode.src,
                                        );
                                   return quality &&
                                        resolutions.indexOf(quality) > -1 &&
                                        id
          ...
          25: [
               function (_dereq_, module, exports) {
                    ...
                    var IS_IE = (exports.IS_IE = /(trident|microsoft)/i.test(
                         NAV.appName,
                    ));
                    ...
                    for (
                         var i = 0, total = html5Elements.length;
                         i < total;
                         i++
                    ) {
                         video = _document2.default.createElement(
                              html5Elements[i],
                         );
                    }
                    ...
                    var hasMozNativeFullScreen =
                         video.mozRequestFullScreen !== undefined;
                    var hasMsNativeFullScreen =
                         video.msRequestFullscreen !== undefined;
                    ...
                    var HAS_WEBKIT_NATIVE_FULLSCREEN =
                         (exports.HAS_WEBKIT_NATIVE_FULLSCREEN =
                              hasWebkitNativeFullScreen);
                    var HAS_MOZ_NATIVE_FULLSCREEN =
                         (exports.HAS_MOZ_NATIVE_FULLSCREEN =
                              hasMozNativeFullScreen);
                    var HAS_MS_NATIVE_FULLSCREEN =
                         (exports.HAS_MS_NATIVE_FULLSCREEN =
                              hasMsNativeFullScreen);
                    var HAS_IOS_FULLSCREEN = (exports.HAS_IOS_FULLSCREEN =
                         hasiOSFullScreen);
                    var HAS_TRUE_NATIVE_FULLSCREEN =
                         (exports.HAS_TRUE_NATIVE_FULLSCREEN =
                    ...
                    _mejs2.default.Features.requestFullScreen =
                         requestFullScreen;
          ...
          26: [
               function (_dereq_, module, exports) {
                    ...
                    function loadScript(url) {
                         return new Promise(function (resolve, reject) {
                              var script =
                                   _document2.default.createElement('script');
                              script.src = url;
                              script.async = true;
                    ...
                    if ('classList' in _document2.default.documentElement) {
                         hasClassMethod = function hasClassMethod(
                              el,
                              className,
                         ) {
                              return (
                         ...
                         addClassMethod = function addClassMethod(
                              el,
                              className,
                         ) {
                              return el.classList.add(className);
                         };
                         removeClassMethod = function removeClassMethod(
                              el,
                              className,
                         ) {
                    ...
                    function fadeOut(el) {
                         ...
                         var start = null;
                         _window2.default.requestAnimationFrame(
          ...
          28: [
               function (_dereq_, module, exports) {
                    ...
                    function getTypeFromFile(url) {
                         ...
                         for (
                              var i = 0, total = typeChecks.length;
                              i < total;
                              i++
                         ) {
                    ...
                    _mejs2.default.Utils.normalizeExtension =
                         normalizeExtension;
               },
               { 27: 27, 7: 7 },
          ],
               ...
               function (_dereq_, module, exports) {
                    ...
                    function secondsToTimeCode(time) {
                         ...
                         if (isDropFrame(fps)) {
                              ...
                              hours = Math.floor(
                                   Math.floor(timeBaseDivision / 60) / 60,
                              );
                              ...
                              if (showFrameCount) {
                                   ...
                                   seconds = Math.floor(time % 60).toFixed(
                                        secondsDecimalLength,
                                   );
                              }
                         }
                         ...
                         for (
                              var i = 0, total = timeFormatFrags.length;
                              i < total;
                              ++i
                         ) {
                              var unique = '';
                              for (
                                   var j = 0, t = timeFormatFrags[i].length;
                                   j < t;
                                   j++
                              ) {
                                   if (
                                        unique.indexOf(timeFormatFrags[i][j]) <
                                        0
                                   ) {
                              ...
                              if (~['f', 's', 'm', 'h'].indexOf(unique)) {
                                   timeFormatSettings[unique] =
                                        timeFormatFrags[i].length;
                              }
                         }

                         var result =
                              forceHours || hours > 0
                                   ? (hours < 10 && timeFormatSettings.h > 1
                                          ? '0' + hours
                                          : hours) + ':'
                                   : '';
                         result +=
                    ...
                    _mejs2.default.Utils.calculateTimeFormat =
                         calculateTimeFormat;
