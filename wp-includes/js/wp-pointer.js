          ...
          /** @lends $.widget.wp.pointer.prototype */ {
               options: {
                    ...
                    buttons: function (event, t) {
                         var button = $('<a class="close" href="#"></a>').text(
                              wp.i18n.__('Dismiss'),
                         );
               ...
               repoint: function () {
                    ...
                    this.pointer[0].className =
                         this.pointer[0].className.replace(
                              /wp-pointer-[^\s'"]*/,
                              '',
                         );
               ...
               _processPosition: function (position) {
                    ...
                    if (result.edge == 'top' || result.edge == 'bottom') {
                         ...
                         result.at =
                              result.at ||
                              result.align + ' ' + opposite[result.edge];
                         result.my =
                              result.my || result.align + ' ' + result.edge;
                    } else {
                         result.align = result.align || 'top';

                         result.at =
                              result.at ||
                              opposite[result.edge] + ' ' + result.align;
                         result.my =
                              result.my || result.edge + ' ' + result.align;
                    }
