          ...
          if (
               ...
               imgPreloader.onload = function () {
                    ...
                    jQuery('#TB_window').append(
                         "<a href='' id='TB_ImageOff'><span class='screen-reader-text'>" +
                              ...
                              thickboxL10n.close +
                              "</span><span class='tb-close-icon' aria-hidden='true'></span></button></div>",
                    );
               ...
               if (url.indexOf('TB_iframe') != -1) {
                    ...
                    if (params['modal'] != 'true') {
                         ...
                         jQuery('#TB_window').append(
                              "<div id='TB_title'><div id='TB_ajaxWindowTitle'>" +
                                   ...
                                   thickboxL10n.close +
                                   "</span><span class='tb-close-icon' aria-hidden='true'></span></button></div></div><iframe frameborder='0' hspace='0' allowtransparency='true' src='" +
                                   urlNoQuery[0] +
                    ...
                    if (jQuery('#TB_window').css('visibility') != 'visible') {
                         if (params['modal'] != 'true') {
                              ...
                              jQuery('#TB_window').append(
                                   "<div id='TB_title'><div id='TB_ajaxWindowTitle'>" +
                                        ...
                                        "</div><div id='TB_closeAjaxWindow'><button type='button' id='TB_closeWindowButton'><span class='screen-reader-text'>" +
                                        thickboxL10n.close +
                                        "</span><span class='tb-close-icon' aria-hidden='true'></span></button></div></div><div id='TB_ajaxContent' style='width:" +
                                        ajaxContentW +
                                        'px;height:' +
                                        ajaxContentH +
                                        "px'></div>",
                         ...
                         jQuery('#TB_ajaxContent')[0].style.width =
                              ajaxContentW + 'px';
                         jQuery('#TB_ajaxContent')[0].style.height =
                              ajaxContentH + 'px';
