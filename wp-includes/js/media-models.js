                         ...
                         sync: function (method, model, options) {
                              ...
                              if ('read' === method) {
                                   ...
                                   options.data = _.extend(options.data || {}, {
                                        ...
                                        post_id: wp.media.model.settings.post
                                             .id,
                                   });
                                    ...
                                    */
                                   return Backbone.Model.prototype.sync.apply(
                                        this,
                                        arguments,
                                   );
                              }
               ...
               var Attachments = Backbone.Collection.extend(
                    /** @lends wp.media.model.Attachments.prototype */ {
                         ...
                         _changeFilteredProps: function (model) {
                              ...
                              this.reset(
                                   this._source.filter(this.validator, this),
                              );
                         },
                         ...
                         observe: function (attachments) {
                              ...
                              attachments.on(
                                   'add',
                                   this._addToTotalAttachments,
                                   this,
                              );
                              attachments.on(
                                   'remove',
                                   this._removeFromTotalAttachments,
                                   this,
                              );
                              attachments.on(
                                   'reset',
                                   this._validateAllHandler,
                                   this,
                              );
               ...
               var PostImage = Backbone.Model.extend(
                    /** @lends wp.media.model.PostImage.prototype */ {
                         ...
                         changeAttachment: function (attachment, props) {
                              ...
                              this.set(
                                   'attachment_id',
                                   this.attachment.get('id'),
                              );
                              this.set(
                                   'caption',
                                   this.attachment.get('caption'),
                              );
                         ...
                         setAspectRatio: function () {
                              ...
                              this.set(
                                   'aspectRatio',
                                   this.get('customWidth') /
                                        this.get('customHeight'),
                              );
                         },
                    },
               );
               ...
               Query = Attachments.extend(
                    /** @lends wp.media.model.Query.prototype */ {
                         ...
                         initialize: function (models, options) {
                              ...
                              options = options || {};
                              Attachments.prototype.initialize.apply(
                                   this,
                                   arguments,
                              );
                    ...
                    /** @lends wp.media.model.Query */ {
                         ...
                         get: (function () {
                              ...
                              return function (props, options) {
                                   ...
                                   args.orderby =
                                        orderby.valuemap[props.orderby] ||
                                        props.orderby;
               ...
               Selection = Attachments.extend(
                    /** @lends wp.media.model.Selection.prototype */ {
                         ...
                         add: function (models, options) {
                               ...
                               */
                              return Attachments.prototype.add.call(
                                   this,
                                   models,
                                   options,
                              );
     ...
     (() => {
          ...
          media = wp.media = function (attributes) {
               ...
               if ('select' === attributes.frame && MediaFrame.Select) {
                    ...
                    'image' === attributes.frame &&
                    MediaFrame.ImageDetails
               ) {
                    frame = new MediaFrame.ImageDetails(attributes);
               } else if (
                    'audio' === attributes.frame &&
                    MediaFrame.AudioDetails
               ) {
                    frame = new MediaFrame.AudioDetails(attributes);
               } else if (
                    'video' === attributes.frame &&
                    MediaFrame.VideoDetails
               ) {
          ...
          _.extend(
               ...
               /** @lends wp.media */ {
                    ...
                    fit: function (dimensions) {
                          ...
                          */
                         if (
                              !_.isUndefined(maxWidth) &&
                              !_.isUndefined(maxHeight)
                         ) {
                              constraint =
