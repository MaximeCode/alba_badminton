/******/ (() => {
               ...
               TwoColumn = Details.extend(
                    /** @lends wp.media.view.Attachment.Details.TowColumn.prototype */ {
                         ...
                         initialize: function () {
                              ...
                              Details.prototype.initialize.apply(
                                   this,
                                   arguments,
                              );
                         },
          ...
          /***/ 5806: /***/ (module) => {
               ...
               DeleteSelectedPermanently = DeleteSelected.extend(
                    /** @lends wp.media.view.DeleteSelectedPermanentlyButton.prototype */ {
                         initialize: function () {
                              DeleteSelected.prototype.initialize.apply(
                                   this,
                                   arguments,
                              );
                              this.controller.on(
          ...
          /***/ 6606: /***/ (module) => {
               ...
               DeleteSelected = Button.extend(
                    /** @lends wp.media.view.DeleteSelectedButton.prototype */ {
                         initialize: function () {
                              Button.prototype.initialize.apply(
                                   this,
                                   arguments,
                              );
                              if (this.options.filters) {
                                   this.options.filters.model.on(
                                        'change',
                                        this.filterChange,
                                        this,
                                   );
               ...
               SelectModeToggle = Button.extend(
                    /** @lends wp.media.view.SelectModeToggle.prototype */ {
                         ...
                         toggleBulkEditHandler: function () {
                              var toolbar =
                                        this.controller.content.get().toolbar,
                                   children;
               ...
               EditAttachments = MediaFrame.extend(
                    /** @lends wp.media.view.MediaFrame.EditAttachments.prototype */ {
                         ...
                         editMetadataMode: function (contentRegion) {
                              contentRegion.view =
                                   new wp.media.view.Attachment.Details.TwoColumn(
                                        {
                                             controller: this,
                                             model: this.model,
                                        },
                         ...
                         editImageMode: function (contentRegion) {
                              ...
                              contentRegion.view =
                                   new wp.media.view.EditImage.Details({
                                        model: this.model,
                                        frame: this,
                         ...
                         resetRoute: function () {
                              var searchTerm =
                                        this.controller.browserView.toolbar
                                             .get('search')
                                             .$el.val(),
                                   url =
                                        '' !== searchTerm
                    ...
                    /** @lends wp.media.view.MediaFrame.Manage.prototype */ {
                         ...
                         initialize: function () {
                              ...
                              this.$uploaderToggler = $('.page-title-action')
                                   ...
                                   .on(
                                        'click',
                                        _.bind(this.addNewClickHandler, this),
                                   );

                              this.$window.on(
                                   'scroll resize',
                                   _.debounce(
                                        _.bind(this.fixPosition, this),
                                        15,
                                   ),
                              );
                              ...
                              this.gridRouter =
                                   new wp.media.view.MediaFrame.Manage.Router();
                         ...
                         handleKeydown: function (e) {
                              if (27 === e.which) {
                                   e.preventDefault();
                                   this.deactivateMode('select').activateMode(
                                        'edit',
                                   );
                              }
                         },
                         ...
                         bindKeydown: function () {
                              this.$body.on(
                                   'keydown.select',
                                   _.bind(this.handleKeydown, this),
                              );
                         },
                         ...
                         browseContent: function (contentRegion) {
                              ...
                              this.browserView = contentRegion.view =
                         ...
                         bindDeferred: function () {
                              ...
                              this.browserView.dfd.done(
                                   _.bind(this.startHistory, this),
                              );
                         },
                         ...
                         startHistory: function () {
                              ...
                              if (window.history && window.history.pushState) {
                                   ...
                                   Backbone.history.start({
                                        root: window._wpMediaGridSettings
                                             .adminUrl,
                                        pushState: true,
                                   });
                              }
     ...
     (() => {
          ...
          media.view.DeleteSelectedPermanentlyButton =
