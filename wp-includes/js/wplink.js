...
(function ($, wpLinkL10n, wp) {
     ...
     window.wpLink = {
          ...
          mceRefresh: function (searchStr, text) {
               ...
               if (linkNode.length) {
                    ...
                    if (
                         searchStr &&
                         (urlRegexp.test(searchStr) ||
                              emailRegexp.test(searchStr))
                    ) {
                         href = searchStr;
                    }
          ...
          close: function (reset) {
               ...
               if (reset !== 'noReset') {
                    if (!wpLink.isMCE()) {
                         ...
                         if (wpLink.range) {
                              wpLink.range.moveToBookmark(
                                   wpLink.range.getBookmark(),
                              );
                              wpLink.range.select();
                         }
                    } else {
          ...
          getAttrs: function () {
               ...
               return {
                    ...
                    target: inputs.openInNewTab.prop('checked')
                         ? '_blank'
                         : null,
               };
          },
          ...
          updateFields: function (e, li) {
               ...
               if (
                    inputs.wrap.hasClass('has-text-field') &&
                    !inputs.text.val()
               ) {
          ...
          searchInternalLinks: function () {
               var waiting,
                    ...
                    minInputLength =
                         parseInt(wpLinkL10n.minInputLength, 10) || 3;
     ...
     $.extend(River.prototype, {
          ...
          ajax: function (callback) {
               var self = this,
                    delay =
                         this.query.page == 1 ? 0 : wpLink.minRiverAJAXDuration,
