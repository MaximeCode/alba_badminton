     ...
     var media = (function () {
          ...
          var dataToHtml = function (editor, dataIn) {
               ...
               if (data.embed) {
                    ...
                    var audioTemplateCallback =
                         Settings.getAudioTemplateCallback(editor);
                    var videoTemplateCallback =
                         Settings.getVideoTemplateCallback(editor);
          ...
          var getData = function (editor) {
               ...
               return element.getAttribute('data-mce-object')
                    ? HtmlToData.htmlToData(
                           Settings.getScripts(editor),
                           editor.serializer.serialize(element, {
                                selection: true,
                           }),
                      )
                    : {};
          ...
          var showDialog = function (editor) {
               ...
               var reserialise = function (update) {
                    ...
                    win.find('#embed').value(
                         UpdateHtml.updateHtml(data.embed, data),
                    );
               };
                    ...
                    while (i--) {
                         ...
                         if (videoScript) {
                              if (videoScript.width) {
                                   node.attr(
                                        'width',
                                        videoScript.width.toString(),
                                   );
                              }
                              if (videoScript.height) {
                                   node.attr(
                                        'height',
                                        videoScript.height.toString(),
                                   );
                              }
                         }
                         if (
                              ...
                              if (!isWithinEphoxEmbed(node)) {
                                   node.replace(
                                        createPreviewIframeNode(editor, node),
                                   );
                              }
                         } else {
                              if (!isWithinEphoxEmbed(node)) {
                                   node.replace(
                                        createPlaceholderNode(editor, node),
                                   );
                              }
                         }
                    }
                              ...
                              while (i--) {
                                   ...
                                   if (
                                        ...
                                        if (
                                             ...
                                             realElm.attr({
                                                  width: node.firstChild.attr(
                                                       'width',
                                                  ),
                                                  height: node.firstChild.attr(
                                                       'height',
                                                  ),
                                             });
                                        } else {
               ...
               editor.on('setContent', function () {
                    editor
                         ...
                         .each(function (index, elm) {
                              var $elm = editor.$(elm);
                              if (
                                   $elm.find('span.mce-shim', elm).length === 0
                              ) {
                                   $elm.append(
