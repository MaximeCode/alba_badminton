!(function () {
     ...
     var e,
          ...
          I = function (r, e) {
               var n = v.extend({}, e);
               if (!n.source1 && (v.extend(n, P(w(r), n.embed)), !n.source1))
                    return '';
               n.source2 || (n.source2 = ''),
                    n.poster || (n.poster = ''),
               ...
               return c
                    ? ((i = t),
                      ...
                      new F(function (t, e) {
                           var r = function (e) {
                                return (
                                     e.html && (q[i.source1] = e),
                                     t({
                                          url: i.source1,
                                          html: e.html ? e.html : o(i),
                                     })
                                );
                           };
                           q[i.source1]
          ...
          se = function (n) {
               ...
               if (
                    ...
                    var u = re(function (e) {
                         e(i),
                              (t = i.toJSON()),
                              i.find('#embed').value(W(t.embed, t));
                    });
                    a.push(u);
               }
          ...
          ge = function (e, t, r) {
               ...
               (c = t.firstChild && t.firstChild.value) &&
                    (r.attr('data-mce-html', escape(he(e, c))),
                    (r.firstChild = null));
          },
          ve = function (e) {
               for (; (e = e.parent); )
