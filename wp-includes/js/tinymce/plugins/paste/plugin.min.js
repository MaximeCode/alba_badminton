!(function (v) {
          ...
          return (
               b.each(t, function (t, e) {
                    ...
                    0 !== e.indexOf('mso-comment')
                         ? 0 !== e.indexOf('mso-') &&
                           ('all' === g.getRetainStyleProps(n) ||
                                (r && r[e])) &&
                           (u[e] = t)
                         : o.remove();
               }),
               /(bold)/i.test(u['font-weight']) &&
                    (delete u['font-weight'], o.wrap(new E('b', 1))),
               /(italic)/i.test(u['font-style']) &&
                    (delete u['font-style'], o.wrap(new E('i', 1))),
     ...
     var vt = gt.exports.boltExport,
          ...
          Wt = function (t, e, n, r) {
               $t(t.clipboardData, e.html, e.text)
                    ? (t.preventDefault(), r())
                    : n(e.html, r);
          },
          Ut = function (u) {
          ...
          Gt = function (t, e) {
               return qt.getCaretRangeFromPoint(
                    e.clientX,
                    e.clientY,
                    t.getDoc(),
               );
