     ...
     var paste = (function (domGlobals) {
          ...
          var togglePlainTextPaste = function (
               ...
               if (clipboard.pasteFormat.get() === 'text') {
                    ...
                    if (
                         shouldInformUserAboutPlainText(
                              editor,
                              userIsInformedState,
                         )
                    ) {
                    ...
                    for (key in rootAttrs) {
                         if (rootAttrs.hasOwnProperty(key)) {
                              attrs.push(
                                   key +
                                        '="' +
                                        global$6.encodeAllRaw(rootAttrs[key]) +
                                        '"',
                              );
                         }
                    }
          ...
          function filterStyles(editor, validStyles, node, styleValue) {
               ...
               outputStyles = editor.dom.serializeStyle(
                    outputStyles,
                    node.name,
               );
               if (outputStyles) {
          ...
          var postProcessFilter = function (
               editor,
               html,
               internal,
               isWordHtml,
          ...
          var filterContent = function (editor, content, internal, isWordHtml) {
               ...
               var filteredContent = preProcess$1(
                    editor,
          ...
          var process = function (editor, html, internal) {
               ...
               var content = isWordHtml
                    ? WordFilter.preProcess(editor, html)
                    : html;
                                        ...
                                        (function (setImmediate) {
                                             (function (root) {
                                                  ...
                                                  Promise._setUnhandledRejectionFn =
                                                       function _setUnhandledRejectionFn(
                                                            fn,
                                                       ) {
                                                            Promise._unhandledRejectionFn =
                                                                 fn;
               ...
               if (dataTransfer) {
                    if (dataTransfer.getData) {
                         ...
                         if (legacyText && legacyText.length > 0) {
                              if (
                                   legacyText.indexOf(mceInternalUrlPrefix) ===
                                   -1
                              ) {
               ...
               editor.on('keydown', function (e) {
                    ...
                    if (isKeyboardPasteEvent(e) && !e.isDefaultPrevented()) {
                         ...
                         if (
                              keyboardPastePlainTextState &&
                              global$2.webkit &&
                              domGlobals.navigator.userAgent.indexOf(
                                   'Version/',
                              ) !== -1
                         ) {
                              return;
          ...
          var registerEventsAndFilters = function (
               ...
               editor.parser.addNodeFilter('img', function (nodes, name, args) {
                    ...
                    if (
                         !editor.settings.paste_data_images &&
                         isPasteInsert(args)
                    ) {
                         var i = nodes.length;
                         while (i--) {
          ...
          var Clipboard = function (editor, pasteFormat) {
               ...
               editor.on('preInit', function () {
                    return registerEventsAndFilters(
                         editor,
                         pasteBin,
                         pasteFormat,
                    );
          ...
          var setup = function (editor, clipboard, draggingInternallyState) {
               ...
               editor.on('drop', function (e) {
                    ...
                    if (
                         e.isDefaultPrevented() ||
                         draggingInternallyState.get()
                    ) {
                         return;
                    }
                    dropContent = clipboard.getDataTransferItems(
                         e.dataTransfer,
                    );
               ...
               editor.on('dragover dragend', function (e) {
                    if (
                         ...
                         setFocusedRange(
                              editor,
                              getCaretRangeFromEvent(editor, e),
                         );
                    }
                    if (e.type === 'dragend') {
               ...
               if (webKitStyles) {
                    ...
                    content = content.replace(
                         ...
                         function (all, before, value, after) {
                              var inputStyles = dom_1.parseStyle(
                                   dom_1.decode(value),
                              );
                              var outputStyles = {};
          ...
          global$1.add('paste', function (editor) {
               if (DetectProPlugin.hasProPlugin(editor) === false) {
                    ...
                    var pasteFormat = Cell(
                         Settings.isPasteAsTextEnabled(editor)
                              ? 'text'
                              : 'html',
                    );
