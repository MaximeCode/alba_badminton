!(function (u) {
     ...
     var e,
          ...
          D = function (e, n) {
               return (
                    !!h(n) &&
                    !(!e.isBlock(n.nextSibling) || h(n.previousSibling))
               );
          },
          w = function (e, n, t) {
               var r = e.isEmpty(n);
               return (
                    !(
                         t &&
                         0 < e.select('span[data-mce-type=bookmark]', n).length
                    ) && r
               );
          },
          k = function (e, n) {
          ...
          ce = function (e) {
               ...
               return ((n = t), ae('HTMLElement', n)).prototype.isPrototypeOf(
                    e,
               );
          },
               ...
               return (
                    ie(n).each(function (e) {
                         ...
                         (u = c),
                              ...
                              (i.item = u),
                              (a = d),
                              dn((s = e).list) !== a.listType &&
                                   (s.list = hn(s.list, a.listType)),
               ...
               return (
                    ...
                    (function (e, n) {
                         ...
                         ie(e).each(function (e) {
                              mn(e.list, n.listAttributes),
                                   mn(e.item, n.itemAttributes),
                                   cn(e.item, n.content);
                         });
                    })(o, t),
                    (r = o),
          ...
          En = function (e) {
               var n = tn(e),
                    t = un(e).map(Cn).getOr(!1) ? n.slice(0, -1) : n;
               return J(t, vn);
          },
          ...
          Pn = function (e) {
               ...
               return Ne(
                    te(r, M(On)),
                    te(((n = r), (t = Y.call(n, 0)).reverse(), t), M(On)),
                    function (e, n) {
               ...
               for (
                    o = n[t ? 'startContainer' : 'endContainer'],
                         ...
                         1 === o.nodeType &&
                              (o =
                                   o.childNodes[
                                        Math.min(i, o.childNodes.length - 1)
                                   ] || o),
          ...
          ot = function (e, n, t, r) {
               var o,
                    ...
                    u = n.startContainer,
                    s = n.startOffset;
               if (3 === u.nodeType && (t ? s < u.data.length : 0 < s))
                    return u;
               for (
          ...
          st = function (n, e, t) {
               ...
               if (k(n, e) && k(n, t)) {
                    N(t.lastChild) && (o = t.lastChild),
                         ...
                         ut(n, e, t),
                         o && t.appendChild(o);
                    var u = Ze(ye.fromDom(t), ye.fromDom(e))
                         ? n.getParents(e, N, t)
                         : [];
                    n.remove(e),
                         Z(u, function (e) {
          ...
          ct = function (e, n) {
               ...
               if (c) {
                    ...
                    if (
                         ((r = x(u.getRng(!0))),
                         (o = i.getParent(ot(e, r, n, a), 'LI', a)) && o !== c)
                    )
                         return (
                              n
                                   ? at(e, r, o, c)
               ...
               return e.selection.isCollapsed()
                    ...
                    : ((r = (t = e).selection.getStart()),
                      ...
                      !!(
                           ...
                           0 < ve.getSelectedListItems(t).length
                      ) &&
