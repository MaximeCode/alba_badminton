(function () {
     var lists = (function (domGlobals) {
          ...
          var isTextBlock = function (editor, node) {
               return (
                    node &&
                    !!editor.schema.getTextBlockElements()[node.nodeName]
               );
          };
          ...
          var getNormalizedPoint = function (container, offset) {
               ...
               if (NodeType.isTextNode(node)) {
                    ...
                    node.nextSibling &&
                    NodeType.isTextNode(node.nextSibling)
               ) {
                    return {
          ...
          var normalizeRange = function (rng) {
               ...
               var rangeStart = getNormalizedPoint(
                    rng.startContainer,
                    rng.startOffset,
               );
               outRng.setStart(rangeStart.container, rangeStart.offset);
               var rangeEnd = getNormalizedPoint(
                    rng.endContainer,
                    rng.endOffset,
               );
          ...
          var parent = function (element) {
               return Option.from(element.dom().parentNode).map(
                    Element.fromDom,
               );
          };
          ...
          var isSupported = function (dom) {
               return (
                    dom.style !== undefined &&
                    isFunction(dom.style.getPropertyValue)
               );
          };
          ...
          var cloneItemContent = function (li) {
               ...
               var content = hasLastChildList(li)
                    ...
                    .fold(
                         function () {
                              ...
                              var childListEntries = lastChild(item)
                                   ...
                                   .getOr([]);
                              return currentItemEntry
                                   .toArray()
                                   .concat(childListEntries);
                         },
                         function (list) {
                              return parseList(
                                   depth,
          ...
          var createTextBlock = function (editor, contentNode) {
               ...
               if (blockName) {
                    ...
                    if (
                         textBlock.tagName === editor.settings.forced_root_block
                    ) {
                         dom.setAttribs(
                              textBlock,
               ...
               if (!editor.settings.forced_root_block) {
                    ...
                    if (!hasContentNode && (!global$8.ie || global$8.ie > 10)) {
                         textBlock.appendChild(
                              dom.create('br', { 'data-mce-bogus': '1' }),
                         );
                    }
               }
               return fragment;
          ...
          var outdentedComposer = function (editor, entries) {
               return map(entries, function (entry) {
                    ...
                    return Element.fromDom(
                         createTextBlock(editor, content.dom()),
                    );
               });
          };
          ...
          var listsIndentation = function (editor, lists, indentation) {
               ...
               each(entrySets, function (entrySet) {
                    ...
                    before$1(
                         entrySet.sourceList,
                         composeEntries(editor, entrySet.entries),
                    );
          ...
          var applyList = function (editor, listName, detail) {
               ...
               var dom = editor.dom;
               if (
                    dom.getContentEditable(editor.selection.getNode()) ===
                    'false'
               ) {
                    return;
               }
          ...
          var toggleMultipleLists = function (
               ...
               if (
                    ...
                    var bookmark = Bookmark.createBookmark(
          ...
          var backspaceDeleteFromListToListCaret = function (
               editor,
               isForward,
          ) {
               var dom = editor.dom,
          ...
          var setupTabKey = function (editor) {
               editor.on('keydown', function (e) {
                    if (
                         e.keyCode !== global$3.TAB ||
                         global$3.metaKeyPressed(e)
                    ) {
                         return;
                    }
                    editor.undoManager.transact(function () {
          ...
          var register$1 = function (editor) {
               var hasPlugin = function (editor, plugin) {
                    var plugins = editor.settings.plugins
                         ...
                         : '';
                    return (
                         global$5.inArray(plugins.split(/[ ,]/), plugin) !== -1
                    );
               };
