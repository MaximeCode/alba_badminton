     ...
     var image = (function (domGlobals) {
          ...
          var splitTextBlock = function (editor, figure) {
               ...
               var textBlock = dom.getParent(
                    figure.parentNode,
                    function (node) {
                         return editor.schema.getTextBlockElements()[
                              node.nodeName
                         ];
                    },
                    editor.getBody(),
          ...
          var insertImageAtCaret = function (editor, data) {
               ...
               var insertedElm = editor.dom.select(
               ...
               return function (evt) {
                    ...
                    if (css['border-width']) {
                         rootControl
                              .find('#border')
                              .value(
                                   Utils.removePixelSuffix(css['border-width']),
                              );
                    } else {
          ...
          var onSrcChange = function (evt, editor) {
               ...
               if (imageListCtrl) {
                    imageListCtrl.value(
                         editor.convertURL(control.value(), 'src'),
                    );
               }
          ...
          function Uploader(settings) {
               ...
               var upload = function (blobInfo) {
                    return !settings.url && isDefaultHandler(settings.handler)
                         ? global$1.reject(
                                'Upload url missing from the settings.',
                           )
               ...
               function showDialog(imageList) {
                    ...
                    if (imageList) {
                         imageListCtrl = {
                              ...
                              value:
                                   data.src &&
                                   editor.convertURL(data.src, 'src'),
                              onselect: function (e) {
