(function (tinymce) {
     ...
     tinymce.ui.Factory.add(
          ...
          tinymce.ui.Control.extend({
               ...
               getURL: function () {
                    return tinymce.trim(
                         this.getEl().firstChild.nextSibling.value,
                    );
               },
               getLinkText: function () {
                    var text =
                         this.getEl().firstChild.nextSibling.nextSibling.value;
     ...
     tinymce.PluginManager.add('wplink', function (editor) {
          ...
          function removePlaceholderStrings(content, dataAttr) {
               return content.replace(
                    ...
                    function (all, tag, text) {
                         ...
                         if (dataAttr) {
                              tag = tag.replace(
                                   / data-wplink-edit="true"/g,
                                   '',
                              );
                         }

                         tag = tag.replace(
                              / data-wplink-url-error="true"/g,
                              '',
                         );
                              ...
                              window.setTimeout(function () {
                                   ...
                                   if (element) {
                                        if (
                                             !element.value &&
                                             selection &&
                                             typeof window.wpLink !==
                                                  'undefined'
                                        ) {
                                             element.value =
                                                  window.wpLink.getUrlFromSelection(
                                                       selection,
                                                  );
                                        }
          ...
          editor.addCommand('wp_link_apply', function () {
               ...
               if (linkNode) {
                    ...
                    if (
                         'javascript:' === parser.protocol ||
                         'data:' === parser.protocol
                    ) {
                         // jshint ignore:line
                         href = '';
                    }
          ...
          editor.on('wptoolbar', function (event) {
               ...
               if (linkNode) {
                    ...
                    if (href === '_wp_link_placeholder' || edit) {
                         ...
                         if (
                              $linkNode.attr('data-wplink-url-error') === 'true'
                         ) {
                              toolbar.$el
