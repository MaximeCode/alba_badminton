     ...
     function patchEditor(editor) {
          ...
          function patchEditorEvents(oldEventNames, argsMap) {
               tinymce.each(oldEventNames.split(' '), function (oldName) {
                    editor['on' + oldName] = new Dispatcher(
                         editor,
                         oldName,
                         argsMap,
                    );
          ...
          patchEditorEvents(
               'BeforeExecCommand ExecCommand',
               'command ui value args',
          ); // args.terminate not supported
          patchEditorEvents(
               'PreProcess PostProcess LoadContent SaveContent Change',
          );
          patchEditorEvents(
          ...
          editor.on('init', function () {
               ...
               undoManager.onAdd = new Dispatcher(
                    editor,
                    'AddUndo',
                    null,
                    undoManager,
          ...
          editor.on('BeforeRenderUI', function () {
               ...
               windowManager.createInstance = function (
                    className,
                    a,
                    b,
                    c,
