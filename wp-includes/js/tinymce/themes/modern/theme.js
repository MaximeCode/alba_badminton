     ...
     var modern = (function (domGlobals) {
          ...
          var NONE = (function () {
               ...
               var me = {
                    ...
                    getOrDie: function (msg) {
                         throw new Error(
                              msg || 'error: getOrDie called on none.',
                         );
                    },
          ...
          var addContextualToolbars = function (editor) {
               ...
               var reposition = function (match, shouldShow) {
                    ...
                    if (
                         DOM.getStyle(match.element, 'display', true) !==
                         'inline'
                    ) {
          ...
          var cleanupMenu = function (namedMenuItems, removedMenuItems) {
               var menuItemsPass1 = filter(
                    ...
                    function (namedMenuItem) {
                         return (
                              removedMenuItems.hasOwnProperty(
                                   namedMenuItem.name,
                              ) === false
                         );
                    },
               ...
               var menuItemsPass2 = filter(
                    ...
                    function (namedMenuItem, i) {
                         return (
                              ...
                              !isSeparator(menuItemsPass1[i - 1])
                         );
                    },
               );
                              ...
                              items: [
                                   hasMenubar(editor) === false
                                        ...
                                        : {
                                               type: 'menubar',
                                               border: '0 0 1 0',
                                               items: Menubar.createMenuButtons(
                                                    editor,
                                               ),
                                          },
          ...
          var funcs = {
               ...
               getPos: function (elm, root) {
                    return global$3.DOM.getPos(
                         elm,
                         root || funcs.getContainer(),
                    );
               },
          ...
          var getWindowViewPort = function () {
               ...
               var w =
                    win.innerWidth ||
                    domGlobals.document.documentElement.clientWidth;
               var h =
                    win.innerHeight ||
                    domGlobals.document.documentElement.clientHeight;
               return {
                    x: x,
                    y: y,
                    w: w,
          ...
          var Movable = {
               testMoveRel: function (elm, rels) {
                    ...
                    for (var i = 0; i < rels.length; i++) {
                         var pos = calculateRelativePosition(
                              this,
                              elm,
                              rels[i],
                         );
                         if (isFixed(this)) {
                              ...
                              if (
                                   ...
                                   pos.x + pos.w <
                                        viewPortRect.w + viewPortRect.x &&
                                   pos.y > viewPortRect.y &&
                                   pos.y + pos.h <
                                        viewPortRect.h + viewPortRect.y
                              ) {
                                   return rels[i];
                              }
                         }
          ...
          var global$b = tinymce.util.Tools.resolve(
          ...
          var Selector = global$a.extend({
               init: function (selector) {
                    ...
                    function compileClassesFilter(classes) {
                         if (classes) {
                              ...
                              return function (item) {
                                   ...
                                   while (i--) {
                                        if (
                                             !item.classes.contains(classes[i])
                                        ) {
                                             return false;
                                        }
                                   }
                    ...
                    function compile(selector, filters, direct) {
                         ...
                         parts = expression.exec(
                              selector.replace(whiteSpace, ''),
                         );
          ...
          var proto$1 = {
               ...
               init: function (settings) {
                    ...
                    self.settings = settings = global$2.extend(
                         {},
                         self.Defaults,
                         settings,
                    );
               ...
               initLayoutRect: function () {
                    ...
                    self.marginBox =
                         self.marginBox || BoxUtils.measureBox(elm, 'margin');
          ...
          function bindPendingEvents(eventCtrl) {
               ...
               if (nativeEvents) {
                    ...
                    if (!eventRootCtrl) {
                         eventRootCtrl =
                              parents[parents.length - 1] || eventCtrl;
                    }
                    ...
                    for (name in nativeEvents) {
                         ...
                         if (name === 'mouseenter' || name === 'mouseleave') {
                              ...
                              global$9(eventRootCtrl.getEl()).on(
                                   name,
                                   delegate,
                              );
          ...
          function KeyboardNavigation(settings) {
               ...
               function focusFirst(targetControl) {
                    ...
                    var focusElements = getFocusElements(
                         navigationRoot.getEl(),
                    );
                    if (
               ...
               function moveFocus(dir, elements) {
                    ...
                    elements =
                         elements || getFocusElements(navigationRoot.getEl());
                    ...
                    idx += dir;
                    navigationRoot.lastAriaIndex = moveFocusToIndex(
                         idx,
                         elements,
                    );
               }
               function left() {
                    ...
                    if (parentRole === 'tablist') {
                         moveFocus(
                              -1,
                              getFocusElements(focusedElement.parentNode),
                         );
               ...
               function tab(e) {
                    var parentRole = getParentRole();
                    if (parentRole === 'tablist') {
                         var elm = getFocusElements(
                              focusedControl.getEl('body'),
                         )[0];
                         if (elm) {
                              elm.focus();
                         }
                    ...
                    self.items().each(function (ctrl, index) {
                         ...
                         if (!ctrl.state.get('rendered')) {
                              ...
                              if (
                                   ...
                                   global$9(
                                        containerElm.childNodes[index],
                                   ).before(ctrl.renderHtml());
                              } else {
                                   global$9(containerElm).append(
                                        ctrl.renderHtml(),
                                   );
                              }
                              ctrl.postRender();
          ...
          function getDocumentSize(doc) {
               ...
               return {
                    width:
                         scrollWidth < offsetWidth ? clientWidth : scrollWidth,
                    height:
          ...
          var Scrollable = {
               ...
               renderScroll: function () {
                    ...
                    function repaintScroll() {
                              ...
                              if (scrollBarElm) {
                                   ...
                                   containerSize -=
                                        hasScrollH && hasScrollV
                                             ...
                                             : 0;
                                   scrollSize =
                                        containerElm['scroll' + sizeName];
                                   ratio = containerSize / scrollSize;
                                   rect = {};
                                   rect[posNameLower] =
                                        containerElm['offset' + posName] +
                                        margin;
                                   rect[sizeNameLower] = containerSize;
                                   global$9(scrollBarElm).css(rect);
                                   rect = {};
                                   rect[posNameLower] =
                                        containerElm['scroll' + posName] *
                                        ratio;
                         ...
                         hasScrollV =
                              bodyElm.scrollHeight > bodyElm.clientHeight;
                         repaintAxis(
                              'h',
                              'Left',
                              'Width',
          ...
          var FloatPanel = Panel.extend({
               ...
               init: function (settings) {
                         ...
                         if (e.control === self) {
                              ...
                              if (self.modal && !hasModal) {
                                   ...
                                   global$7.setTimeout(function () {
                                        $modalBlockEl_1.addClass(
                                             prefix_1 + 'in',
                                        );
                                        global$9(self.getEl()).addClass(
                                             prefix_1 + 'in',
                                        );
                                   });
                                   hasModal = true;
                    ...
                    self.aria(
                         'describedby',
                         self.describedBy || self._id + '-none',
                    );
               },
          ...
          var isFixed$1 = function (inlineToolbarContainer, editor) {
               return !!(
                    inlineToolbarContainer && !editor.settings.ui_container
               );
          };
                    ...
                    if (
                         ...
                         if (scrollContainer) {
                              var bodyPos = DOM.getPos(body),
                                   scrollContainerPos =
                                        DOM.getPos(scrollContainer);
                              deltaX = Math.max(
                                   0,
                                   scrollContainerPos.x - bodyPos.x,
                              );
                              deltaY = Math.max(
                                   0,
                                   scrollContainerPos.y - bodyPos.y,
                              );
                         }
                         panel.fixed(false)
                              .moveRel(
          ...
          var setup = function (editor, theme) {
               ...
               editor.on('ProgressState', function (e) {
                    throbber =
                         throbber || new Throbber(theme.panel.getEl('body'));
                    if (e.state) {
          ...
          var Tooltip = Control$1.extend({
               ...
               bindStates: function () {
                    ...
                    self.state.on('change:text', function (e) {
                         self.getEl().lastChild.innerHTML = self.encode(
                              e.value,
                         );
                    });
                    return self._super();
          ...
          var Window = FloatPanel.extend({
               ...
               recalc: function () {
                    ...
                    if (statusbar) {
                         statusbar
                              .layoutRect({ w: self.layoutRect().innerW })
                              .recalc();
                         width =
                              statusbar.layoutRect().minW + layoutRect.deltaW;
                         if (width > layoutRect.w) {
                              x =
                                   layoutRect.x -
                                   Math.max(0, width - layoutRect.w);
                              self.layoutRect({
                                   w: width,
                                   x: x,
                              });
               ...
               fullscreen: function (state) {
                    ...
                    if (state !== self._fullscreen) {
                         ...
                         if (!state) {
                              self.borderBox = BoxUtils.parseBox(
                    ...
                    self.state.on('change:icon', function (e) {
                         ...
                         if (icon) {
                              if (!iconElm || iconElm !== btnElm.firstChild) {
                                   iconElm =
                                        domGlobals.document.createElement('i');
                                   btnElm.insertBefore(
                                        iconElm,
                                        btnElm.firstChild,
                                   );
          ...
          var Checkbox = Widget.extend({
               ...
               bindStates: function () {
                    ...
                    self.state.on('change:text', function (e) {
                         self.getEl('al').firstChild.data = self.translate(
                              e.value,
                         );
                    });
          ...
          var ColorBox = ComboBox.extend({
               ...
               repaintColor: function (value) {
                    ...
                    var elm = openElm
                         ? openElm.getElementsByTagName('i')[0]
                         : null;
                    if (elm) {
                         try {
          ...
          var Path = Widget.extend({
               ...
               _getDataPathHtml: function (data) {
                    ...
                    if (!html) {
                         html =
                              '<div class="' + prefix + 'path-item">\xA0</div>';
                    }
                    return html;
               },
          });
               ...
               postRender: function () {
                    ...
                    function isHidden(elm) {
                         if (elm.nodeType === 1) {
                              ...
                              if (
                                   elm.getAttribute('data-mce-type') ===
                                   'bookmark'
                              ) {
                                   return true;
                              }
          ...
          var PROCESSING_INSTRUCTION =
               domGlobals.Node.PROCESSING_INSTRUCTION_NODE;
          ...
          var browsers = [
               ...
               },
               {
                    ...
                    search: function (uastring) {
                         return (
                              contains(uastring, 'msie') ||
                              contains(uastring, 'trident')
                         );
                    },
               },
               {
          ...
          var oses = [
               ...
               },
               {
                    ...
                    search: function (uastring) {
                         return (
                              contains(uastring, 'iphone') ||
                              contains(uastring, 'ipad')
                         );
                    },
                    versionRegexes: [
                         /.*?version\/\ ?([0-9]+)\.([0-9]+).*/,
          ...
          var bypassSelector = function (dom) {
               return (
                    (dom.nodeType !== ELEMENT$1 &&
                         dom.nodeType !== DOCUMENT$1) ||
                    dom.childElementCount === 0
               );
          };
          var all = function (selector, scope) {
               var base =
                    scope === undefined ? domGlobals.document : scope.dom();
          ...
          var hasContentEditableState = function (value) {
               return function (node) {
                    if (node && node.nodeType === 1) {
                         ...
                         if (
                              node.getAttribute('data-mce-contenteditable') ===
                              value
                         ) {
                              return true;
                         }
          ...
          var createMenuItems = function (
               ...
               var anchorMenuItems = function () {
                    ...
                    if (topAnchor !== null) {
                         anchorMenuItems.unshift(
                              staticMenuItem('<top>', topAnchor),
                         );
                    }
                    if (bottomAchor !== null) {
          ...
          var filterByQuery = function (term, menuItems) {
               ...
               var result = global$2.grep(menuItems, function (item) {
                    return (
                         item.title.toLowerCase().indexOf(lowerCaseTerm) !== -1
                    );
               });
          ...
          var setupLinkValidatorHandler = function (
               ...
               var validatorHandler =
                    editorSettings.filepicker_validator_handler;
               if (validatorHandler) {
               ...
               global$2.each(
                    ...
                    function (item, name) {
                         editor.addButton(name, {
                              ...
                              tooltip: item[0],
                              cmd: item[1],
                              onPostRender: postRenderFormatToggle(
                                   editor,
                                   name,
                              ),
                         });
          ...
          var hideFormatMenuItems = function (editor, menu) {
               ...
               menu.items().each(function (item) {
                    if (item.menu) {
                         item.visible(
                              hideFormatMenuItems(editor, item.menu) > 0,
                         );
                    }
          ...
          var createListBoxChangeHandler = function (
               editor,
               items,
               formatName,
          ) {
          ...
          var createInsertMenu = function (editor) {
               ...
               if (insertButtonItems) {
                    ...
                    return trimMenuItems(
                         createContextMenuItems(editor, 'insert'),
                    );
               }
          };
          ...
          var GridLayout = AbsoluteLayout.extend({
               recalc: function (container) {
                    ...
                    contLayoutRect = container.layoutRect();
                    cols =
                         settings.columns || Math.ceil(Math.sqrt(items.length));
                    ...
                    for (maxY = 0, y = 0; y < rows; y++) {
                         ...
                         availableHeight -=
                              (y > 0 ? spacingV : 0) + rowHeights[y];
                    }
                    maxX += contPaddingBox.left + contPaddingBox.right;
                    maxY += contPaddingBox.top + contPaddingBox.bottom;
                    rect = {};
                    rect.minW =
                         maxX + (contLayoutRect.w - contLayoutRect.innerW);
                    rect.minH =
                         maxY + (contLayoutRect.h - contLayoutRect.innerH);
                    ...
                    rect.minW = Math.max(
                         rect.minW,
                         contLayoutRect.startMinWidth,
                    );
                    rect.minH = Math.max(
                         rect.minH,
                         contLayoutRect.startMinHeight,
                    );
                    if (
                         contLayoutRect.autoResize &&
                         (rect.minW !== contLayoutRect.minW ||
          ...
          var InfoBox = Widget.extend({
               ...
               bindStates: function () {
                    var self = this;
                    self.state.on('change:text', function (e) {
                         self.getEl('body').firstChild.data = self.encode(
                              e.value,
                         );
                         if (self.state.get('rendered')) {
          ...
          var Label = Widget.extend({
               ...
               repaint: function () {
                    var self = this;
                    if (!self.settings.multiline) {
                         self.getEl().style.lineHeight =
                              self.layoutRect().h + 'px';
                    }
                    return self._super();
               },
               severity: function (level) {
          ...
          var MenuButton = Button.extend({
               ...
               showMenu: function (toggle) {
                    ...
                    var selfBottom =
                         self.$el.offset().top + self.layoutRect().h;
                    if (
               ...
               renderHtml: function () {
                    ...
                    self.aria(
                         'role',
                         self.parent() instanceof MenuBar
                              ? 'menuitem'
                              : 'button',
                    );
                    return (
               ...
               postRender: function () {
                    ...
                    self.on('click', function (e) {
                         if (
                              e.control === self &&
                              isChildOf$1(e.target, self.getEl())
                         ) {
                              self.focus();
               ...
               init: function (settings) {
                    ...
                    function setSelected(menuValues) {
                         for (var i = 0; i < menuValues.length; i++) {
                              ...
                              if (selected) {
                                   selectedText =
                                        selectedText || menuValues[i].text;
                         ...
                         self._dragHelper = new DragHelper(self._id, {
                              ...
                              start: function (e) {
                                   ...
                                   startHandlePos = parseInt(
                                        self.getEl('handle').style[
                                             stylePosName
                                        ],
                                        10,
                                   );
                                   maxHandlePos =
                                        (self.layoutRect()[shortSizeName] ||
                                             100) -
                                        funcs.getSize(handleEl)[sizeName];
                                   self.fire('dragstart', { value: value });
                              },
          ...
          var TabPanel = Panel.extend({
               ...
               activateTab: function (idx) {
                    ...
                    global$9(activeTabElm).addClass(
                         this.classPrefix + 'active',
                    );
               ...
               postRender: function () {
                    ...
                    this.on('click', function (e) {
                         ...
                         if (
                              ...
                              while (i--) {
                                   if (
                                        targetParent.childNodes[i] === e.target
                                   ) {
                                        self.activateTab(i);
                                   }
                              }
