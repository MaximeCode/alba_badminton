!(function (_) {
     ...
     var e,
          ...
          T =
               ...
               (i = {
                    ...
                    getOrDie: function (e) {
                         throw new Error(
                              e || 'error: getOrDie called on none.',
                         );
                    },
                    getOrNull: k(null),
                    ...
                    n = function (e, t) {
                         ...
                         if (!x.removed) {
                              ...
                              if (
                                   ...
                                   (o.y += b.y),
                                   'inline' !==
                                        B.getStyle(e.element, 'display', !0))
                              ) {
                              ...
                              x.inline ||
                                   (o.w =
                                        x.getDoc().documentElement.offsetWidth),
                                   ...
                                   n
                                        ? ((a = C.relativePosition(i, r, n)),
                                          z(s, I(u, a.x, a.y, r, o, i)))
                                        : ((o.h += i.h),
                                          (r = C.intersect(o, r))
                                               ? (n =
                                                      C.findBestRelativePosition(
                                                           i,
                                                           r,
                                                           o,
                                                           [
          ...
          re = function (e) {
               for (
                    var t,
                         ...
                         r = w.makeMap(
                              ((t = e),
                              t.getParam('removed_menuitems', '')).split(
                                   /[ ,]/,
                              ),
                         ),
                         o = c(e),
          ...
          ae = function (e, t, n) {
               ...
               (i = e.getContainer()),
                    ...
                    null !== t &&
                         ((t = Math.max(
                              e.getParam('min_width', 100, 'number'),
                              t,
                         )),
                         (t = Math.min(
                              e.getParam('max_width', 65535, 'number'),
                              t,
                         )),
                    ...
                    (n = Math.min(
                         e.getParam('max_height', 65535, 'number'),
                         n,
                    )),
          ...
          be = function (t, e, n) {
               ...
               if (
                    (!1 === m(t) && n.skinUiCss
                         ? pe.styleSheetLoader.load(n.skinUiCss, ge(t))
                         : ge(t)(),
                    (i = e.panel =
                         v.create({
                              type: 'panel',
                    ...
                    'none' !== g(t) &&
                         (r = {
                              ...
                              onResizeStart: function () {
                                   var e =
                                        t.getContentAreaContainer().firstChild;
                                   o = {
                                        width: e.clientWidth,
     ...
     w.extend(We.prototype, {
          ...
          toggle: function (e, t) {
               ...
               return (
                    n !== t &&
                         (n ? this.remove(e) : this.add(e), this._change()),
                    this
               );
          },
          contains: function (e) {
     ...
     var De,
          ...
          Ie = Se.extend({
               ...
               match: function (e, t) {
                    ...
                    for (
                         n = 0, i = (t = t || this._selectors).length;
                         n < i;
                         n++
                    ) {
                         for (
     ...
     var Xe,
          ...
          Je = Se.extend({
               ...
               set: function (t, n) {
                    var i,
                         ...
                         o = this.data[t];
                    if (
                         (n instanceof Ye && (n = n.create(this, t)),
                         'object' == typeof t)
                    ) {
          ...
          tt = {
                         ...
                         e
                              ? ((i = a.deltaW),
                                ...
                                (n = e.innerH) !== undefined &&
                                     ...
                                     (a.innerH = n),
                                     (a.h = n + r)),
                                e.contentW !== undefined &&
                                     (a.contentW = e.contentW),
                                e.contentH !== undefined &&
                                     (a.contentH = e.contentH),
               ...
               renderTo: function (e) {
                    return (
                         ye(e || this.getContainerElm()).append(
                              this.renderHtml(),
                         ),
                         this.postRender(),
                         this
     ...
     function st(e) {
          ...
          function d(e) {
               ...
               for (
                    var i = 0;
                    i < n.length && !(t = n[i]).settings.ariaRoot;
                    i++
               );
               return t;
          }
                         ...
                         function t(e, t, n, i, r, o) {
                              ...
                              if ((a = p.getEl('scroll' + e))) {
                                   if (
                                        ((f = t.toLowerCase()),
                                        (h = n.toLowerCase()),
                                        ye(p.getEl('absend')).css(
                                             f,
                                             p.layoutRect()[i] - 1,
                                        ),
                                        !r)
                                   )
                                        return void ye(a).css(
                                             'display',
                                             'none',
                                        );
     ...
     function Rt(e, t) {
          ...
          i
               ...
               : o && (o.parentNode.removeChild(o), (mt = !1)),
               (Ct.currentZIndex = r);
     }
     var Ct = pt.extend({
          Mixins: [He, vt],
     ...
     var kt = function (s, n, e) {
          ...
          return (
               ...
               !1 === m(s) && e.skinUiCss
                    ? l.styleSheetLoader.load(e.skinUiCss, ge(s))
                    : ge(s)(),
               {}
          );
     };
     ...
     function zt(e, t) {
          (function () {
               ...
               !1 === t &&
               ye([_.document.documentElement, _.document.body]).removeClass(
                    e + 'fullscreen',
               );
     }
     var It = Ct.extend({
          ...
          init: function (e) {
               ...
               n._super(e),
                    ...
                    n.on('click', function (e) {
                         ...
                         (we.hasClass(e.target, t) ||
                              we.hasClass(e.target.parentNode, t)) &&
                              n.close();
                    }),
               ...
               if (e !== i._fullscreen)
                    if (
                         ...
                         (i.borderBox = Me(i.settings.border)),
                              ...
                              (t.deltaH += t.headerH),
                              ye([r, _.document.body]).removeClass(
                                   o + 'fullscreen',
                              ),
     ...
     !(function () {
          if (!ce.desktop) {
               ...
               u.setInterval(function () {
                    ...
                    (n.w === e && n.h === t) ||
                         ((n = { w: e, h: t }), ye(_.window).trigger('resize'));
               }, 100);
          }
          ye(_.window).on('resize', function () {
               var e,
               ...
               for (e = 0; e < At.length; e++)
                    (t = At[e].layoutRect()),
                         At[e].moveTo(
                              At[e].settings.x ||
                                   Math.max(0, n.w / 2 - t.w / 2),
                              At[e].settings.y ||
                                   Math.max(0, n.h / 2 - t.h / 2),
                         );
          });
     })();
     var Ft,
               ...
               renderHtml: function () {
                    ...
                    return (
                         (e = l.image)
                              ? ((o = 'none'),
                                'string' != typeof e &&
                                     (e = _.window.getSelection ? e[0] : e[1]),
                                (e =
          ...
          Qt = Nt.extend({
               ...
               statusMessage: function (e) {
                    return (
                         0 < arguments.length &&
                              this.state.set('statusMessage', e),
               ...
               repaint: function () {
                    ...
                    n.statusLevel() &&
                         ...
                         (s =
                              parseInt(
                                   we.getRuntimeStyle(a, 'padding-right'),
                                   10,
                              ) -
                              parseInt(
                                   we.getRuntimeStyle(a, 'padding-left'),
                                   10,
                              )),
          ...
          sn = Nt.extend({
               ...
               postRender: function () {
                    ...
                    (i = a.getEl('h')),
                         ...
                         a._super(),
                         (a._svdraghelper = new ct(a._id + '-sv', {
                              start: e,
                              drag: e,
                         })),
          ...
          ei = function (e) {
               return (
                    (t = e) && 'A' === t.nodeName && (t.id || t.name) && ni(e)
               );
               var t;
          },
          ti = function (e) {
               ...
               recalc: function (e) {
                    ...
                    if (
                         ...
                         for (
                              ...
                              (p =
                                   (m = (h = i[t]).layoutRect()).maxFlexSize ||
                                   m[R]),
                                   'center' === a
                                        ? (y[M] = Math.round(
                                               r[N] / 2 - m[P] / 2,
          ...
          wi = function (e, t) {
               return (
                    ...
                    qn(r)
                         ? N.none()
                         : N.from(r.querySelector(n)).map(gn.fromDom)
               );
               var n, i, r;
          },
          _i = function (e, t) {
               ...
               return (
                    e.items().each(function (e) {
                         e.menu && e.visible(0 < Oi(n, e.menu)),
                              !e.menu &&
                                   e.settings.menu &&
                                   e.visible(0 < Di(n, e.settings.menu));
          ...
          Zi = Nt.extend({
               ...
               bindStates: function () {
                    ...
                    return (
                         t.state.on('change:text', function (e) {
                              (t.getEl('body').firstChild.data = t.encode(
                                   e.value,
                              )),
                                   t.state.get('rendered') &&
                                        t.updateLayoutRect();
          ...
          nr = jt.extend({
               ...
               showMenu: function (e) {
                    ...
                    n.menu ||
                         ...
                         t.renderTo
                              ...
                              : (n.menu = v.create(t).parent(n).renderTo()),
                         n.fire('createmenu'),
                         n.menu.reflow(),
               ...
               renderHtml: function () {
                    ...
                    return (
                         ...
                         t.aria(
                              'role',
                              t.parent() instanceof tr ? 'menuitem' : 'button',
                         ),
                         '<div id="' +
                              n +
                              '" class="' +
                    ...
                    if (
                         ...
                         (t = n.menu)
                              ...
                              : ((t = e.menu).length
                                ...
                                (t = n.menu =
                                     v.create(t).parent(n).renderTo()).reflow(),
     ...
     var hr = Nt.extend({
          ...
          gr = nr.extend({
               ...
               activeMenu: function (e) {
                    ye(this.getEl().lastChild).toggleClass(
          ...
          br = Nt.extend({
               ...
               repaint: function () {
                    ...
                    return (
                         ...
                         t.w !== r.w &&
                              ((e.width = t.w - i + 'px'), (r.w = t.w)),
                         t.h !== r.h &&
                              ((e.height = t.h - s + 'px'), (r.h = t.h)),
