(function () {
     var inlite = (function (domGlobals) {
          ...
          var isObject = function (predicate) {
               return function (value) {
                    return (
                         !isNull(value) && !isArray(value) && predicate(value)
                    );
               };
          };
          ...
          var bindContextualToolbarsEvents = function (editor, panel) {
               ...
               editor.on(
                    'nodeChange mouseup',
                    throttledTogglePanelWhenNotInForm,
               );
          ...
          var proto$1 = {
               ...
               init: function (settings) {
                    ...
                    self.settings = settings = global$4.extend(
                         {},
                         self.Defaults,
                         settings,
                    );
               ...
               if (nativeEvents) {
                    ...
                    for (name in nativeEvents) {
                         ...
                         if (name === 'mouseenter' || name === 'mouseleave') {
                              ...
                              global$7(eventRootCtrl.getEl()).on(
                                   name,
                                   delegate,
                              );
               ...
               function restoreEndPoint(start) {
                    ...
                    function nodeIndex(container) {
                         ...
                         while (node) {
                              ...
                              if (
                                   node.nodeType !== 1 ||
                                   node.getAttribute('data-mce-type') !==
                                        'bookmark'
                              ) {
                                   idx++;
                              }
          ...
          var create$3 = function () {
               ...
               var repositionPanelAt = function (
                    panel,
                    id,
                    editor,
                    targetRect,
               ...
               var showForm = function (editor, id) {
                    if (panel) {
                         ...
                         userConstainHandler =
                              Settings.getPositionHandler(editor);
                         contentAreaRect = Measure.getContentAreaRect(editor);
                         panelRect = global$2.DOM.getRect(panel.getEl());
                         result = Layout.calc(
                              currentRect,
          ...
          var TabPanel = Panel.extend({
               ...
               activateTab: function (idx) {
                    ...
                    global$7(activeTabElm).addClass(
                         this.classPrefix + 'active',
                    );
