          ...
          props: function (props, attachment) {
               ...
               if ('image' === props.type) {
                    props = _.defaults(props || {}, {
                         align:
                              defaultProps.align ||
                              getUserSetting('align', 'none'),
                         size:
                              defaultProps.size ||
                              getUserSetting('imgsize', 'medium'),
                         url: '',
                         classes: [],
                    });
               }
               ...
               if ('image' === attachment.type) {
                    ...
                    _.extend(
                         props,
                         _.pick(attachment, 'align', 'caption', 'alt'),
                         {
                              width: size.width,
                              height: size.height,
                              src: size.url,
                    ...
                    _.extend(
                         props,
                         _.pick(attachment, 'title', 'type', 'icon', 'mime'),
                    );
                    // Format properties for non-images.
               } else {
                    props.title = props.title || attachment.filename;
                    props.rel =
                         props.rel || 'attachment wp-att-' + attachment.id;
               }
          ...
          return _.extend(
               /** @lends wp.media.collection.prototype */ {
                    ...
                    attachments: function (shortcode) {
                         ...
                         if (
                              !attrs.orderby ||
                              /^menu_order(?: ID)?$/i.test(attrs.orderby)
                         ) {
                    ...
                    shortcode: function (attachments) {
                         ...
                         clone = new wp.media.model.Attachments(
                              attachments.models,
                              {
                                   props: props,
                              },
     ...
     wp.media.editor = {
          ...
          add: function (id, options) {
               ...
               workflow.state('gallery-edit').on(
                    ...
                    function (selection) {
                          ...
                          */
                         this.insert(
                              wp.media.gallery.shortcode(selection).string(),
                         );
                    },
                    this,
               );
               ...
               workflow.state('playlist-edit').on(
                    ...
                    function (selection) {
                          ...
                          */
                         this.insert(
                              wp.media.playlist.shortcode(selection).string(),
                         );
                    },
                    this,
               );
          ...
          open: function (id, options) {
               ...
               if (
                    !workflow ||
                    (workflow.options &&
                         options.state !== workflow.options.state)
               ) {
               ...
               $(document.body).on(
                    ...
                    function (event) {
                         ...
                         if (elem.hasClass('gallery')) {
                              ...
                              options.title =
                                   wp.media.view.l10n.createGalleryTitle;
                         }
