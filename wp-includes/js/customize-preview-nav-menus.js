     ...
     if (api.selectiveRefresh) {
          ...
          self.NavMenuInstancePartial = api.selectiveRefresh.Partial.extend(
               /** @lends wp.customize.navMenusPreview.NavMenuInstancePartial.prototype */ {
                    ...
                    initialize: function (id, options) {
                         ...
                         options.params = _.extend(
                              {
                                   selector:
                                        ...
                                        '"]',
                                   navMenuArgs:
                                        options.constructingContainerContext ||
                                        {},
                         ...
                         if (
                              partial.params.navMenuArgs.args_hmac !== argsHmac
                         ) {
                    ...
                    isRelatedSetting: function (setting, newValue, oldValue) {
                          ...
                          */
                         isNavMenuItemSetting = /^nav_menu_item\[/.test(
                              setting.id,
                         );
                         if (
                              isNavMenuItemSetting &&
                         ...
                         return (
                              ...
                              (isNavMenuItemSetting &&
                                   ((newValue &&
                                        newValue.nav_menu_term_id ===
                                             navMenuId) ||
                                        (oldValue &&
                                             oldValue.nav_menu_term_id ===
                                                  navMenuId)))
                         );
                    },
          ...
          self.bindSettingListener = function (setting, options) {
               ...
               if (matches) {
                    ...
                    if (options.fire) {
                         this.onChangeNavMenuSetting.call(
                              setting,
                              setting(),
                              false,
                         );
               ...
               if (matches) {
                    ...
                    if (options.fire) {
                         this.onChangeNavMenuItemSetting.call(
                              setting,
                              setting(),
                              false,
                         );
               ...
               if (matches) {
                    ...
                    if (options.fire) {
                         this.onChangeNavMenuLocationsSetting.call(
                              setting,
                              setting(),
                              false,
                         );
          ...
          self.onChangeNavMenuSetting = function () {
               ...
               api.each(function (otherSetting) {
                    ...
                    if (setting._navMenuId === otherSetting()) {
                         self.handleUnplacedNavMenuInstances({
                              theme_location:
                                   otherSetting._navMenuThemeLocation,
                         });
                    }
               });
          };
          ...
          self.onChangeNavMenuItemSetting = function (newItem, oldItem) {
               var item = newItem || oldItem,
                    navMenuSetting;
               navMenuSetting = api(
                    'nav_menu[' + String(item.nav_menu_term_id) + ']',
               );
               if (navMenuSetting) {
