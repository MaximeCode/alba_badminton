...
!(function (n, r) {
     ...
     function l(u, o) {
          return (
               ...
               function () {
                    for (
                         var n = Math.max(arguments.length - o, 0),
                              r = Array(n),
                              t = 0;
                         t < n;
                         t++
     ...
     var M = l(function (u, o) {
               function i() {
                    for (
                         var n = 0, r = o.length, t = Array(r), e = 0;
                         e < r;
                         e++
                    )
     ...
     function Dr(n) {
          for (
               var r = (n && gr(n, g).length) || 0, t = Array(r), e = 0;
               e < r;
               e++
          )
               t[e] = dr(n, e);
     ...
     N(
          ...
          N(['concat', 'join', 'slice'], function (n) {
               ...
               m.prototype[n] = function () {
                    ...
                    return Fr(
                         this,
                         (n = null != n ? r.apply(n, arguments) : n),
                    );
               };
          });
     n = Vr({
          ...
          template: function (o, n, r) {
               ...
               if (
                    ...
                    if (!Cn.test(r))
                         throw new Error(
                              'variable is not a bare identifier: ' + r,
                         );
               } else (a = 'with(obj||{}){\n' + a + '}\n'), (r = 'obj');
               a =
          ...
          intersection: function (n) {
               for (
                    var r = [], t = arguments.length, e = 0, u = g(n);
                    e < u;
                    e++
               ) {
                    var o = n[e];
