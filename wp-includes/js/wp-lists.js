...
(function ($) {
     ...
     wpList = {
          ...
          ajaxAdd: function (element, settings) {
               ...
               formData =
                    typeof formValues.fieldSerialize === 'function'
          ...
          ajaxDim: function (element, settings) {
               ...
               settings.dimAddColor = data[4]
                    ? '#' + data[4]
                    : settings.dimAddColor;
               settings.dimDelColor = data[5]
                    ? '#' + data[5]
               ...
               settings.success = function (response) {
                    ...
                    if (
                         'undefined' !==
                         typeof parsedResponse.responses[0].supplemental
                              .comment_link
                    ) {
                         ...
                         if (
                              '' !==
                              parsedResponse.responses[0].supplemental
                                   .comment_link
                         ) {
                              $submittedOn.html(
                                   $('<a></a>')
          ...
          add: function (element, settings) {
               ...
               if (settings.alt) {
                    $element.toggleClass(
                         settings.alt,
                         ($list.children(':visible').index($element[0]) +
                              settings.altOffset) %
                              2,
                    );
               }
