     ...
     /******/ var __webpack_modules__ = {
               ...
               CollectionAdd = Library.extend(
                    /** @lends wp.media.controller.CollectionAdd.prototype */ {
                         ...
                         initialize: function () {
                              ...
                              Library.prototype.initialize.apply(
                                   this,
                                   arguments,
                              );
                         },
                         ...
                         activate: function () {
                              ...
                              library.validator = function (attachment) {
                                   return (
                                        ...
                                        Selection.prototype.validator.apply(
                                             this,
                                             arguments,
                                        )
                                   );
               ...
               CollectionEdit = Library.extend(
                    /** @lends wp.media.controller.CollectionEdit.prototype */ {
                         ...
                         deactivate: function () {
                              ...
                              Library.prototype.deactivate.apply(
                                   this,
                                   arguments,
                              );
                         },
               ...
               Cropper = wp.media.controller.State.extend(
                    /** @lends wp.media.controller.Cropper.prototype */ {
                         ...
                         createCropToolbar: function () {
                              ...
                              this.frame.toolbar.set(
                                   new wp.media.view.Toolbar(toolbarOptions),
                              );
                         },
                    ...
                    /** @lends wp.media.controller.CustomizeImageCropper.prototype */ {
                         ...
                         doCrop: function (attachment) {
                              ...
                              if (
                                   ...
                                   cropDetails.dst_width = control.params
                                        .flex_width
                                        ? control.params.height * ratio
                                        : control.params.width;
                                   cropDetails.dst_height = control.params
                                        .flex_height
                    ...
                    /** @lends wp.media.controller.Embed.prototype */ {
                         ...
                         scan: function () {
                              ...
                              if (attributes.scanners.length) {
                                   scanners = attributes.scanners =
                                        $.when.apply($, attributes.scanners);
               ...
               GalleryEdit = Library.extend(
                    /** @lends wp.media.controller.GalleryEdit.prototype */ {
                         ...
                         gallerySettings: function (browser) {
                              ...
                              library.gallery =
                                   library.gallery || new Backbone.Model();
                    ...
                    /** @lends wp.media.controller.Library.prototype */ {
                         ...
                         isImageAttachment: function (attachment) {
                              ...
                              if (attachment.get('uploading')) {
                                   return /\.(jpe?g|png|gif|webp|avif)$/i.test(
          ...
          /***/ 9875: /***/ (module) => {
               ...
               var Region = function (options) {
                    _.extend(
                         this,
                         _.pick(options || {}, 'id', 'view', 'selector'),
                    );
               };
          ...
          /***/ 6172: /***/ (module) => {
               ...
               SiteIconCropper = Controller.Cropper.extend(
                    /** @lends wp.media.controller.SiteIconCropper.prototype */ {
                         ...
                         createCropContent: function () {
                              this.cropperView =
                                   new wp.media.view.SiteIconCropper({
                                        controller: this,
                                        attachment:
                                             this.get('selection').first(),
                                   });
                              this.cropperView.on(
                                   'image-loaded',
                                   this.createCropToolbar,
          ...
          /***/ 5694: /***/ (module) => {
               ...
               var State = Backbone.Model.extend(
                    /** @lends wp.media.controller.State.prototype */ {
                          ...
                          */
                         _title: function () {
                              this.frame.title.render(
                                   this.get('titleMode') || 'default',
                              );
                         },
               ...
               AttachmentCompat = View.extend(
                    /** @lends wp.media.view.AttachmentCompat.prototype */ {
                         ...
                         dispose: function () {
                               ...
                               */
                              return View.prototype.dispose.apply(
                                   this,
                                   arguments,
                              );
                         },
               ...
               All = wp.media.view.AttachmentFilters.extend(
                    /** @lends wp.media.view.AttachmentFilters.All.prototype */ {
                         createFilters: function () {
                              ...
                              _.each(
                                   wp.media.view.settings.mimeTypes || {},
                                   function (text, key) {
                                        filters[key] = {
                                             text: text,
                                             props: {
          ...
          /***/ 4075: /***/ (module) => {
               ...
               Attachment = View.extend(
                    /** @lends wp.media.view.Attachment.prototype */ {
                         ...
                         render: function () {
                              ...
                              options.describe = this.controller
                                   .state()
                                   .get('describe');
                         ...
                         updateSetting: function (event) {
                              var $setting = $(event.target).closest(
                                        '[data-setting]',
                                   ),
                                   setting,
                                   value;
                         ...
                         save: function () {
                              var view = this,
                                   save = (this._save = this._save || {
                                        status: 'ready',
                                   }),
                                   request = this.model.save.apply(
                                        this.model,
                                        arguments,
                                   ),
                         ...
                         updateSave: function (status) {
                              var save = (this._save = this._save || {
                                   status: 'ready',
                              });
                         ...
                         checkClickHandler: function (event) {
                              ...
                              event.stopPropagation();
                              if (
                                   selection.where({ id: this.model.get('id') })
                                        .length
                              ) {
               ...
               _.each(
                    ...
                    function (method, setting) {
                          ...
                          * @return {wp.media.view.Attachment} Returns itself to allow chaining.
                          */
                         Attachment.prototype[method] = function (
                              model,
                              value,
                         ) {
                              var $setting = this.$(
               ...
               Details = Attachment.extend(
                    /** @lends wp.media.view.Attachment.Details.prototype */ {
                         ...
                         initialize: function () {
                              ...
                              Attachment.prototype.initialize.apply(
                                   this,
                                   arguments,
                              );
                         ...
                         moveFocus: function () {
                              ...
                              if (
                                   ...
                                   this.controller.uploader.$browser
                              ) {
                                   this.controller.uploader.$browser.trigger(
                                        'focus',
                                   );
                                   return;
                              }
                         ...
                         editAttachment: function (event) {
                              var editState =
                                   this.controller.states.get('edit-image');
                         ...
                         render: function () {
                              Attachment.prototype.render.apply(
                                   this,
                                   arguments,
                              );
                              ...
                              this.$('audio, video').each(function (i, elem) {
                                   var el =
                                        wp.media.view.MediaDetails.prepareSrc(
                                             elem,
                                        );
                                   new window.MediaElementPlayer(
                                        el,
                    ...
                    /** @lends wp.media.view.Attachments.prototype */ {
                         ...
                         initialize: function () {
                              ...
                              this.collection.on(
                                   ...
                                   function (attachment) {
                                        this.views.add(
                                             this.createAttachmentView(
                                                  attachment,
                                             ),
                                             {
                                                  at: this.collection.indexOf(
                                                       attachment,
                                                  ),
                                             },
                                        );
                              ...
                              this.collection.on(
                                   ...
                                   function (attachment) {
                                        var view =
                                             this._viewsByCid[attachment.cid];
                              ...
                              if (this.options.infiniteScrolling) {
                                   ...
                                   this.scroll = _.chain(this.scroll)
                                        .bind(this)
                                        .throttle(
                                             this.options.refreshSensitivity,
                                        )
                                        .value();

                                   this.options.scrollElement =
                                        this.options.scrollElement || this.el;
                                   $(this.options.scrollElement).on(
                                        'scroll',
                                        this.scroll,
                                   );
                              }
                    ...
                    /** @lends wp.media.view.AttachmentsBrowser.prototype */ {
                         ...
                         announceSearchResults: _.debounce(function () {
                              ...
                              if (
                                   ...
                                   if (this.collection.hasMore()) {
                                        wp.a11y.speak(
                                             mediaFoundHasMoreResultsMessage.replace(
                                                  '%d',
                                                  count,
                                             ),
                                        );
                                   ...
                                   wp.a11y.speak(
                                        l10n.mediaFound.replace('%d', count),
                                   );
                              }
                         }, 200),
                         ...
                         createToolbar: function () {
                              ...
                              if (showFilterByType) {
                                   ...
                                   if ('uploaded' === this.options.filters) {
                                        ...
                                        Filters =
                                             new wp.media.view.AttachmentFilters.All(
                                                  {
                                                       controller:
                                                            this.controller,
                                                       model: this.collection
                         ...
                         updateContent: function () {
                              ...
                              if (!this.collection.length) {
                                   ...
                                   this.dfd = this.collection
                                        .more()
                                        .done(function () {
                                             if (!view.collection.length) {
                                                  noItemsView.$el.removeClass(
                                                       'hidden',
                                                  );
                                             } else {
                                                  noItemsView.$el.addClass(
                                                       'hidden',
                                                  );
                                             }
                         ...
                         createAttachments: function () {
                              ...
                              if (this.controller.isModeActive('grid')) {
                                   ...
                                   this.attachmentsNoResults.$el.addClass(
                                        'hidden no-media',
                                   );
                         ...
                         createLoadMoreView: function () {
                              ...
                              this.loadMoreSpinner =
                                   new wp.media.view.Spinner();

                              this.loadMoreJumpToFirst =
                         ...
                         updateLoadMoreView: _.debounce(function () {
                               ...
                               */
                              if (this.collection.hasMore()) {
                                   this.loadMoreButton.$el.removeClass(
                                        'hidden',
                                   );
                              }
                              ...
                              if (
                                   ...
                                   this.loadMoreJumpToFirst.$el.trigger(
                                        'focus',
                                   );
                              }
                         }, 10),
                         ...
                         createAttachmentsHeading: function () {
                              this.attachmentsHeading =
                                   new wp.media.view.Heading({
                                        text: l10n.attachmentsList,
                                        level: 'h2',
                                        className:
                                             'media-views-heading screen-reader-text',
                                   });
                              ...
                              if (this.options.display) {
                                   sidebar.set(
                                        ...
                                        new wp.media.view.Settings.AttachmentDisplay(
                                             {
                                                  controller: this.controller,
                                                  model: this.model.display(
                                                       single,
                                                  ),
                                                  attachment: single,
                                                  priority: 160,
                                                  userSettings: this.model.get(
                                                       'displayUserSettings',
                                                  ),
                                             },
                                        ),
               ...
               Selection = Attachments.extend(
                    /** @lends wp.media.view.Attachments.Selection.prototype */ {
                         ...
                         initialize: function () {
                              ...
                              // Call 'initialize' directly on the parent class.
                              return Attachments.prototype.initialize.apply(
                                   this,
                                   arguments,
                              );
                         },
          ...
          /***/ 168: /***/ (module) => {
               ...
               ButtonGroup = wp.media.View.extend(
                    /** @lends wp.media.view.ButtonGroup.prototype */ {
                         tagName: 'div',
                         className:
                              'button-group button-large media-button-group',
                              ...
                              this.buttons = _.map(
                                   ...
                                   function (button) {
                                        if (button instanceof Backbone.View) {
                                             ...
                                             return new wp.media.view.Button(
                                                  button,
                                             ).render();
                                        }
                                   },
                         ...
                         render: function () {
                              this.$el.html(
                                   $(_.pluck(this.buttons, 'el')).detach(),
                              );
                              return this;
                         },
                    },
               ...
               var Button = wp.media.View.extend(
                    /** @lends wp.media.view.Button.prototype */ {
                         ...
                         render: function () {
                              ...
                              classes = _.uniq(
                                   classes.concat(this.options.classes),
                              );
               ...
               Cropper = View.extend(
                    /** @lends wp.media.view.Cropper.prototype */ {
                         ...
                         onImageLoad: function () {
                              var imgOptions =
                                        this.controller.get('imgSelectOptions'),
                                   imgSelect;
                              ...
                              imgOptions = _.extend(imgOptions, {
                                   ...
                                   onInit: function () {
                                        // Store the set ratio.
                                        var setRatio =
                                             imgSelect.getOptions().aspectRatio;
                              ...
                              imgSelect = this.controller.imgSelect =
                                   this.$image.imgAreaSelect(imgOptions);
                         },
                         onError: function () {
                              var filename =
                                   this.options.attachment.get('filename');
                              ...
                              this.views.add(
                                   ...
                                   new wp.media.view.UploaderStatusError({
                                        ...
                                        message: window._wpMediaViewsL10n
                                             .cropError,
                                   }),
                                   { at: 0 },
                              );
               ...
               EmbedImage = AttachmentDisplay.extend(
                    /** @lends wp.media.view.EmbedImage.prototype */ {
                         ...
                         initialize: function () {
                               ...
                               */
                              AttachmentDisplay.prototype.initialize.apply(
                                   this,
                                   arguments,
                              );
                              this.listenTo(
          ...
          /***/ 7327: /***/ (module) => {
               ...
               EmbedUrl = View.extend(
                    /** @lends wp.media.view.EmbedUrl.prototype */ {
                         ...
                         initialize: function () {
                              this.$input = $(
                                   '<input id="embed-url-field" type="url" />',
                              )
                    ...
                    /** @lends wp.media.view.FocusManager.prototype */ {
                         ...
                         initialize: function (options) {
                              ...
                              this.tabsAutomaticActivation =
                                   options.tabsAutomaticActivation || false;
                         },
                          ...
                          * @return {void}
                          */
                         setAriaHiddenOnBodyChildren: function (
                              visibleElement,
                         ) {
                              var bodyChildren,
                                   self = this;
          ...
          /***/ 1061: /***/ (module) => {
                    ...
                    /** @lends wp.media.view.Frame.prototype */ {
                         ...
                         _createRegions: function () {
                              ...
                              _.each(
                                   ...
                                   function (region) {
                                        this[region] =
                                             new wp.media.controller.Region({
                                                  view: this,
                                                  id: region,
                                                  selector:
                                                       '.media-frame-' + region,
                         ...
                         deactivateMode: function (mode) {
                              ...
                              this.activeModes.remove(
                                   this.activeModes.where({ id: mode }),
                              );
                         ...
                         isModeActive: function (mode) {
                              return Boolean(
                                   this.activeModes.where({ id: mode }).length,
                              );
                         },
                    },
               );
               ...
               _.extend(
                    Frame.prototype,
                    wp.media.controller.StateMachine.prototype,
               );
          ...
          /***/ 5424: /***/ (module) => {
               ...
               ImageDetails = Select.extend(
                    /** @lends wp.media.view.MediaFrame.ImageDetails.prototype */ {
                         ...
                         initialize: function (options) {
                              this.image = new wp.media.model.PostImage(
                                   options.metadata,
                              );
                              ...
                              Select.prototype.initialize.apply(
                                   this,
                                   arguments,
                              );
                         },
                         ...
                         bindHandlers: function () {
                              Select.prototype.bindHandlers.apply(
                                   this,
                                   arguments,
                              );
                              this.on(
                                   'menu:create:image-details',
                                   this.createMenu,
                                   this,
                              );
                              this.on(
               ...
               Post = Select.extend(
                    /** @lends wp.media.view.MediaFrame.Post.prototype */ {
                         initialize: function () {
                              this.counts = {
                                   audio: {
                                        count: wp.media.view.settings
                                             .attachmentCounts.audio,
                                        state: 'playlist',
                                   },
                                   video: {
                                        count: wp.media.view.settings
                                             .attachmentCounts.video,
                         ...
                         bindHandlers: function () {
                              ...
                              this.on(
                                   'menu:create:video-playlist',
                                   this.createMenu,
                                   this,
                              );
                              this.on(
                                   'toolbar:create:main-insert',
                                   this.createToolbar,
                                   this,
                              );
                              this.on(
          ...
          /***/ 455: /***/ (module) => {
               ...
               Select = MediaFrame.extend(
                    /** @lends wp.media.view.MediaFrame.Select.prototype */ {
                         initialize: function () {
                              // Call 'initialize' directly on the parent class.
                              MediaFrame.prototype.initialize.apply(
                                   this,
                                   arguments,
                              );
                         ...
                         browseContent: function (contentRegion) {
                              ...
                              // Browse our library of attachments.
                              contentRegion.view =
                                   new wp.media.view.AttachmentsBrowser({
                                        controller: this,
                                        ...
                                        idealColumnWidth:
                                             state.get('idealColumnWidth'),
                                        suggestedWidth:
                                             state.get('suggestedWidth'),
                                        suggestedHeight:
                                             state.get('suggestedHeight'),

                                        AttachmentView:
                                             state.get('AttachmentView'),
                                   });
                         },
               ...
               ImageDetails = AttachmentDisplay.extend(
                    /** @lends wp.media.view.ImageDetails.prototype */ {
                         ...
                         events: _.defaults(
                              ...
                              {
                                   'click .edit-attachment': 'editAttachment',
                                   'click .replace-attachment':
                                        'replaceAttachment',
                                   'click .advanced-toggle': 'onToggleAdvanced',
                                   'change [data-setting="customWidth"]':
                                        'onCustomSize',
                                   'change [data-setting="customHeight"]':
                                        'onCustomSize',
                                   'keyup [data-setting="customWidth"]':
                                        'onCustomSize',
                                   'keyup [data-setting="customHeight"]':
                                        'onCustomSize',
                              },
                         ),
                         initialize: function () {
                         ...
                         render: function () {
                              ...
                              if (
                                   ...
                                   'pending' === this.model.dfd.state()
                              ) {
                                   this.model.dfd
                                        .done(
                                             _.bind(function () {
                                                  AttachmentDisplay.prototype.render.apply(
                                                       this,
                                                       args,
                                                  );
                                                  this.postRender();
                         ...
                         postRender: function () {
                              ...
                              this.toggleLinkSettings();
                              if (
                                   window.getUserSetting('advImgDetails') ===
                                   'show'
                              ) {
                         ...
                         toggleLinkSettings: function () {
                              if (this.model.get('link') === 'none') {
                                   ...
                                   this.$('.link-settings').removeClass(
                                        'hidden',
                                   );
                              }
                         },
                         ...
                         onCustomSize: function (event) {
                              ...
                              if (dimension === 'customWidth') {
                                   value = Math.round(
                                        (1 / this.model.get('aspectRatio')) *
                                             num,
                                   );
                                   this.model.set('customHeight', value, {
                                        silent: true,
                                   });
                                   this.$('[data-setting="customHeight"]').val(
                                        value,
                                   );
                              } else {
                                   value = Math.round(
                                        this.model.get('aspectRatio') * num,
                                   );
                                   this.model.set('customWidth', value, {
                                        silent: true,
                                   });
                                   this.$('[data-setting="customWidth"]').val(
                                        value,
                                   );
                              }
                         },
                         ...
                         toggleAdvanced: function (show) {
                              var $advanced =
                                        this.$el.find('.advanced-section'),
                                   mode;

                              if (
                                   $advanced.hasClass('advanced-visible') ||
                                   show === false
                              ) {
          ...
          /***/ 2836: /***/ (module) => {
               ...
               MediaFrame = Frame.extend(
                    /** @lends wp.media.view.MediaFrame.prototype */ {
                         ...
                         initialize: function () {
                              ...
                              if (
                                   wp.Uploader.limitExceeded ||
                                   !wp.Uploader.browser.supported
                              ) {
                              ...
                              if (this.options.uploader) {
                                   this.uploader =
                                        new wp.media.view.UploaderWindow({
                                             controller: this,
                                             uploader: {
                                                  dropzone: this.modal
                                                       ? this.modal.$el
                              ...
                              this.on(
                                   'attach',
                                   _.bind(this.views.ready, this.views),
                                   this,
                              );
                         ...
                         setMenuTabPanelAriaAttributes: function () {
                              var stateId = this.state().get('id'),
                                   tabPanelEl = this.$el.find(
                                        '.media-frame-tab-panel',
                                   ),
                                   ariaLabelledby;

                              tabPanelEl.removeAttr(
                         ...
                         render: function () {
                               ...
                               */
                              return Frame.prototype.render.apply(
                                   this,
                                   arguments,
                              );
                         },
               ...
               _.each(
                    ['open', 'close', 'attach', 'detach', 'escape'],
                    function (method) {
                         /**
                          * @function open
                          * @memberOf wp.media.view.MediaFrame
               ...
               MenuItem = wp.media.View.extend(
                    /** @lends wp.media.view.MenuItem.prototype */ {
                         ...
                         render: function () {
                              var options = this.options,
                                   menuProperty =
                                        options.state || options.contentMode;
               ...
               Menu = PriorityList.extend(
                    /** @lends wp.media.view.Menu.prototype */ {
                         ...
                         initialize: function () {
                              ...
                              this.focusManager =
                                   new wp.media.view.FocusManager({
                                        el: this.el,
                                        mode: 'tabsNavigation',
                                   });
                         ...
                         ready: function () {
                               ...
                               */
                              PriorityList.prototype.ready.apply(
                                   this,
                                   arguments,
                              );
                              this.visibility();
                         ...
                         unset: function () {
                               ...
                               */
                              PriorityList.prototype.unset.apply(
                                   this,
                                   arguments,
                              );
                              this.visibility();
                         ...
                         visibility: function () {
                              ...
                              if (this === view) {
                                   ...
                                   this.controller.$el.toggleClass(
                                        'hide-' + region,
                                        hide,
                                   );
                              }
               ...
               Modal = wp.media.View.extend(
                    /** @lends wp.media.view.Modal.prototype */ {
                         ...
                         open: function () {
                              ...
                              this.focusManager.setAriaHiddenOnBodyChildren(
                                   $el,
                              );
               ...
               Selection = wp.media.View.extend(
                    /** @lends wp.media.view.Selection.prototype */ {
                         ...
                         initialize: function () {
                               ...
                               */
                              this.attachments =
                                   new wp.media.view.Attachments.Selection({
                                        controller: this.controller,
                                        collection: this.collection,
                    ...
                    /** @lends wp.media.view.Settings.prototype */ {
                         ...
                         update: function (key) {
                              ...
                              if ($setting.is('select')) {
                                   ...
                                   $setting.is('input[type="text"], textarea')
                              ) {
                                   if (!$setting.is(':focus')) {
                                        $setting.val(value);
                                   }
                                   ...
                                   $setting.is('input[type="checkbox"]')
                              ) {
                                   $setting.prop(
                                        'checked',
                                        !!value && 'false' !== value,
               ...
               AttachmentDisplay = Settings.extend(
                    /** @lends wp.media.view.Settings.AttachmentDisplay.prototype */ {
                         ...
                         initialize: function () {
                              ...
                              // Call 'initialize' directly on the parent class.
                              Settings.prototype.initialize.apply(
                                   this,
                                   arguments,
                              );
                              this.listenTo(
          ...
          /***/ 443: /***/ (module) => {
               ...
               SiteIconCropper = View.Cropper.extend(
                    /** @lends wp.media.view.SiteIconCropper.prototype */ {
                         ...
                         ready: function () {
                              View.Cropper.prototype.ready.apply(
                                   this,
                                   arguments,
                              );
                         ...
                         addSidebar: function () {
                              ...
                              this.controller.cropperView.views.add(
                                   this.sidebar,
                              );
                         },
                    },
                    ...
                    /** @lends wp.media.view.SiteIconPreview.prototype */ {
                         ...
                         updatePreview: function (img, coords) {
                              ...
                              $('#preview-app-icon').css({
                                   width:
                                        Math.round(rx * this.imageWidth) + 'px',
                                   height:
                                        Math.round(ry * this.imageHeight) +
                                        'px',
                                   marginLeft:
                                        '-' + Math.round(rx * coords.x1) + 'px',
                                   marginTop:
                                        '-' + Math.round(ry * coords.y1) + 'px',
                              });

                              $('#preview-favicon').css({
                                   width:
                                        Math.round(
                                             preview_rx * this.imageWidth,
                                        ) + 'px',
                                   height:
                                        Math.round(
                                             preview_ry * this.imageHeight,
                                        ) + 'px',
                                   marginLeft:
                                        '-' +
                                        Math.round(preview_rx * coords.x1) +
                                        'px',
                                   marginTop:
                                        '-' +
                                        Math.floor(preview_ry * coords.y1) +
                                        'px',
                              });
                         },
                    },
               ...
               Toolbar = View.extend(
                    /** @lends wp.media.view.Toolbar.prototype */ {
                         ...
                         initialize: function () {
                              ...
                              this.primary.$el.addClass(
                                   'media-toolbar-primary search-form',
                              );
                              this.secondary.$el.addClass(
               ...
               Select = Toolbar.extend(
                    /** @lends wp.media.view.Toolbar.Select.prototype */ {
                         initialize: function () {
                              ...
                              // Call 'initialize' directly on the parent class.
                              Toolbar.prototype.initialize.apply(
                                   this,
                                   arguments,
                              );
                         },
               ...
               EditorUploader = View.extend(
                    /** @lends wp.media.view.EditorUploader.prototype */ {
                         ...
                         drop: function (event) {
                              ...
                              $wrap = $(event.target).parents(
                                   '.wp-editor-wrap',
                              );
                              if ($wrap.length > 0 && $wrap[0].id) {
                                   window.wpActiveEditor = $wrap[0].id.slice(
                                        3,
                                        -5,
                                   );
                              }
          ...
          /***/ 1753: /***/ (module) => {
               ...
               UploaderInline = View.extend(
                    /** @lends wp.media.view.UploaderInline.prototype */ {
                         ...
                         prepare: function () {
                              var suggestedWidth = this.controller
                                        .state()
                                        .get('suggestedWidth'),
                                   suggestedHeight = this.controller
                                        .state()
                                        .get('suggestedHeight'),
                                   data = {};
                         ...
                         remove: function () {
                               ...
                               */
                              var result = View.prototype.remove.apply(
                                   this,
                                   arguments,
                              );
               ...
               UploaderStatus = View.extend(
                    /** @lends wp.media.view.UploaderStatus.prototype */ {
                         ...
                         visibility: function () {
                              ...
                              this.$el.toggle(
                                   !!this.queue.length || !!this.errors.length,
                              );
                         },
                         ...
                         error: function (error) {
                              ...
                              this.views.add('.upload-errors', statusError, {
                                   at: 0,
                              });
                              _.delay(function () {
               ...
               UploaderWindow = wp.media.View.extend(
                    /** @lends wp.media.view.UploaderWindow.prototype */ {
                         ...
                         ready: function () {
                              ...
                              if (postId) {
                                   this.options.uploader.params.post_id =
                                        postId;
                              }
               ...
               var View = wp.Backbone.View.extend(
                    /** @lends wp.media.View.prototype */ {
                         ...
                         remove: function () {
                               ...
                               * call 'remove' directly on the parent class
                               */
                              return wp.Backbone.View.prototype.remove.apply(
                                   this,
                                   arguments,
                              );
                         },
     ...
     (() => {
          ...
          media.transition = function (selector, sensitivity) {
               ...
               if ($.support.transition) {
                    ...
                    selector
                         .first()
                         .one($.support.transition.end, deferred.resolve);
