...
window.wpAjax = jQuery.extend(
     {
          unserialize: function (s) {
               ...
               for (i in pp) {
                    if (
                         typeof pp.hasOwnProperty === 'function' &&
                         !pp.hasOwnProperty(i)
                    ) {
                         continue;
                    }
          ...
          parseAjaxResponse: function (x, r, e) {
               ...
               if (
                    x &&
                    typeof x === 'object' &&
                    x.getElementsByTagName('wp_ajax')
               ) {
                    parsed.responses = [];
                    parsed.errors = false;
                         ...
                         if (
                              !jQuery('supplemental', child)
                                   ...
                                   .each(function () {
                                        ...
                                        response.supplemental[this.nodeName] =
                                             jQuery(this).text();
                                   }).length
                         ) {
                    ...
                    if (err.length) {
                         ...
                         re.html(
                              '<div class="notice notice-success is-dismissible" role="alert"><p>' +
                                   noticeMessage +
                                   '</p></div>',
                         );
