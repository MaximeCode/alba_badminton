...
!(function (n) {
     ...
     function x(t, e, i) {
          ...
          for (
               var n = Array(t.length - i), s = e.length, r = 0;
               r < n.length;
               r++
          )
               n[r] = t[r + i];
     ...
     var o,
          ...
          m =
               (b.extend(v.prototype, e, {
                    ...
                    hasChanged: function (t) {
                         return null == t
                              ? !b.isEmpty(this.changed)
                              : b.has(this.changed, t);
                    },
                    changedAttributes: function (t) {
                         if (!t)
                              return (
                                   !!this.hasChanged() && b.clone(this.changed)
                              );
                         var e,
                              i,
                              n = this._changing
                    ...
                    save: function (t, e, i) {
                         null == t || 'object' == typeof t
                              ...
                              : ((n = {})[t] = e);
                         var n,
                              s = (i = b.extend({ validate: !0, parse: !0 }, i))
                                   .wait;
                         if (n && !s) {
          ...
          y =
               (b.extend(m.prototype, e, {
                    ...
                    modelId: function (t, e) {
                         return t[
                              e || this.model.prototype.idAttribute || 'id'
                         ];
                    },
                    values: function () {
                         return new E(this, S);
          ...
          T =
               (b.extend(y.prototype, e, {
                    ...
                    remove: function () {
                         return (
                              this._removeElement(), this.stopListening(), this
                         );
                    },
                    ...
                    _ensureElement: function () {
                         ...
                         this.el
                              ...
                              : ((t = b.extend(
                                     {},
                                     b.result(this, 'attributes'),
                                )),
                                this.id && (t.id = b.result(this, 'id')),
                                this.className &&
                                     (t.class = b.result(this, 'className')),
                                this.setElement(
                                     this._createElement(
                    ...
                    M.extend =
                         function (t, e) {
                              ...
                              return (
                                   ...
                                   ((n.prototype.constructor = n).__super__ =
                                        i.prototype),
                                   n
                              );
                         }),
