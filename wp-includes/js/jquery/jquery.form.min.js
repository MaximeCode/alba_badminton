!(function (a) {
     ...
     var d = /\r?\n/g,
          h = {},
          X =
               ((h.fileapi = void 0 !== O('<input type="file">').get(0).files),
               (h.formdata = void 0 !== window.FormData),
               !!O.fn.prop);
     function o(e) {
          var t = e.data;
          e.isDefaultPrevented() ||
               (e.preventDefault(), O(e.target).closest('form').ajaxSubmit(t));
     }
     function i(e) {
          var t = e.target,
               a = O(t);
     ...
     (O.fn.attr2 = function () {
          var e;
          return X &&
               (((e = this.prop.apply(this, arguments)) && e.jquery) ||
                    'string' == typeof e)
               ? e
          ...
          (O.fn.ajaxSubmit = function (F, e, t, a) {
                    ...
                    var E,
                         ...
                         e =
                              ('function' == typeof F
                                   ? (F = { success: F })
                                   : 'string' == typeof F ||
                                       (!1 === F && 0 < arguments.length)
                                     ? ((F = { url: F, data: e, dataType: t }),
                                       'function' == typeof a &&
                                            (F.success = a))
                                     : void 0 === F && (F = {}),
                              (E = F.method || F.type || this.attr2('method')),
                              (t =
                                   (t =
                                        (t =
                                             'string' ==
                                             typeof (e =
                                                  F.url || this.attr2('action'))
                                                  ? O.trim(e)
                                                  : '') ||
                              ...
                              {});
                    if (
                         (this.trigger('form-pre-serialize', [this, F, e]),
                         e.veto)
                    )
                         C(
                         ...
                         var t = F.traditional,
                              M =
                                   (void 0 === t &&
                                        (t = O.ajaxSettings.traditional),
                                   []),
                              r = this.formToArray(F.semantic, M, F.filtering);
                         if (
                              (F.data &&
                                   ((a = O.isFunction(F.data)
                                        ? F.data(r)
                                        : F.data),
                                   (F.extraData = a),
                                   (l = O.param(a, t))),
                              F.beforeSubmit &&
                                   !1 === F.beforeSubmit(r, this, F))
                         )
                              C(
                              ...
                              F.resetForm &&
                                   ...
                                   !F.dataType && F.target
                                        ? ((o = F.success || function () {}),
                                          s.push(function (e, t, a) {
                                               var r = arguments,
                                                    n = F.replaceTarget
                                                         ? 'replaceWith'
                                                         : 'html';
                                   ...
                                   (F.success = function (e, t, a) {
                                        for (
                                             ...
                                             s[n].apply(r, [e, t, a || L, L]);
                                   }),
                                   F.error &&
                                        ((n = F.error),
                                        (F.error = function (e, t, a) {
                                             var r = F.context || this;
                                             n.apply(r, [e, t, a, L]);
                                        })),
                                   F.complete &&
                                   ...
                                   (F.iframe || ((e || l) && !a))
                                        ...
                                        : (c =
                                               (e || l) && a
                                                    ...
                                                    : O.ajax(F)),
                                   L.removeData('jqxhr').data('jqxhr', c);
               ...
               function f(e) {
                    ...
                    (l = O.extend(!0, {}, O.ajaxSettings, F)).context =
                         l.context || l;
                    var v,
                         x,
                         r,
                    ...
                    return (
                         l.iframeTarget
                              ? (r = (f = O(l.iframeTarget, c)).attr2('name'))
                                   ? (s = r)
                                   : f.attr2('name', s)
                              : (f = O(
                                     '<iframe name="' +
                         ...
                         (m = {
                              ...
                              abort: function (e) {
                                   ...
                                   f.attr('src', l.iframeSrc),
                                        (m.error = t),
                                        l.error &&
                                             l.error.call(l.context, m, t, e),
                                        u &&
                                        ...
                                        l.complete &&
                                             l.complete.call(l.context, m, t);
                              },
                         }),
                         (u = l.global) &&
                              0 == O.active++ &&
                              O.event.trigger('ajaxStart'),
                         u && O.event.trigger('ajaxSend', [m, l]),
                         l.beforeSend &&
                         !1 === l.beforeSend.call(l.context, m, l)
                              ? (l.global && O.active--, g.reject())
                              : m.aborted
                                ? g.reject()
                                : ((e = o.clk) &&
                                       (r = e.name) &&
                                       ...
                                       (l.extraData[r] = e.value),
                                       'image' === e.type) &&
                                       ((l.extraData[r + '.x'] = o.clk_x),
                                       (l.extraData[r + '.y'] = o.clk_y)),
                                  (v = 1),
                                  (x = 2),
                                  (e = O('meta[name=csrf-token]').attr(
                                       'content',
                                  )),
                                  (r = O('meta[name=csrf-param]').attr(
                                       'content',
                                  )) &&
                                       e &&
                                       ((l.extraData = l.extraData || {}),
                                       (l.extraData[r] = e)),
                                  l.forceSync ? n() : setTimeout(n, 10),
                                  (T = 50),
                                  (w =
                                       O.parseXML ||
                                       function (e, t) {
                    ...
                    function n() {
                         ...
                         try {
                              if (l.extraData)
                                   for (var n in l.extraData)
                                        l.extraData.hasOwnProperty(n) &&
                                             (O.isPlainObject(l.extraData[n]) &&
                                             l.extraData[n].hasOwnProperty(
                                                  'name',
                                             ) &&
                                             l.extraData[n].hasOwnProperty(
                                                  'value',
                              ...
                              o.setAttribute('action', t),
                                   o.setAttribute('enctype', a),
                                   e
                                        ? o.setAttribute('target', e)
                                        : L.removeAttr('target'),
                                   O(r).remove();
                         }
                    }
                    function A(t) {
                         if (!m.aborted && !j)
                              if (
                                   ((b = D(d)) ||
                                        (C('cannot access response document'),
                                        (t = x)),
                                   t === v && m)
                              )
                                   m.abort('timeout'), g.reject(m, 'timeout');
                              else if (t === x && m)
                                   m.abort('server abort'),
                                        g.reject(m, 'error', 'server abort');
                              else if (
                                   (b && b.location.href !== l.iframeSrc) ||
                                   p
                              ) {
                                   d.detachEvent
          ...
          (O.fn.ajaxForm = function (e, t, a, r) {
               ...
               return (
                    ('string' == typeof e ||
                         (!1 === e && 0 < arguments.length)) &&
                         ((e = { url: e, data: t, dataType: a }),
                         'function' == typeof r) &&
                         (e.success = r),
                    ((e = e || {}).delegation =
                         e.delegation && O.isFunction(O.fn.on)),
                    ...
                    if (
                         ...
                         for (
                              var s,
                                   ...
                                   f,
                                   d = 0,
                                   m = (i = O.isFunction(a) ? O.map(i, a) : i)
                                        .length;
                              d < m;
                              d++
                         )
                              if ((f = (l = i[d]).name) && !l.disabled)
                                   if (e && n.clk && 'image' === l.type)
                                        n.clk === l &&
                                             (r.push({
                                                  name: f,
                                                  value: O(l).val(),
                         ...
                         !e &&
                              n.clk &&
                              (f = (a = (o = O(n.clk))[0]).name) &&
                              !a.disabled &&
                              'image' === a.type &&
                              (r.push({ name: f, value: o.val() }),
                              r.push(
                                   { name: f + '.x', value: n.clk_x },
                                   { name: f + '.y', value: n.clk_y },
                              ));
                    }
               }
               return r;
                         ...
                         if (e) {
                              ...
                              if (t && t.constructor === Array)
                                   for (var a = 0, r = t.length; a < r; a++)
                                        o.push({ name: e, value: t[a] });
                              else
                                   null != t &&
                                        o.push({ name: this.name, value: t });
                         }
                    }),
                    O.param(o)
               );
          ...
          (O.fn.fieldValue = function (e) {
               for (var t = [], a = 0, r = this.length; a < r; a++) {
                    ...
                    null == n ||
                         ...
                         (n.constructor === Array ? O.merge(t, n) : t.push(n));
               }
               return t;
          }),
