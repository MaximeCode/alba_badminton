               ...
               if (!r && (V(e), (e = e || T), C)) {
                    if (11 !== p && (u = L.exec(t)))
                         if ((i = u[1])) {
                              ...
                              if (u[2])
                                   return (
                                        k.apply(n, e.getElementsByTagName(t)), n
                                   );
                                   ...
                                   (c = ce.extend(
                                        {
                                             ...
                                             needsContext:
                                                  i &&
                                                  ce.expr.match.needsContext.test(
                                                       i,
                                                  ),
                                             namespace: h.join('.'),
                                        },
