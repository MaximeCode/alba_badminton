          ...
          z.widget('ui.resizable', z.ui.mouse, {
               ...
               _create: function () {
                    ...
                    this._addClass('ui-resizable'),
                         ...
                         this.element[0].nodeName.match(
                              ...
                              (this.element.wrap(
                                   z("<div class='ui-wrapper'></div>").css({
                                        overflow: 'hidden',
               ...
               _setupHandles: function () {
                    ...
                    if (
                         ((this.handles =
                              n.handles ||
                              (z('.ui-resizable-handle', this.element).length
                                   ? {
                                          n: '.ui-resizable-n',
                                          e: '.ui-resizable-e',
                                          s: '.ui-resizable-s',
                         ...
                         for (
                              ...
                              (s =
                                   'ui-resizable-' +
                                   (t = String.prototype.trim.call(e[i]))),
                                   (h = z('<div>')),
                                   this._addClass(
                                        h,
                                   ...
                                   this.element.children(this.handles[t])
                                        .length ||
                                        (this.element.append(h),
                                        (this._addedHandles =
                                             this._addedHandles.add(h)));
                         ...
                         for (i in ((t = t || this.element), this.handles))
                              this.handles[i].constructor === String
                                   ...
                                   : (this.handles[i].jquery ||
                                     ...
                                     ((this.handles[i] = z(this.handles[i])),
                                   ...
                                   this.elementIsWrapper &&
                                        ...
                                        ((s = z(this.handles[i], this.element)),
               ...
               _mouseCapture: function (t) {
                    ...
                    for (i in this.handles)
                         ((e = z(this.handles[i])[0]) !== t.target &&
                              !z.contains(e, t.target)) ||
                              (s = !0);
               ...
               _mouseStart: function (t) {
                    ...
                    return (
                         ...
                         s.containment &&
                              ((i += z(s.containment).scrollLeft() || 0),
               ...
               _mouseStop: function (t) {
                    ...
                    return (
                         this._helper &&
                              ((e =
                                   (i =
                                        (e = this._proportionallyResizeElements)
                                             .length &&
                              ...
                              (e =
                                   parseFloat(n.element.css('left')) +
                                        (n.position.left -
                                             n.originalPosition.left) || null),
                              (s =
                                   parseFloat(n.element.css('top')) +
                                        (n.position.top -
                                             n.originalPosition.top) || null),
                              h.animate ||
                                   this.element.css(
                                        z.extend(i, { top: s, left: e }),
                                   ),
               ...
               _updateVirtualBoundaries: function (t) {
                    var i,
                         ...
                         h = this.options,
                         h = {
                              minWidth: this._isNumber(h.minWidth)
                                   ? h.minWidth
                                   : 0,
                              maxWidth: this._isNumber(h.maxWidth)
                                   ? h.maxWidth
                                   : 1 / 0,
                              minHeight: this._isNumber(h.minHeight)
                                   ? h.minHeight
                                   : 0,
                              maxHeight: this._isNumber(h.maxHeight)
                                   ? h.maxHeight
                                   : 1 / 0,
                         };
                    (this._aspectRatio || t) &&
                         ((t = h.minHeight * this.aspectRatio),
                         ...
                         for (
                              ...
                              (t = this._proportionallyResizeElements[i]),
                                   ...
                                   t.css({
                                        height:
                                             e.height() -
                                                  this.outerDimensions.height ||
                                             0,
                                        width:
                                             e.width() -
                                                  this.outerDimensions.width ||
                                             0,
                                   });
               },
          ...
          z.ui.plugin.add('resizable', 'animate', {
               stop: function (i) {
                    var e = z(this).resizable('instance'),
                         ...
                         n =
                              parseFloat(e.element.css('left')) +
                                   (e.position.left -
                                        e.originalPosition.left) || null,
                         o =
                              parseFloat(e.element.css('top')) +
                                   (e.position.top - e.originalPosition.top) ||
                              null;
                    e.element.animate(
                         z.extend(h, o && n ? { top: o, left: n } : {}),
                         {
               ...
               resize: function (t) {
                    ...
                    o[0] !== document &&
                         ...
                         h.left < (i._helper ? s.left : 0) &&
                              ...
                              t &&
                                   ((i.size.height =
                                        i.size.width / i.aspectRatio),
                                   (a = !1)),
                              (i.position.left = e.helper ? s.left : 0)),
                         h.top < (i._helper ? s.top : 0) &&
                              ((i.size.height =
                                   i.size.height +
                                   (i._helper
                                        ? i.position.top - s.top
                                        : i.position.top)),
                              t &&
                                   ((i.size.width =
                                        i.size.height * i.aspectRatio),
                                   (a = !1)),
                              (i.position.top = i._helper ? s.top : 0)),
                         (o =
                              i.containerElement.get(0) ===
                              i.element.parent().get(0)),
                         (e = /relative|absolute/.test(
                              i.containerElement.css('position'),
                         )),
                         o && e
                              ? ((i.offset.left =
                                     i.parentData.left + i.position.left),
                                (i.offset.top =
                                     i.parentData.top + i.position.top))
                              : ((i.offset.left = i.element.offset().left),
                                (i.offset.top = i.element.offset().top)),
                         (h = Math.abs(
                              i.sizeDiff.width +
                                   (i._helper
                                        ? i.offset.left - n.left
                                        : i.offset.left - s.left),
                         )),
                         (o = Math.abs(
                              i.sizeDiff.height +
                                   (i._helper
                         ...
                         h + i.size.width >= i.parentData.width &&
                              ((i.size.width = i.parentData.width - h), t) &&
                              ((i.size.height = i.size.width / i.aspectRatio),
                              (a = !1)),
                         o + i.size.height >= i.parentData.height &&
                              ((i.size.height = i.parentData.height - o), t) &&
          ...
          z.ui.plugin.add('resizable', 'grid', {
               resize: function () {
                    ...
                    (e.grid = a),
                         ...
                         c && (g -= r),
                         /^(se|s|e)$/.test(o)
                              ? ((i.size.width = d), (i.size.height = g))
                              : /^(ne)$/.test(o)
                                ? ((i.size.width = d),
                                  (i.size.height = g),
                                  (i.position.top = n.top - s))
                                : /^(sw)$/.test(o)
                                  ? ((i.size.width = d),
                                    (i.size.height = g),
                                    (i.position.left = n.left - p))
                                  : ((g - r <= 0 || d - l <= 0) &&
                                         (t =
                                              i._getPaddingPlusBorderDimensions(
                                                   this,
                                              )),
                                    0 < g - r
                                         ? ((i.size.height = g),
