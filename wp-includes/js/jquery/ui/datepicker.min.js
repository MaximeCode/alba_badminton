     ...
     return (
          ...
          V.extend(e.prototype, {
                              ...
                              t.trigger.on('click', function () {
                                   return (
                                        ...
                                        V.datepicker._lastInput === e[0]
                                             ...
                                             : (V.datepicker
                                                    ._datepickerShowing &&
                                                    V.datepicker._lastInput !==
                                                         e[0] &&
                                                    V.datepicker._hideDatepicker(),
                                               V.datepicker._showDatepicker(
                                                    e[0],
                                               )),
                                        !1
                                   );
                    ...
                    (i = t || {}),
                         ...
                         r &&
                              ...
                              null !== a &&
                                   void 0 !== i.dateFormat &&
                                   void 0 === i.minDate &&
                                   (r.settings.minDate = this._formatDate(
                                        r,
                                        a,
                                   )),
                              null !== s &&
                                   void 0 !== i.dateFormat &&
                                   void 0 === i.maxDate &&
                                   (r.settings.maxDate = this._formatDate(
                                        r,
                                        s,
                                   )),
                              'disabled' in i &&
                              ...
                              case 13:
                                   return (
                                        ...
                                        (a = V.datepicker._get(i, 'onSelect'))
                                             ? ((t =
                                                    V.datepicker._formatDate(
                                                         i,
                                                    )),
                                               a.apply(
                                                    i.input ? i.input[0] : null,
                                                    [t, i],
                                               ))
                                             : V.datepicker._hideDatepicker(),
                                        !1
               ...
               _checkExternalClick: function (e) {
                    ...
                    V.datepicker._curInst &&
                         ...
                         !(
                              ...
                              0 !==
                                   e.parents('#' + V.datepicker._mainDivId)
                                        .length ||
                              e.hasClass(V.datepicker.markerClassName) ||
                              e.closest('.' + V.datepicker._triggerClass)
                                   .length ||
                              !V.datepicker._datepickerShowing ||
                              (V.datepicker._inDialog && V.blockUI)
                         ) ||
               ...
               _selectDay: function (e, t, a, i) {
                    ...
                    V(i).hasClass(this._unselectableClass) ||
                         ...
                         (((s = this._getInst(s[0])).selectedDay =
                              s.currentDay =
               ...
               parseDate: function (t, s, e) {
                    ...
                    if (
                         '' ===
                         (s = 'object' == typeof s ? s.toString() : s + '')
                    )
                         return null;
                    for (
                         var a,
               ...
               _get: function (e, t) {
                    return (
                         void 0 !== e.settings[t] ? e.settings : this._defaults
                    )[t];
               },
                         ...
                         if (((e.yearshtml = ''), r || !_))
                              ...
                              for (
                                   n = this._get(e, 'yearRange').split(':'),
                                        ...
                                        p = Math.max(u, k(n[1] || '')),
                                        u = i
                                             ? Math.max(u, i.getFullYear())
                                             : u,
                                        p = s
                                             ? Math.min(p, s.getFullYear())
                                             : p,
                                        e.yearshtml +=
          ...
          (V.fn.datepicker = function (e) {
               ...
               V.datepicker.initialized ||
                    (V(document).on(
                         'mousedown',
                         V.datepicker._checkExternalClick,
                    ),
