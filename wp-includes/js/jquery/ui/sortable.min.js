     ...
     return u.widget('ui.sortable', u.ui.mouse, {
          ...
          _mouseCapture: function (t, e) {
               ...
               return !(
                    ...
                    !(i =
                         u.data(t.target, o.widgetName + '-item') === o
                              ? u(t.target)
                              : i)) ||
                    (this.options.handle &&
                         !e &&
               ...
               return (
                    this.placeholder &&
                         ...
                         this.domPosition.prev
                              ...
                              : u(this.domPosition.parent).prepend(
                                     this.currentItem,
                                )),
                    this
               );
          ...
          serialize: function (e) {
               ...
               return (
                    ...
                    u(t).each(function () {
                         var t = (
                              u(e.item || this).attr(e.attribute || 'id') || ''
          ...
          toArray: function (t) {
               ...
               return (
                    ...
                    e.each(function () {
                         i.push(
                              u(t.item || this).attr(t.attribute || 'id') || '',
                         );
                    }),
                    i
               );
          ...
          _getItemsAsjQuery: function (t) {
               ...
               if (h && t)
                    for (e = h.length - 1; 0 <= e; e--)
                         for (
                              i = (s = u(h[e], this.document[0])).length - 1;
                              0 <= i;
                              i--
                         )
          ...
          _refreshItems: function (t) {
               ...
               if (p && this.ready)
                    for (e = p.length - 1; 0 <= e; e--)
                         for (
                              i = (s = u(p[e], this.document[0])).length - 1;
                              0 <= i;
                              i--
                         )
                              (o = u.data(s[i], this.widgetFullName)) &&
               ...
               for (
                    ...
                    u.contains(
                         ...
                         (this._intersectsWith(
                              this.containers[f].containerCache,
                         )
                              ? (c &&
                                     u.contains(
                                          this.containers[f].element[0],
          ...
          _setContainment: function () {
               ...
               'parent' === i.containment &&
                    ...
                    /^(document|window|parent)$/.test(i.containment) ||
                         ...
                         (this.containment = [
                              i.left +
                                   (parseInt(u(t).css('borderLeftWidth'), 10) ||
                                        0) +
                                   (parseInt(u(t).css('paddingLeft'), 10) ||
                                        0) -
                                   this.margins.left,
                              i.top +
                                   (parseInt(u(t).css('borderTopWidth'), 10) ||
                                        0) +
                              ...
                              i.left +
                                   ...
                                   (parseInt(u(t).css('borderLeftWidth'), 10) ||
                                        0) -
                                   (parseInt(u(t).css('paddingRight'), 10) ||
                                        0) -
                                   this.helperProportions.width -
                                   this.margins.left,
                              i.top +
                                   ...
                                   (parseInt(u(t).css('borderTopWidth'), 10) ||
                                        0) -
                                   (parseInt(u(t).css('paddingBottom'), 10) ||
                                        0) -
                                   this.helperProportions.height -
                                   this.margins.top,
                         ]));
