     ...
     return r.widget('ui.controlgroup', {
          ...
          _initWidgets: function () {
               ...
               r.each(this.options.items, function (n, t) {
                    ...
                    t &&
                         ('controlgroupLabel' === n
                              ? ((e = s.element.find(t)).each(function () {
                                     var t = r(this);
                                     t.children(
          ...
          refresh: function () {
               ...
               this._addClass(
                    ...
                    this._initWidgets(),
                    (o = this.childWidgets),
                    (o = this.options.onlyVisible ? o.filter(':visible') : o)
                         .length &&
                         (r.each(['first', 'last'], function (t, e) {
                              var i,
                                   n = o[e]().data('ui-controlgroup-data');
                              n && s['_' + n.widgetName + 'Options']
                                   ? (((i = s['_' + n.widgetName + 'Options'](
                                          1 === o.length ? 'only' : e,
                                     )).classes = s._resolveClassesValues(
                                          i.classes,
                                          n,
                                     )),
                                     n.element[n.widgetName](i))
                                   : s._updateCornerClass(o[e](), e);
                         }),
