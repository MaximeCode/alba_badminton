     ...
     return (
          l.widget('ui.dialog', {
               ...
               _appendTo: function () {
                    ...
                    return i && (i.jquery || i.nodeType)
                         ? l(i)
                         : this.document.find(i || 'body').eq(0);
               },
               _destroy: function () {
                    var i,
                    ...
                    this._untrackInstance(),
                         ...
                         (i = t.parent.children().eq(t.index)).length &&
                         i[0] !== this.element[0]
               ...
               close: function (i) {
                    ...
                    this._isOpen &&
                         ...
                         this.opener.filter(':focusable').trigger('focus')
                              .length ||
                              l.ui.safeBlur(
                                   l.ui.safeActiveElement(this.document[0]),
                              ),
                         this._hide(
                              this.uiDialog,
                              this.options.hide,
               ...
               _moveToTop: function (i, t) {
                    ...
                    return (
                         o >= +this.uiDialog.css('z-index') &&
                              (this.uiDialog.css('z-index', o + 1), (e = !0)),
               ...
               _focusTabbable: function () {
                    ...
                    (i = (i = (i = (i = (i =
                         i || this.element.find('[autofocus]')).length
                         ? i
                    ...
                    (this.uiDialog = l('<div>')
                         ...
                         this._on(this.uiDialog, {
                              keydown: function (i) {
                                   ...
                                   i.keyCode &&
                                   i.keyCode === l.ui.keyCode.ESCAPE
                                        ? (i.preventDefault(), this.close(i))
                                        : i.keyCode !== l.ui.keyCode.TAB ||
                                          i.isDefaultPrevented() ||
                                          ((t =
                                               this.uiDialog.find(':tabbable')),
                                          (e = t.first()),
                                          (o = t.last()),
                                          (i.target !== o[0] &&
                                               i.target !== this.uiDialog[0]) ||
                                          i.shiftKey
                                               ? (i.target !== e[0] &&
                                                      i.target !==
                                                           this.uiDialog[0]) ||
               ...
               _createButtonPane: function () {
                    (this.uiDialogButtonPane = l('<div>')),
                         ...
                         (this.uiButtonSet = l('<div>').appendTo(
                              this.uiDialogButtonPane,
                         )),
                         this._addClass(
                              this.uiButtonSet,
               ...
               _createButtons: function () {
                    ...
                    this.uiDialogButtonPane.remove(),
                         ...
                         l.isEmptyObject(i) || (Array.isArray(i) && !i.length)
                              ? this._removeClass(
                                     this.uiDialog,
                                     'ui-dialog-buttons',
                                )
                              : (l.each(i, function (i, t) {
                                     ...
                                     (t = l.extend(
                                          ...
                                          delete t.showLabel,
                                          delete t.icons,
                                          'boolean' == typeof t.text &&
                                               delete t.text,
                                          l('<button></button>', t)
                                               .button(i)
                                               .appendTo(o.uiButtonSet)
                                               .on('click', function () {
                                                    e.apply(
                                                         o.element[0],
                                                         arguments,
               ...
               _setOption: function (i, t) {
                    ...
                    'disabled' !== i &&
                         ...
                         'resizable' === i &&
                              ((e = o.is(':data(ui-resizable)')) &&
                                   !t &&
                                   o.resizable('destroy'),
                              e &&
                                   'string' == typeof t &&
                                   o.resizable('option', 'handles', t),
               ...
               _allowInteraction: function (i) {
                    return (
                         !!l(i.target).closest('.ui-dialog').length ||
                         !!l(i.target).closest('.ui-datepicker').length
                    );
               },
               _createOverlay: function () {
                    var e, o;
                    this.options.modal &&
                         ((e = l.fn.jquery.substring(0, 4)),
                         (o = !0),
                         this._delay(function () {
                              o = !1;
                         }),
                         ...
                         this.document.data(
                              'ui-dialog-overlays',
                              (this.document.data('ui-dialog-overlays') || 0) +
                                   1,
                         ));
               },
               _destroyOverlay: function () {
                    ...
                    this.options.modal &&
                         this.overlay &&
                         ((i = this.document.data('ui-dialog-overlays') - 1)
          ...
          !1 !== l.uiBackCompat &&
               l.widget('ui.dialog', l.ui.dialog, {
                    options: { dialogClass: '' },
                    _createWrapper: function () {
                         this._super(),
