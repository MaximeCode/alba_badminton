     ...
     return (
          l.widget('ui.tabs', {
               ...
               _tabKeydown: function (t) {
                    var e = l(l.ui.safeActiveElement(this.document[0])).closest(
                              'li',
                         ),
                         i = this.tabs.index(e),
                         a = !0;
               ...
               refresh: function () {
                    ...
                    (t.disabled = l.map(
                         ...
                         !1 !== t.active && this.anchors.length
                              ? this.active.length &&
                                !l.contains(this.tablist[0], this.active[0])
                         ...
                         this.anchors.each(function (t, e) {
                              ...
                              o._isLocal(e)
                                   ? ((s = (i = e.hash).substring(1)),
                                     (a = o.element.find(
                                          o._sanitizeSelector(i),
                                     )))
                                   : ((s =
                                          h.attr('aria-controls') ||
                                          l({}).uniqueId()[0].id),
                                     (a = o.element.find((i = '#' + s)))
                                          .length ||
