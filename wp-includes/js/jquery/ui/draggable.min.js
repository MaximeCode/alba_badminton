          ...
          P.widget('ui.draggable', P.ui.mouse, {
               ...
               _mouseCapture: function (t) {
                    ...
                    return !(
                         ...
                         e.disabled ||
                         0 <
                              P(t.target).closest('.ui-resizable-handle')
                                   .length ||
                    ...
                    return (
                         ...
                         !1 === this._trigger('start', t)
                              ...
                              : (this._cacheHelperProportions(),
                                ...
                                this._mouseDrag(t, !0),
                                P.ui.ddmanager &&
                                     P.ui.ddmanager.dragStart(this, t),
                                !0)
                    );
               },
               ...
               _mouseDrag: function (t, e) {
                    if (
                         ...
                         if (!1 === this._trigger('drag', t, e))
                              return (
                                   this._mouseUp(new P.Event('mouseup', t)), !1
                              );
                    ...
                    return 'relative' !== this.cssPosition
                         ...
                         : ((t = this.element.position()),
                           (e = this._isRootNode(this.scrollParent[0])),
                           {
                                top:
                                     t.top -
                                     (parseInt(this.helper.css('top'), 10) ||
                                          0) +
               ...
               _cacheMargins: function () {
                    this.margins = {
                         ...
                         right:
                              ...
                              0,
                         bottom:
                              parseInt(this.element.css('marginBottom'), 10) ||
                              0,
                    };
               },
               ...
               start: function (t, e, s) {
                    s.scrollParentNotHidden ||
                         ...
                         s.scrollParentNotHidden[0] !== s.document[0] &&
                              ...
                              (s.overflowOffset =
                                   s.scrollParentNotHidden.offset());
               },
               drag: function (t, e, s) {
                    var i = s.options,
                         o = !1,
                    ...
                    n !== r && 'HTML' !== n.tagName
                         ? ((i.axis && 'x' === i.axis) ||
                           ...
                           (i.axis && 'y' === i.axis) ||
                                ...
                                i.scrollSensitivity
                                     ? (n.scrollLeft = o =
                                            n.scrollLeft + i.scrollSpeed)
                                     : t.pageX - s.overflowOffset.left <
                                            i.scrollSensitivity &&
                                       (n.scrollLeft = o =
                                            n.scrollLeft - i.scrollSpeed)))
                         : ((i.axis && 'x' === i.axis) ||
                                (t.pageY - P(r).scrollTop() <
                                i.scrollSensitivity
                                     ? (o = P(r).scrollTop(
                                            P(r).scrollTop() - i.scrollSpeed,
                                       ))
                                     : P(window).height() -
                                            (t.pageY - P(r).scrollTop()) <
                                            i.scrollSensitivity &&
                           ...
                           (i.axis && 'y' === i.axis) ||
                                (t.pageX - P(r).scrollLeft() <
                                i.scrollSensitivity
                                     ? (o = P(r).scrollLeft(
                                            P(r).scrollLeft() - i.scrollSpeed,
                                       ))
                                     : P(window).width() -
                                            (t.pageX - P(r).scrollLeft()) <
                                            i.scrollSensitivity &&
