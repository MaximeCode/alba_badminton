          ...
          u.ui.formResetMixin,
          {
               ...
               _position: function () {
                    this.menuWrap.position(
                         u.extend({ of: this.button }, this.options.position),
                    );
               },
               close: function (e) {
                    this.isOpen &&
               ...
               _documentClick: {
                    mousedown: function (e) {
                         !this.isOpen ||
                              u(e.target).closest(
                                   '.ui-selectmenu-menu, #' +
                                        u.escapeSelector(this.ids.button),
                              ).length ||
                              this.close(e);
                    },
               },
               ...
               _parseOption: function (e, t) {
                    ...
                    return {
                         ...
                         value: e.val(),
                         label: e.text(),
                         hidden: i.prop('hidden') || e.prop('hidden'),
