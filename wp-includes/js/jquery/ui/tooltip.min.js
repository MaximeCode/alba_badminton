...
!(function (t) {
     ...
     return (
          r.widget('ui.tooltip', {
               ...
               _addDescribedBy: function (t, i) {
                    ...
                    e.push(i),
                         t
                              ...
                              .attr(
                                   'aria-describedby',
                                   String.prototype.trim.call(e.join(' ')),
                              );
               },
               _removeDescribedBy: function (t) {
                    ...
                    -1 !== i && e.splice(i, 1),
                         ...
                         (e = String.prototype.trim.call(e.join(' ')))
               ...
               _disable: function () {
                    ...
                    r.each(this.tooltips, function (t, i) {
                         var e = r.Event('blur');
                         (e.target = e.currentTarget = i.element[0]),
                              o.close(e, !0);
                    }),
               ...
               open: function (t) {
                    var e = this,
                         i = r(t ? t.target : this.element).closest(
                              this.options.items,
                         );
                    i.length &&
               ...
               _updateContent: function (i, e) {
                    ...
                    if ('string' == typeof t || t.nodeType || t.jquery)
                         return this._open(e, i, t);
                    (t = t.call(i[0], function (t) {
                         o._delay(function () {
                              i.data('ui-tooltip-open') &&
                                   (e && (e.type = n), this._open(e, i, t));
                         });
                    })) && this._open(e, i, t);
               },
               _open: function (t, i, e) {
                    var o,
                         n,
                         s,
                         l = r.extend({}, this.options.position);
                    function a(t) {
                         (l.of = t), o.is(':hidden') || o.position(l);
                    }
                    e &&
                         ((s = this._find(i))
                              ? s.tooltip.find('.ui-tooltip-content').html(e)
                              : (i.is('[title]') &&
                                     (t && 'mouseover' === t.type
                                          ? i.attr('title', '')
                                          : i.removeAttr('title')),
                                ...
                                o.find('.ui-tooltip-content').html(e),
                                this.liveRegion.children().hide(),
                                (s = r('<div>').html(
                                     o.find('.ui-tooltip-content').html(),
                                ))
                                     .removeAttr('name')
                                     .find('[name]')
                                     .removeAttr('name'),
               ...
               _registerCloseHandlers: function (t, i) {
                    var e = {
                         keyup: function (t) {
                              t.keyCode === r.ui.keyCode.ESCAPE &&
                                   (((t = r.Event(t)).currentTarget = i[0]),
                                   this.close(t, !0));
                         },
                    };
                    i[0] !== this.element[0] &&
                    ...
                    n
                         ? ((i = n.tooltip),
                           n.closing ||
                                ...
                                t &&
                                     'mouseleave' === t.type &&
                                     r.each(this.parents, function (t, i) {
                                          r(i.element).attr('title', i.title),
                                               delete e.parents[t];
                                     }),
                                (n.closing = !0),
          ...
          !1 !== r.uiBackCompat &&
               r.widget('ui.tooltip', r.ui.tooltip, {
