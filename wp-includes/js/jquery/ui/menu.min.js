     ...
     return a.widget('ui.menu', {
          ...
          _scrollIntoView: function (e) {
               ...
               this._hasScroll() &&
                    ...
                    (i =
                         parseFloat(a.css(this.activeMenu[0], 'paddingTop')) ||
                         0),
                    ...
                    t < 0
                         ...
                         : s < t + e &&
                           this.activeMenu.scrollTop(i + t - s + e));
          },
          blur: function (e, t) {
          ...
          select: function (e) {
               this.active =
                    this.active || a(e.target).closest('.ui-menu-item');
