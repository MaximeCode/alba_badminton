     ...
     return o.widget('ui.accordion', {
               ...
               e.preventDefault(),
                    (s && !t.collapsible) ||
                         ...
                         t.icons &&
                              ...
                              )._addClass(h, null, t.icons.header)),
                         s) ||
                         (this._removeClass(
                              a,
                              'ui-accordion-header-collapsed',
                         ...
                         t.icons &&
                              ...
                              this._removeClass(
                                   ...
                                   null,
                                   t.icons.header,
                              )._addClass(e, null, t.icons.activeHeader)),
                         this._addClass(
                              a.next(),
                              'ui-accordion-content-active',
                         ));
                         ...
                         : t.length &&
                           this.headers
                                .filter(function () {
                                     return (
                                          0 ===
                                          parseInt(o(this).attr('tabIndex'), 10)
                                     );
                                })
                                .attr('tabIndex', -1),
                    t
          ...
          _animate: function (e, i, t) {
               ...
               var s,
                    ...
                    o = (o && d.down) || d,
                    c =
                         (c = 'string' == typeof o ? o : c) ||
                         o.easing ||
                         d.easing,
                    l =
                         (l = 'number' == typeof o ? o : l) ||
                         o.duration ||
                         d.duration;
               return i.length
                    ? e.length
