     ...
     return (
          ...
          (u.effects.animateClass = function (o, t, e, n) {
               ...
               return this.queue(function () {
                    var n = u(this),
                         t = n.attr('class') || '',
                         e = (e = s.children ? n.find('*').addBack() : n).map(
                              function () {
               ...
               u.extend(u.effects, {
                    save: function (t, e) {
                         for (var n = 0, i = e.length; n < i; n++)
                              null !== e[n] &&
                                   t.data(d + e[n], t[0].style[e[n]]);
                    },
                    restore: function (t, e) {
                         for (var n, i = 0, o = e.length; i < o; i++)
                              null !== e[i] &&
                                   ((n = t.data(d + e[i])), t.css(e[i], n));
                    },
          ...
          u.extend(u.effects, {
               ...
               unshift: function (t, e, n) {
                    var i = t.queue();
                    1 < e && i.splice.apply(i, [1, 0].concat(i.splice(e, n))),
                         t.dequeue();
               },
