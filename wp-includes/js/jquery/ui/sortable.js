...
(function (factory) {
     ...
     return $.widget('ui.sortable', $.ui.mouse, {
               ...
               if (this.originalPosition) {
                    ...
                    if (o.grid) {
                         top =
                              this.originalPageY +
                              Math.round(
                                   (pageY - this.originalPageY) / o.grid[1],
                              ) *
                                   o.grid[1];
                         ...
                         left =
                              this.originalPageX +
                              Math.round(
                                   (pageX - this.originalPageX) / o.grid[0],
                              ) *
                                   o.grid[0];
          ...
          _trigger: function () {
               if (
                    $.Widget.prototype._trigger.apply(this, arguments) === false
               ) {
                    this.cancel();
               }
          },
