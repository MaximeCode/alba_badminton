...
!(function (e) {
     ...
     'function' == typeof define && define.amd
          ? define(
                 ['jquery', './mouse', '../keycode', '../version', '../widget'],
                 e,
            )
          : e(jQuery);
})(function (o) {
     ...
     return o.widget('ui.slider', o.ui.mouse, {
          ...
          _values: function (e) {
               ...
               if (arguments.length)
                    return (
                         (e = this.options.values[e]), this._trimAlignValue(e)
                    );
