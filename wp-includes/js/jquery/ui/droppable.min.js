...
!(function (e) {
     ...
     return (
          a.widget('ui.droppable', {
               ...
               _setOption: function (e, t) {
                    ...
                    'accept' === e
                         ...
                         : 'scope' === e &&
                           ((i = a.ui.ddmanager.droppables[this.options.scope]),
                           this._splice(i),
          ...
          (a.ui.intersect = function (e, t, i, s) {
               ...
               var o =
                    ...
                    d = p + t.proportions().height;
               switch (i) {
                    case 'fit':
                         return l <= o && n <= c && p <= r && a <= d;
                    case 'intersect':
                         return (
                              l < o + e.helperProportions.width / 2 &&
                              n - e.helperProportions.width / 2 < c &&
                              p < r + e.helperProportions.height / 2 &&
                              a - e.helperProportions.height / 2 < d
                         );
                    case 'pointer':
                         return (
                              h(s.pageY, p, t.proportions().height) &&
                              h(s.pageX, l, t.proportions().width)
                         );
                    case 'touch':
                         return (
                              ((p <= r && r <= d) ||
          ...
          !(a.ui.ddmanager = {
               ...
               drop: function (e, t) {
                    ...
                    return (
                         a.each(
                              (
                                   a.ui.ddmanager.droppables[e.options.scope] ||
                                   []
                              ).slice(),
                              function () {
                                   this.options &&
                    ...
                    e.element
                         ...
                         .on('scroll.droppable', function () {
                              e.options.refreshPositions ||
                                   a.ui.ddmanager.prepareOffsets(e, t);
                         });
               },
               drag: function (o, r) {
                    o.options.refreshPositions &&
                         a.ui.ddmanager.prepareOffsets(o, r),
                         a.each(
                              a.ui.ddmanager.droppables[o.options.scope] || [],
                              function () {
                                   var e, t, i, s;
                                   this.options.disabled ||
                                        this.greedyChild ||
