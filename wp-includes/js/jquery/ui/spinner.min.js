          ...
          o.widget('ui.spinner', {
               ...
               _events: {
                    ...
                    mousewheel: function (t, i) {
                         var n = o.ui.safeActiveElement(this.document[0]);
                         if (this.element[0] === n && i) {
                              if (!this.spinning && !this._start(t)) return !1;
                              this._spin(
                                   (0 < i ? 1 : -1) * this.options.step,
                                   t,
                              ),
               ...
               _spin: function (t, i) {
                    ...
                    this.counter || (this.counter = 1),
                         (n = this._adjustValue(
                              n + t * this._increment(this.counter),
                         )),
                         (this.spinning &&
                              !1 === this._trigger('spin', i, { value: n })) ||
               ...
               _adjustValue: function (t) {
                    var i = this.options,
                         n = null !== i.min ? i.min : 0,
                         e = t - n;
                    return (
                         (t = n + Math.round(e / i.step) * i.step),
