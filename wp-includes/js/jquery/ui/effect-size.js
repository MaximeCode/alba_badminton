     ...
     return $.effects.define('size', function (options, done) {
          ...
          if (origin) {
               ...
               from.top =
                    ...
                    pos.top;
               from.left =
                    (original.outerWidth - from.outerWidth) * baseline.x +
                    pos.left;
               to.top =
                    (original.outerHeight - to.outerHeight) * baseline.y +
                    pos.top;
               to.left =
                    (original.outerWidth - to.outerWidth) * baseline.x +
                    pos.left;
          }
               ...
               element.find('*[width]').each(function () {
                    var child = $(this),
                         ...
                         childFrom = {
                              ...
                              outerHeight:
                                   childOriginal.outerHeight * factor.from.y,
                              outerWidth:
                                   childOriginal.outerWidth * factor.from.x,
                         },
                         childTo = {
