...
!(function (i, e, o) {
     ...
     e &&
          e.customize &&
          (((t = e.customize).HeaderTool.CurrentView = e.Backbone.View.extend({
          ...
          (t.HeaderTool.ChoiceView = e.Backbone.View.extend({
               ...
               initialize: function () {
                    ...
                    this.listenTo(
                         ...
                         o.contains(e, t.get().header_image) &&
                              t.HeaderTool.currentHeader.set(
                                   this.extendedModel(),
                              );
               },
               render: function () {
               ...
               select: function () {
                    this.preventJump(),
                         this.model.save(),
                         t.HeaderTool.currentHeader.set(this.extendedModel());
               },
          ...
          (t.HeaderTool.ChoiceListView = e.Backbone.View.extend({
               ...
               addOne: function (e) {
                    e.set({ collection: this.collection }),
                         (e = new t.HeaderTool.ChoiceView({ model: e })),
